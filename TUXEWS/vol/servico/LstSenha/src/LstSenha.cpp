...
DECLARE_TUXEDO_SERVICE(LSTSENHA);

void implLSTSENHA::Execute(DOMNode* dnode, XMLGen* xml_g) {
	...
	try
	{
		...
		xml_g->addItem("dsSenha", oPessoa.getSenha().getCdSenha());
