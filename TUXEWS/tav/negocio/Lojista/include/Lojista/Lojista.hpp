...
public:
	...
	int		getInSitefAtivo() const;
	int		getIdUF();
	char   *getNmAreaRegistro();
	char   *getNmMunicipio();
	char   *getNmLoja();
	char   *getNmTerminal();
	int		getInLiberadoRecargaPagamento();
	...
	void  setInSitefAtivo(int value);
	...
	void  setInLiberadoRecargaPagamento(int value);		
	...
	void  consultarListaTerminais(XMLGen* xml_g, int iIdUF, int iIdTerminal, int iIdPessoaDePara, char *cNmMunicipio, int iInLiberadoRecargaPagamento, int iNrPagina );
	...
	void  alterarTerminal(int iIdTerminal, int iIdPessoaDePara, int iIdUFOperadora, char *cNrTerminal, char *cNrIpTerminal, char *cCdSitefSenha, char *cdLojaOperadoraCartao, int  iLiberadoRecargaPagamento, int iIdCor);	 	 
	void  incluirTerminal(long iIdPessoaDePara, char *cNrTerminal, char *cNrIpTerminal, char *cCdSitefSenha, char *cdLojaOperadoraCartao, int  iLiberadoRecargaPagamento, int iIdCor, int iIdUFOperadora);	 	 
...
private:
	...
	int  m_iLiberadoRecargaPagamento;
	int  m_iIdCor;
