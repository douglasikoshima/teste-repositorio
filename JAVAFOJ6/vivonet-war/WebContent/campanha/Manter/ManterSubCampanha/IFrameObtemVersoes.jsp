...
<html>
    <head></head>
    <body>
        <form name="copiaPerguntasActionForm" action="obtemVersoes.do" method="post">
            <html:select name="Form" property="versaoDestSelecionada">
...
<SCRIPT FOR=window EVENT=onload>
    if(parent.document.forms["copiaPerguntasActionForm"])
    {
        var aOptComponent        = new Array(document.forms[0].elements["versaoDestSelecionada"]);
        var aOptComponentsParent = new Array(parent.document.forms["copiaPerguntasActionForm"].elements["versaoDestSelecionada"]);
