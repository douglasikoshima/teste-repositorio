...
<netui-template:template templatePage="/resources/jsp/CRMTemplate.jsp">
    ...
    <acesso:controlHiddenItem nomeIdentificador="cam_rr_verpagina">
    <script>
        function imprimir()
        {
            // default values
            var default_url = "generarImpressao.do?idRelatorio=5";
    ...
    <vivo:sessao id="idFrelatorio" height="470" width="790" label="Relatório Percentual de Respostas" operacoes="" scroll="N">
        ...
        <table width="100%" class="tbl_bggray" cellpadding="5" border="0">
            ...
            <tr>
                ...
                <td>
                de
                <b><bean:write name="relHeader" property="filtroDtInicio" /></b> a
                <b><bean:write name="relHeader" property="filtroDtFim" /></b></td>
            </tr>
            <tr>
            ...
            <div><img src="<%=request.getContextPath()%>/resources/images/transp.gif" border="0" width="1" height="3"></div>
            <vivo:tbTable selectable="true" onRowClick="" layoutWidth="765" layoutHeight="265" tableWidth="765" styleId="tableTitle" sortable="true" >
                <vivo:tbHeader>
                    <vivo:tbHeaderColumn align="left" width="30%" type="string">Pergunta</vivo:tbHeaderColumn>
                    <vivo:tbHeaderColumn align="left" width="30%" type="string">Resposta</vivo:tbHeaderColumn>
                    <vivo:tbHeaderColumn align="center" width="20%" type="number">Nro de Atendimentos</vivo:tbHeaderColumn>
                    <vivo:tbHeaderColumn align="center" width="20%" type="number">Porcentagem</vivo:tbHeaderColumn>
                </vivo:tbHeader>
                <vivo:tbRows>
                        <logic:iterate id="item" name="numerico">
                            <vivo:tbRow key="linha1" zebrar="s">
                                <vivo:tbRowColumn><bean:write name="item" property="dsPergunta"/></vivo:tbRowColumn>
                                <vivo:tbRowColumn><bean:write name="item" property="dsResposta"/></vivo:tbRowColumn>
                                <vivo:tbRowColumn><bean:write name="item" property="nroAtendimento"/></vivo:tbRowColumn>
                                <vivo:tbRowColumn><bean:write name="item" property="porcent"/></vivo:tbRowColumn>
                        </vivo:tbRow>
                        </logic:iterate>
                </vivo:tbRows>
            </vivo:tbTable>
        ...
        <table width="100%" class="tbl_bgGray">
            <tr>
                ...
                <td align="right">
                    <acesso:controlHiddenItem nomeIdentificador="cam_rr_impr">
                ...
                <td align="right">
                    <acesso:controlHiddenItem nomeIdentificador="cam_rr_ga">
                        <img id="gerararquivo" src="/FrontOfficeWeb/resources/images/bt_gerararq_nrml.gif" rolloverImage="/FrontOfficeWeb/resources/images/bt_gerararq_over.gif" onClick="window.location.href='/FrontOfficeWeb/campanha/Relatorio/generarArquivo.do?idRelatorio=5'; return false" style="border:none" hspace="5" vspace="5"/>
                    </acesso:controlHiddenItem>
                </td>
            </tr>
        </table>
