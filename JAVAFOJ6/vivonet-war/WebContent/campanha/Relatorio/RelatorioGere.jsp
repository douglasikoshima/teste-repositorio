...
<bean:define id="relatorio" name="com.bea.wlw.netui.pageflow.PageFlowUtils_currentPageFlow" property="relGerenciamentoForm.campanhaRelatorioVO"/>
...
<netui-template:template templatePage="/resources/jsp/CRMTemplate.jsp">
    ...
    <acesso:controlHiddenItem nomeIdentificador="cam_rg_verpagina">
    <script>
        function imprimir()
        {
            // default values
            var default_url = "generarImpressao.do?idRelatorio=1";
    ...
    <vivo:sessao id="idFrelatorio" height="470" width="790" label="Relatório de Gerenciamento" operacoes="" scroll="N">
            ...
            <vivo:tbTable selectable="true" onRowClick="" layoutWidth="765" layoutHeight="300" tableWidth="765" styleId="tableTitle" sortable="true" >
                <vivo:tbHeader>
                    <vivo:tbHeaderColumn align="left" width="80%" type="string">Descrição</vivo:tbHeaderColumn>
                    <vivo:tbHeaderColumn align="center" width="20%" type="string">Valor</vivo:tbHeaderColumn>
                </vivo:tbHeader>
                <vivo:tbRows >
                        <logic:iterate id="linha" name="relatorio" property="numericoArray">
        ...
        <table width="100%" class="tbl_bgGray">
            <tr>
                ...
                <td align="right">
                    <acesso:controlHiddenItem nomeIdentificador="cam_rg_impr">
                ...
                <td align="right">
                    <acesso:controlHiddenItem nomeIdentificador="cam_rg_ga">
                        <img id="gerararquivo" src="/FrontOfficeWeb/resources/images/bt_gerararq_nrml.gif" rolloverImage="/FrontOfficeWeb/resources/images/bt_gerararq_over.gif" onClick="window.location.href='/FrontOfficeWeb/campanha/Relatorio/generarArquivo.do?idRelatorio=1'; return false" style="border:none" hspace="5" vspace="5"/>
                    </acesso:controlHiddenItem>
                    </td>
            </tr>
        </table>
