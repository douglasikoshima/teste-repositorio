...
<bean:define id="aVersao" name="com.bea.wlw.netui.pageflow.PageFlowUtils_currentPageFlow" property="relEfetividadeActionForm.listaVersao" />
...
<html>
    ...
    <SCRIPT FOR=window EVENT=onload>    
        ...
        {    
            copiarCombo(document.forms[0].elements["versaoSelecionada"], parent.document.forms["relEfetividadeActionForm"].elements["versaoSelecionada"]);
