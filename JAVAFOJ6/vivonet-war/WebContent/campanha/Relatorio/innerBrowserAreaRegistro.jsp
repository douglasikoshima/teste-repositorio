...
<bean:define id="aListaAreaRegistro" name="com.bea.wlw.netui.pageflow.PageFlowUtils_currentPageFlow" property="relEfetividadeActionForm.listaAreaRegistro" />
...
<html>
    ...
    <body>
        <form>
            <html:select name="Form" property="areaRegistroSelecionada" size="1" style="width=150px;height=10px">
                <option value=""></option>
                <html:options collection="aListaAreaRegistro" property="idAreaRegistro" labelProperty="dsAreaRegistro"/> 
            </html:select>
		</form>
    ...
    <SCRIPT FOR=window EVENT=onload>    
        ...
        {    
            copiarCombo(document.forms[0].elements["areaRegistroSelecionada"], parent.document.forms["relEfetividadeActionForm"].elements["areaRegistroSelecionada"]);            
        }      
