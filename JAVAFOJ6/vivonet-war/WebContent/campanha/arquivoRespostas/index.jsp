...
<bean:define id="listaVersao" name="com.bea.wlw.netui.pageflow.PageFlowUtils_currentPageFlow" property="arquivoForm.listaVersao" />
 ...
 <script language="Javascript">
    ...
    {            
        ...
        else
        {
            ...
            objForm.idCanalCampanha.options.length = 0;
    ...
    function consultaIFrameCanalCampanha() 
    {            
        var objForm = document.forms["arquivoForm"];
        
        if(objForm.versaoSelecionada.value == "")
        {
        ...
        {    
            ...
            //Monta o path seleção
            objForm.target = "innerBrowser";
            objForm.action = "carregarCanais.do";
            objForm.submit();
        ...
        function submitConsulta()
        {
            ...
            else if(objForm.idCanalCampanha.value == "")
            {
                alert('Favor selecionar uma Canal Atendimento!');
                objForm.idCanalCampanha.focus();
                return false;
            }                  
        ...
        function gerar(){
            ...
            obj.method="POST";
            obj.action = "/FrontOfficeWeb/campanha/arquivoRespostas/gerarArquivo.do";
    ...
    <acesso:controlHiddenItem nomeIdentificador="cam_indexarqres_verpagina">
            ...
            <tr>
                ...
                <table id="todos3" width="100%" cellpadding="3" cellspacing="0" border="0">
                    ...
                    <tr  valign="top">
                        ...
                        <td colspan="3">
                        <html:select name="form" property="versaoSelecionada" size="1" style="width=150px;height=10px" onchange="consultaIFrameCanalCampanha();">
                            <html:options collection="listaVersao" property="codigo" labelProperty="descricao"/> 
                        </html:select>
                        </td>
                    </tr>                    
                    
                    <tr  valign="top">
                        <td align="right" class="tblEstatica_campoNome" width="140"><font color="red">*</font>&nbsp;Canal
                        Atendimento:
                        </td>
                        <td colspan="3">
                        <html:select name="form" property="idCanalCampanha" size="1" style="width=150px;height=10px">
                            <option value=""></option>
                ...
                <table width="700" border="0" cellpadding="3" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <tr>
                        ...
                        <acesso:controlHiddenItem nomeIdentificador="cam_arqresp_gerar">
                            <img vspace="10" 
                            	 onmouseup="gerar();"
