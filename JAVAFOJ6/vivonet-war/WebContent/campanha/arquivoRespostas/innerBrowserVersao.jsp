...
<html>
    ...
    <body>
        <form>
            <html:select name="form" property="versaoSelecionada">
    ...
    <SCRIPT FOR=window EVENT=onload>    
        ...
        {
            copiarCombo(document.forms[0].elements["versaoSelecionada"], parent.document.forms["arquivoForm"].elements["versaoSelecionada"]);
