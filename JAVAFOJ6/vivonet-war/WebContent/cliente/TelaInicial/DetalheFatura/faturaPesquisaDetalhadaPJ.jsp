    ...
    <script type="text/javascript" language="javascript">
        ...
        validarPesquisa = function() {
            ...
            if ($('pesquisa_periodo').checked) {
                var mesDataInicio = $F('dtInicio').substring(3, 5);
                var mesDataFim = $F('dtFim').substring(3, 5);
                ...
                if ($F('dtInicio').blank() && $F('dtFim').blank()) {
                    ...
                    return false;
                } else if (mesDataInicio != mesDataFim) {
                    alert('A pesquisa não pode ser realizada com meses diferentes.');
                    return false;
                } else {
        ...
        pesquisar = function() {
            if (validarPesquisa()) {
                ...
                var action = 'pesquisaFaturaDetalhadaPJ.do?pesquisa=true';
                document.forms[0].action=action;
                document.forms[0].target='resultadoPesquisa';
...
<table width="100%">
    ...
    <tr>
        ...
        <td>
            <html:select name="Form" property="filtrosFaturamentoForm.cdTipoChamada" styleId="cdTipoChamada">
                ...
                <option value="EX">Chamadas no Exterior</option>
    ...
    <tr>
        ...
        <td>
            <html:select name="Form" property="filtrosFaturamentoForm.cdTipoDestino" styleId="cdTipoDestino">
                ...
                <option value="IG">Chamadas para Intragrupo</option>
    ...
    <tr>
        <td colspan="4" valign="top">
            ...
            <iframe src="" id="resultadoPesquisa" name="resultadoPesquisa" frameborder="0" scrolling="no" width="761" height="142"></iframe>
        </td>
    </tr>
</table>
</form>
