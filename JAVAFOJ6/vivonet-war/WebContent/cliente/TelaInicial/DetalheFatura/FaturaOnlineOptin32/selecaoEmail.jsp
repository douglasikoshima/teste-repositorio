...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        incluirEmail = function() {
            top.frameApp.createNewPopUp('incluirEmailPF', 'Inclusão de E-mail', 500, 100, null, '/FrontOfficeWeb/cliente/TelaInicial/DetalheFatura/FaturaOnlineOptin32/manageCadastroEmail.do', true, null);
        };
    </script>
    <style type="text/css">
        body {
