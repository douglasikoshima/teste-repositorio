    ...
    <script type="text/javascript" language="javascript">
        ...
        salvarEmail = function() {
            ...
            if ($('idTipoComunicacao').selectedIndex == 0) {
                ...
                $('formContaOnline').action = '/FrontOfficeWeb/cliente/TelaInicial/DetalheFatura/FaturaOnlineOptin32/manageCadastroEmail.do?dsTipoComunicacao=' + dsTipoComunicacao;
