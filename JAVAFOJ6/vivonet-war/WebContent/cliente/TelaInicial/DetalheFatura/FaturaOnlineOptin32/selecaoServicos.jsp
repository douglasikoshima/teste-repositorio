    ...
    <script type="text/javascript" language="javascript">
        ...
        submitServicos = function(inAceitar) {
            ...
            if (!inAlteracaoCheckboxes) {
                ...
                if ($('avisoFaturaDisponivelPorEmail').checked || $('servicoEnvioFaturaPorEmail').checked) {
            ...
            if (inAceitar && ((!$('avisoFaturaDisponivelPorEmail').checked && !$('servicoEnvioFaturaPorEmail').checked && !$('servicoEnvioCodigoBarrasPorSMS').checked) && $('radioDesativar') && !$('radioDesativar').checked)) {
            ...
            <div id="divContaOnlineWrapper">
                ...
                <logic:equal name="Form" property="manutencao" value="false">
                    <vivo:quadro id="divFaturamento" width="650" height="40" label="Faturamento">
                        Conta Online:
                        <span id="spanStatus">
                            <logic:match name="Form" property="faturaOnlineAtiva" value="false">DES</logic:match>ATIVADO
                        </span>
                    </vivo:quadro>
                </logic:equal>
