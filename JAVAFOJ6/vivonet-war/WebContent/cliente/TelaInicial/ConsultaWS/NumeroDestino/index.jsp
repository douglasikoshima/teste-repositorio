...
<netui-template:template templatePage="/resources/jsp/templateUsuarioClean.jsp">
    ...
    <netui-template:section name="bodySection">
        <vivo:quadro id="divConsultaNumero" height="247" width="690" label="Consulta de Número" scroll="no">
            <form name="consultarNumeroForm" id="consultarNumeroForm" action="/FrontOfficeWeb/cliente/TelaInicial/ConsultaWS/NumeroDestino/pesquisarNumero.do" method="post">
            <table width="100%">
                <tr>
