...
<html>
        ...
        <script>
            function validaPesquisa() {                
                if (document.getElementById("dtIni").value == "")
                    alert("A data inicial Ã© obrigatoria!");
                else if (document.getElementById("dtFin").value == "")
                    alert("A data final Ã© obrigatoria!");
                else {
    ...
    <acesso:controlHiddenItem nomeIdentificador="cli_asp_verpagina">
        <html:form action="/cliente/TelaInicial/pesquisarHistoricoAtendimento.do">          
            <div class="tbl_bgGray">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>                                
                        ...
                        <td>&nbsp;de 
                            <html:text style="width:65px;" name="form" property="dtIni" styleId="dtIni" readonly="true"/><img src="<%=request.getContextPath()%>\resources\images\calendario.gif" style="cursor:hand;" title="CalendÃ¡rio" onclick="return showCalendar('dtIni', '%d/%m/%Y');">
                                at&eacute;&nbsp;
                            <html:text style="width:65px;" name="form" property="dtFin" styleId="dtFin" readonly="true"/><img src="<%=request.getContextPath()%>\resources\images\calendario.gif" style="cursor:hand;" title="CalendÃ¡rio" onclick="return showCalendar('dtFin', '%d/%m/%Y');">
                        </td>
                        <td valign="middle" align="right">
                        <acesso:controlHiddenItem nomeIdentificador="cli_asp_pesquisar">
