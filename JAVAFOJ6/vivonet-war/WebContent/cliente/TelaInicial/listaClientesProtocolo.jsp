    ...
    <html:form method="post" action="/cliente/TelaInicial/pesquisaCliente.do">
        ...
        <vivo:tbTable selectable="true" layoutWidth="764" layoutHeight="425" tableWidth="764" styleId="tableTitle" sortable="true">
            <vivo:tbHeader>
                ...
                <vivo:tbHeaderColumn align="center" width=""   type="string">Documento</vivo:tbHeaderColumn>
                <vivo:tbHeaderColumn align="center" width="80" type="string">Nº Linha</vivo:tbHeaderColumn>
            </vivo:tbHeader>
            <vivo:tbRows>
                <logic:iterate id="listaClientes" name="FormPesquisa" property="listaClientes.clientesPesquisadosArray">
                    <vivo:tbRow key="Linha">
                        <vivo:tbRowColumn><input type="radio" class="radio" name="clienteSelecionado" value="<bean:write name="listaClientes" property="idPessoa"/>"/></vivo:tbRowColumn>
                        ...
                        <vivo:tbRowColumn><bean:write name="listaClientes" property="nrLinha"/></vivo:tbRowColumn>
                    </vivo:tbRow>
                </logic:iterate>
            </vivo:tbRows>
        </vivo:tbTable>
