        ...
        <script>
            ...
            function utilizaEndereco(valor){
                if(valor)
                    ...
                    alert('Execute uma pesquisa e selecione um endereço!');
            }
            ...
            function selecionaEndereco(idArray){
                if(idArray){
                    ...
                    f.action = '/FrontOfficeWeb/cliente/TelaInicial/DetalheUsuario/pesquisaEndereco.do?pagina=nao&&idArray='+idArray;
            ...
            function verificaExistenciaCep() {
                var msg = '<bean:write name="ErroForm" property="noCep"/>';
                alert(typeof(msg));
            }
        </script>
    </head>
    <body>
        <acesso:controlHiddenItem nomeIdentificador="cli_rsp_verpagina">
        ...
        <logic:empty name="ErroForm" property="erro">
                                ...
                                <script>
                                    <logic:equal name="FormEnd" property="pesquisaBaseFO" value="false">
                                        ...
                                        if (!parent.$F('cep').blank()) {
                                            ...
                                            parametrosPesquisa  = '\nLogradouro: ' + parent.$('logradouro').value.strip();
            ...
            <vivo:tbTable selectable="true" onRowClick="" layoutWidth="735" layoutHeight="230" tableWidth="735" styleId="tableTitle" sortable="true">
                <vivo:tbHeader>
            ...
            <div align="right">
            <acesso:controlHiddenItem nomeIdentificador="cli_rsp_selecionar">
                <img onClick="selecionaEndereco(get_radio_value()); return false" src="/FrontOfficeWeb/resources/images/bt_selecionar_nrml.gif" style="border:none;cursor:hand;"/>
