...
<html>
<acesso:controlHiddenItem nomeIdentificador="cli_tiduexec_verpagina">
<bean:define id="Form" name="com.bea.wlw.netui.pageflow.PageFlowUtils_currentPageFlow" property="abaContato" type="cliente.TelaInicial.DetalheUsuario.DetalheUsuarioController.AbaContato"/>        
    ...
    <html:form action="/cliente/TelaInicial/DetalheUsuario/alterarEmailLegado.do" method="post">
    ...
    <body>
        ...
        <logic:equal name="Form" property="inMsgRetorno" value="true">
            <script>
                ...
                alert('Contato não pôde ser incluído/alterado pois já existe um contato do mesmo tipo com essa descrição ou uma seqüencia de contato com este valor!');
            </script>
        </logic:equal>  
