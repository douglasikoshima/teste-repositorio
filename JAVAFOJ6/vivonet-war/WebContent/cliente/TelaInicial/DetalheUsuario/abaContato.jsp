...
<bean:define id="Form" name="com.bea.wlw.netui.pageflow.PageFlowUtils_currentPageFlow" property="abaContato" type="cliente.TelaInicial.DetalheUsuario.DetalheUsuarioController.AbaContato"/>        
<html>
    <head>
    ...
    <acesso:controlHiddenItem nomeIdentificador="cli_aco_verpagina">
        ...
        <form action="loadContato.do" method="post">
                        ...
                        <vivo:tbRows>                                
                                <logic:iterate name="abaContato" property="abaContato" indexId="idx" id="aba">
                                    <vivo:tbRow key="Linha">
                                        ...
                                        <vivo:tbRowColumn><bean:write name="aba" property="dsContato"/><html:hidden name="aba" property="idComunicacao" styleId="id"/></vivo:tbRowColumn>                                                                                        
                                        <vivo:tbRowColumn>
                                        <acesso:controlHiddenItem nomeIdentificador="cli_aco_alterar">
                                        ...
                                        </logic:equal><logic:equal name="aba" property="inSincronismo" value="1">
                                        ...
                                        <vivo:tbRowColumn>
                                        <acesso:controlHiddenItem nomeIdentificador="cli_aco_excluir">
                                        <logic:equal name="aba" property="inSincronismo" value="0">
                                        ...
                                        </logic:equal></acesso:controlHiddenItem></vivo:tbRowColumn>
                                    </vivo:tbRow>
                                </logic:iterate>                                                                
                        </vivo:tbRows>
                    </vivo:tbTable>
        ...
        <table width="760" height="20" bgcolor="#E3ECF4">
            <tr>                    
                ...
                <acesso:controlHiddenItem nomeIdentificador="cli_aco_incluir">
