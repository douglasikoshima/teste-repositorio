...
<head>
    ...
    <script language="javaScript">
        ...
        onload = function() {
            ...
            <acesso:controlHiddenItem nomeIdentificador="cli_inc_verpagina">
        ...
        changeTipoContato = function(obj) {
            ...
            var objValue = document.forms[0].elements['contato.dsContato'];
            objValue.value = '';
...
<body>
<acesso:controlHiddenItem nomeIdentificador="cli_inc_verpagina">
        <html:form action="/cliente/TelaInicial/DetalheUsuario/salvarContato.do" target="_parent" method="post">
            <table border="0" cellspacing="10" cellpadding="0">
                <tr>
                    ...
                    <td>
                        <html:select style="text-indent:3px;" property="idTipoSelecionado" onchange="changeTipoContato(this)">
                ...
                <tr>
                    ...
                    <acesso:controlHiddenItem nomeIdentificador="cli_inc_gravar">
