...
<body>
<acesso:controlHiddenItem nomeIdentificador="cli_pen_verpagina">
<html:form action="/cliente/TelaInicial/DetalheCliente/buscaEndereco.do" enctype="application/x-www-form-urlencoded" method="post">
            ...
            <td valign="top">
                <table width="750" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <acesso:controlHiddenItem nomeIdentificador="cli_pen_pesquisar">
                            ...
                            <img src="/FrontOfficeWeb/resources/images/bt_limpar_nrml.gif" rolloverImage="/FrontOfficeWeb/resources/images/bt_limpar_over.gif" style="border:none;" onClick="limpar(); return false;"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="4">
                            ...
                            <iframe name="frmResultadoPesquisa" id="ifrResultadoPesquisa" frameborder="0" src="buscaEndereco.do?iniciarTela=TRUE&retorno=<bean:write name="Form" property="filtroPesquisa.idUFSelecionado" />" marginwidth="0" marginheight="0" scrolling="no" width="760" height="400"></iframe>
