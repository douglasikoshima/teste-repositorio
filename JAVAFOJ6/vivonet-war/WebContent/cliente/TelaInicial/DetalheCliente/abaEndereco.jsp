...
<html>
    ...
    <acesso:controlHiddenItem nomeIdentificador="cli_aen_verpagina">  
        <script>
            document.body.style.backgroundColor = '#E3ECF4';    
        </script>
        <form id="fClienteEndereco" action="loadEndereco.do" method="post">
         ...
         <logic:equal name="abaEndereco" property="inMsgRetorno" value="true">
                            ...
                            <vivo:tbRows>
                                ...
                                <bean:define id="addrTit" name="aba" property="nmTituloLogradouro" type="java.lang.String"/>
                                        <vivo:tbRow key="Linha">
                                            ...
                                            <vivo:tbRowColumn>
                                                <acesso:controlHiddenItem nomeIdentificador="cli_aen_alterar">
                                            ...
                                            <vivo:tbRowColumn>
                                                <acesso:controlHiddenItem nomeIdentificador="cli_aen_excluir">
                                                <logic:equal name="aba" property="inSincronismo" value="1">
            ...
            <table width="750" height="20">
                <tr>                    
                    ...
                    <acesso:controlHiddenItem nomeIdentificador="cli_aen_incluir">
                        <img hspace="13" vspace="3" onClick="acao('novo', 999); return false" src="/FrontOfficeWeb/resources/images/bt_incluir_endereco_nrml.gif" style="border:none;cursor:hand;"/>
                    </acesso:controlHiddenItem>
                    </td>
                </tr>
            </table>            
