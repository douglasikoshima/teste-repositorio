...
<acesso:controlHiddenItem nomeIdentificador="cli_per_verpagina">
                    ...
                    <vivo:sessao height="355" id="permissoes" width="740" scroll="no" label="Cliente" operacoes="Permissões">
                        ...
                        <table width="730">
                            <tr>
                                ...
                                <td align="right">
                                    <img onmouseup="document.forms[0].method='POST';document.forms[0].submit; return false"
                                    	 src="/FrontOfficeWeb/resources/images/bt_limpar_nrml.gif"
                                    	 style="border:none;" />
                                    <acesso:controlHiddenItem nomeIdentificador="cli_per_gravar">
                                    	<img onClick="salvar(); return false"
