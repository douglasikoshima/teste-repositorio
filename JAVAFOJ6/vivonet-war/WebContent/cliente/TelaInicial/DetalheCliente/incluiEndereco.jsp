...
<script language="javaScript">
    ...
    function limpar() {
        ...
        document.getElementById('codLogradouro').value="";
        document.getElementById('inCnl').value="";
        document.getElementById('inCodigoIBGE').value="";
    }

</script>
</head>
<body style="background-color:#E3ECF4;">
<acesso:controlHiddenItem nomeIdentificador="cli_ien_verpagina">
    <html:form action="/cliente/TelaInicial/DetalheCliente/salvarEndereco.do" target="_parent" method="post">
        <html:hidden name="abaEndereco" property="idPessoa" styleId="idPessoa"/>
        <html:hidden name="abaEndereco" property="endereco.codLogradouro" styleId="codLogradouro" />
        <html:hidden name="abaEndereco" property="endereco.inCnl" styleId="inCnl" />
        <html:hidden name="abaEndereco" property="endereco.inCodigoIBGE" styleId="inCodigoIBGE" />
        <table width="100%" height="200" border="0" cellspacing="8" cellpadding="0" >
            ...
            <tr>
                ...
                <td>
                    ...
                    <html:select property="idUFSelecionado" styleId="idUFSel" disabled="true">
                        <option value=""></option>
                ...
                <td colspan="3">
                    ...
                    <html:select property="idPaisSelecionado" styleId="idPaisSel" disabled="true">
            ...
            <tr>
                ...
                <acesso:controlHiddenItem nomeIdentificador="cli_ien_pesquisar">
                    <img hspace="15" style="border:none;cursor:hand;" onClick="pesquisaEndereco();return false;" src="/FrontOfficeWeb/resources/images/bt_pesquisar_nrml.gif"/>
                </acesso:controlHiddenItem>
                <img src="/FrontOfficeWeb/resources/images/bt_limpar_nrml.gif" style="border:none;cursor:hand;" hspace="5" onClick="limpar();return false;"/>
                <acesso:controlHiddenItem nomeIdentificador="cli_ien_gravar">
                    <img src="/FrontOfficeWeb/resources/images/bt_registrar_nrml.gif" style="border:none;cursor:hand;" hspace="5" onClick="salvar('novo');return false;"/>
                </acesso:controlHiddenItem>
                </td>
            </tr>
        </table>
