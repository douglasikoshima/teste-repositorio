...
<bean:define id="Atributos" name="com.bea.wlw.netui.pageflow.PageFlowUtils_currentPageFlow" property="manterDadosForm.atributos"/>
    ...
    <acesso:controlHiddenItem nomeIdentificador="cli_pgt_verpagina">
    <html:form action="/cliente/TelaInicial/DetalheCliente/customer/loadAtributos.do" method="post">
    ...
    <vivo:quadro id="perguntas" height="452" width="470">
    ...
                        </logic:iterate></br>
            ...
            <tr>
                ...
                <acesso:controlHiddenItem nomeIdentificador="cli_pgt_gravar">
