...
<head>
    ...
    <body style="background-color:#E3ECF4;">
        <acesso:controlHiddenItem nomeIdentificador="cli_ale_verpagina">
        <html:form action="/cliente/TelaInicial/DetalheCliente/salvarEndereco.do" target="_parent">
        ...
        <table width="100%" height="200" border="0" cellspacing="8" cellpadding="0" >
            <tr>
                <td width="120">Tipo de Endereço&nbsp;</td>
                <td width="120">
            ...
            <tr>
                <td>Logradouro:</td>
                <td colspan="3">
                    <html:text name="abaEndereco"
                               property="endereco.nmLogradouro"
                               maxlength="60"
                               style="width:265px;"
                               styleId="nmLogradouro"
                               readonly="true" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
            ...
            <tr>
                ...
                <td colspan="1" align="right">
                    ...
                    <acesso:controlHiddenItem nomeIdentificador="cli_ale_pesquisar">
                        <img style="border:none;cursor:hand;" onClick="pesquisaEndereco();" src="/FrontOfficeWeb/resources/images/bt_pesquisar_nrml.gif"/>
                    </acesso:controlHiddenItem>
                        <img src="/FrontOfficeWeb/resources/images/bt_limpar_nrml.gif" style="border:none;cursor:hand;" hspace="5" onClick="limpar();"/>
                    <acesso:controlHiddenItem nomeIdentificador="cli_ale_gravar">
                        <img src="/FrontOfficeWeb/resources/images/bt_gravar_nrml.gif" style="border:none;cursor:hand;" hspace="5" onClick="salvar('alteracao');"/>
                    </acesso:controlHiddenItem>
                    <%}%>
                </td>
            </tr>
