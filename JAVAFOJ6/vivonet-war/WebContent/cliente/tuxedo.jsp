...
<netui-template:template templatePage="../resources/jsp/CRMTemplate.jsp">
    ...
    <%
    String isSql = (String) request.getAttribute("TUX");
        ...
        <script language="javascript">
            pesquisar = function() {
                if ($F('sqlCommand').blank()) {
                    ...
                    new Ajax.Updater('containerPesquisa', 'pesquisarTuxedo.do', {
                        method: 'post',
                        parameters: params,
                        evalScripts: true,
                        onSuccess: function() {
    ...
    String isSql = (String) request.getAttribute("TUX");
    if(isSql!=null && ConstantesCRM.SONE.equals(isSql)){%>
    <form action="pesquisarTuxedo.do" id="formPesquisa" style="margin:0;">
