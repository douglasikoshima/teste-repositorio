...
<body style="background-color:#EDEDED;">
  <table width="80%" align="center">
        ...
        <tr>
            <td width="80%" valign="middle">&nbsp;O status do serviço indica que ele já esta de acordo com a sua escolha<br> ou o numero escolhido não pode efetuar essa operação<BR>Verifique a opção escolhida e o status da linha.<br></td>
