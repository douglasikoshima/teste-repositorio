    ...
    <netui-template:section name="bodySection">
        <html:form action="pesquisarCRI">
                ...
                <vivo:tbRows scroll="auto">
                    <logic:iterate id="listaClientes" name="Form" property="grupoCRI.pesquisa.pessoasArray">
                        <vivo:tbRow key="Linha">
                            <vivo:tbRowColumn><input type="radio" class="radio" name="clienteSelecionado" value="<bean:write name="listaClientes" property="idPessoa"/>" onclick="atualizaIdPessoa();" id="clienteSelecionado"/></vivo:tbRowColumn>
            ...
            <table width="720">
                <tr>                
                    <td align="right">
                        <img id="btProsseguir" src="/FrontOfficeWeb/resources/images/bt_prosseguir_nrml.gif" onmouseover="this.src='/FrontOfficeWeb/resources/images/bt_prosseguir_over.gif';" onmouseout="this.src='/FrontOfficeWeb/resources/images/bt_prosseguir_nrml.gif';" style="cursor:hand;border:none;" onclick="selecionaCliente(); return false;">
                        <div><img src="/FrontOfficeWeb/resources/images/transp.gif" width="1" height="5"></div>
                    </td>
                </tr>
            </table>
