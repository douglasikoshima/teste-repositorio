...
<netui-template:template templatePage="/resources/jsp/CRMTemplate.jsp">
    ...
    <netui-template:section name="headerSection">
        ...
        <script language="Javascript">
            ...
            function valida(){
                ...
                }else if(document.forms[0].elements['filtroHexa.nrLinha'].value == "Campo Inválido"){
    ...
    <netui-template:section name="bodySection">
        <acesso:controlHiddenItem nomeIdentificador="cli_mh_verpagina">
        ...
        <html:form action="/cliente/ConsultaHexa/monitorarHexa.do" styleId="idMonitorar" method="post">
            ...
            <table width="770">
                <tr>
                    ...
                    <td valign="middle" align="right">
                        ...
                        <acesso:controlHiddenItem nomeIdentificador="cli_mh_pesquisar">
