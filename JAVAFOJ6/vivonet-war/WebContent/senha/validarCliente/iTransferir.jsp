...
Versão.....: $Author: a5112272 $ - $Revision: 1.2 $ - $Date: 2011/05/25 14:29:15 $
-->
...
<acesso:controlHiddenItem nomeIdentificador="wor_itrans_verpagina">
    <form action="begin.do" tagId="formTransferecia" id="formTransferecia" method="post" name="validarClienteForm">
