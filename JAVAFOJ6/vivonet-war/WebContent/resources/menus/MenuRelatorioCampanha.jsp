...
<vivo:menu idMenuMin="mnMin" idMenuMax="mnMax" width="300px">
    <vivo:menuRaiz value="Campanha" haveNextMenu="N" title="Campanha" styleClass="menuItem" onclick="showMenu('menuRaiz', 'menuItemHolder');" style="cursor:pointer;" width="200px">
        <vivo:menuGrupo styleId="menuRaiz" styleClass="menuItemHolder" style="display:none;" menu="none">
            <vivo:menuItem page="/RelEfetividade.jsp" target="fraAbas" styleClass="menuItem" onmouseover="doHideAllSubMenu('menuRaiz');" onclick="hideMenu();mudarMenuMinMax();">Efetividade</vivo:menuItem>
            <vivo:menuItem page="/RelGerenciamento.jsp" target="fraAbas" styleClass="menuItem" onmouseover="doHideAllSubMenu('menuRaiz');" onclick="hideMenu();mudarMenuMinMax();">Gerenciamento</vivo:menuItem>
			<vivo:menuItem page="/RelMotivo.jsp" target="fraAbas" styleClass="menuItem" onmouseover="doHideAllSubMenu('menuRaiz');" onclick="hideMenu();mudarMenuMinMax();">Motivos</vivo:menuItem>
			<vivo:menuItem page="/RelRespostas.jsp" target="fraAbas" styleClass="menuItem" onmouseover="doHideAllSubMenu('menuRaiz');" onclick="hideMenu();mudarMenuMinMax();">Respostas</vivo:menuItem>
        </vivo:menuGrupo>
    </vivo:menuRaiz>
</vivo:menu>
