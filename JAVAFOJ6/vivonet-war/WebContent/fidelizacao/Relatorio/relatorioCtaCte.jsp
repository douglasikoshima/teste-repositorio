...
<netui-template:template templatePage="/resources/jsp/CRMTemplate.jsp">
    ...
    <vivo:sessao id="idFrelatorio" height="438" width="790" label="Controle de Crédito" operacoes="" scroll="Y">   
        ...
        <table width="790" class="tbl_bgGray">        
            <tr>
                ...
                <acesso:controlHiddenItem nomeIdentificador="fid_rel_ctacte_imp">
                    <img id="imprimir" src="/FrontOfficeWeb/resources/images/imprimir-retrato-nrml.gif" rolloverImage="/FrontOfficeWeb/resources/images/imprimir-retrato-over.gif" onClick="mostrarTelaImpressao('printCtaCte.do','Relatório de Controle de Crédito'); return false;" style="border:none" hspace="5" vspace="5"/>
                </acesso:controlHiddenItem>
                </td>
                <td align="right">
                <acesso:controlHiddenItem nomeIdentificador="fid_rel_ctacte_imp">
                    <img id="imprimir" src="/FrontOfficeWeb/resources/images/imprimir-paisagem-nrml.gif" rolloverImage="/FrontOfficeWeb/resources/images/imprimir-paisagem-over.gif" onClick="mostrarTelaImpressao('relatorioCtaCteImpressao.jsp','Relatório de Controle de Crédito'); return false;" style="border:none" hspace="5" vspace="5"/>
                </acesso:controlHiddenItem>
                </td>
                <td align="right">
