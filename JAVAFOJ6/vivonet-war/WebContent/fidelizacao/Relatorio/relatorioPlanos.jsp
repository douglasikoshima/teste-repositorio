...
<netui-template:template templatePage="/resources/jsp/CRMTemplate.jsp">
    ...
    <acesso:controlHiddenItem nomeIdentificador="fid_rel_plano_verpagina">
    ...
    <vivo:sessao id="idFrelatorio" height="438" width="790" label="Retenção por Planos" operacoes="" scroll="y">
        ...
        <table width="790" class="tbl_bgGray">        
            <tr>
                ...
                <td align="right">
                <acesso:controlHiddenItem nomeIdentificador="fid_rel_plano_imp">
                    <img id="imprimir" src="/FrontOfficeWeb/resources/images/imprimir-retrato-nrml.gif" rolloverImage="/FrontOfficeWeb/resources/images/imprimir-retrato-over.gif" onClick="mostrarTelaImpressao('printRetencaoPorPlanos.do','Relatório Retenção por Planos'); return false;" style="border:none" hspace="5" vspace="5"/>
                </acesso:controlHiddenItem>
                </td>
                <td align="right">
                <acesso:controlHiddenItem nomeIdentificador="fid_rel_plano_imp">
                    <img id="imprimir" src="/FrontOfficeWeb/resources/images/imprimir-paisagem-nrml.gif" rolloverImage="/FrontOfficeWeb/resources/images/imprimir-paisagem-over.gif" onClick="mostrarTelaImpressao('relatorioPlanosImpressao.jsp','Relatório Retenção por Planos'); return false;" style="border:none" hspace="5" vspace="5"/>
                </acesso:controlHiddenItem>
                </td>
                <td align="right">
                <acesso:controlHiddenItem nomeIdentificador="fid_rel_plano_arq">
