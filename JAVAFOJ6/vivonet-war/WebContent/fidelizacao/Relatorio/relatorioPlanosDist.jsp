...
<netui-template:template templatePage="/resources/jsp/CRMTemplate.jsp">
    ...
    <vivo:sessao id="idFrelatorio" height="438" width="790" label="Retenção por Planos Distinção" operacoes="" scroll="y">
        ...
        <table width="790" class="tbl_bgGray">        
            <tr>
                ...
                <acesso:controlHiddenItem nomeIdentificador="fid_rel_planosDist_imp">
                    <img id="imprimir" src="/FrontOfficeWeb/resources/images/imprimir-retrato-nrml.gif" rolloverImage="/FrontOfficeWeb/resources/images/imprimir-retrato-over.gif" onClick="mostrarTelaImpressao('printRetencaoPorPlanos.do','Relatório Retenção por Planos Distinção'); return false;" style="border:none" hspace="5" vspace="5"/>
                </acesso:controlHiddenItem>
                </td>
                <td align="right">
                <acesso:controlHiddenItem nomeIdentificador="fid_rel_planosDist_imp">
                    <img id="imprimir" src="/FrontOfficeWeb/resources/images/imprimir-paisagem-nrml.gif" rolloverImage="/FrontOfficeWeb/resources/images/imprimir-paisagem-over.gif" onClick="mostrarTelaImpressao('relatorioPlanosDistImpressao.jsp','Relatório Retenção por Planos Distinção'); return false;" style="border:none" hspace="5" vspace="5"/>
                </acesso:controlHiddenItem>
                </td>
                <td align="right">
