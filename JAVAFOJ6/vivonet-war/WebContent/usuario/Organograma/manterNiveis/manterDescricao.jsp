...
<html>
   ...
   <form action="<%=request.getContextPath()%>/usuario/Organograma/manterNiveis/begin.do" id="begin" name="begin" method="POST" onSubmit="return false;">
    ...
    <acesso:controlHiddenItem nomeIdentificador="usu_mdesc_verpagina">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td rowspan="2" valign="bottom" style="padding-left:4px;">
                        ...
                        <div id="dsNivel" style="display:block;" >
                            
                            <input type="text" name="dsNivel" maxlength="254" size="50"/>
                        </div>
                ...
                <tr>
                    ...
                    <acesso:controlHiddenItem nomeIdentificador="usu_mdesc_gravar">
