...
<bean:define id="AtendimentoVO"  name="com.bea.wlw.netui.pageflow.PageFlowUtils_currentPageFlow" property="formFormulario.atendimentoVO" />
<bean:define id="FormularioVO"   name="com.bea.wlw.netui.pageflow.PageFlowUtils_currentPageFlow" property="formFormulario.atendimentoVO.arvoreAtendimentoVO.formularioVO" type="br.com.vivo.fo.admsistemas.vo.FormularioVODocument.FormularioVO"/>
<bean:define id="GrupoCamposVO"  name="com.bea.wlw.netui.pageflow.PageFlowUtils_currentPageFlow" property="formFormulario.arrayGrupoCampos" type="br.com.vivo.fo.admsistemas.vo.AdmGrupoCamposVODocument.AdmGrupoCamposVO[]"/>

<html>
<head>
    <title>
        Administraçao de Sistemas - Visualização de Formulário Dinâmico
    </title>
                ...
                <tr>
                    ...
                    <logic:equal name="Campos" property="inPesquisa" value="1">
                        ...
                        <script>tdText<%=ctr%>.style.width="177";</script>
                            <html:text name="Form" property='<%= "valorCampo[" + ctr + "].valor" %>' style="WIDTH:125;"/>&nbsp;<img name="customerProfile" align="middle" src="<%=request.getContextPath()%>/resources/images/lupa_bg_ffffff.gif" style="cursor:hand">
                        </td>
                    </logic:equal> 
                    <logic:notEqual name="Campos" property="inPesquisa" value="1">               
                        <td align="left" width="150" style="border-style:none;">
                            ...
                            <script>tdText<%=ctr%>.style.width="177";</script>
                            <html:text name="Form" property='<%= "valorCampo[" + ctr + "].valor" %>' maxlength='<%=(String)TamanhoCampo%>' style="WIDTH:125;"/><img src="<%=request.getContextPath()%>\resources\images\calendario.gif" align="middle" style="cursor:hand;" title="Calendário">
                            </logic:equal>
                            <logic:notEqual name="TipoCampo" property="sgMascaraApresentacaoCampo" value="data">
                            <html:text name="Form" property='<%= "valorCampo[" + ctr + "].valor" %>' maxlength='<%=(String)TamanhoCampo%>' style="WIDTH:150;"/>
                            </logic:notEqual>
                        </td>
                    </logic:notEqual>
                </tr>
                        ...
                        <tr>
                            <td align="left" width="177" style="font-size: 9px;border-style:none;"><bean:write name="Campos" property="nmCampo" /></td>
                                <td id="tdValorCampo" align="left" width="150">
                                    <html:text readonly="true" name="Form" property='<%= "valorCampo[" + ctr + "].valor" %>' style="WIDTH:125;"/>&nbsp;<img name="customerProfile" align="middle" src="<%=request.getContextPath()%>/resources/images/lupa_bg_ffffff.gif" style="cursor:hand">
                                </td>
                        </tr>
                    </logic:equal>
                    <logic:notEqual name="Campos" property="inPesquisa" value="1">
...
%>
                        <tr>
                            ...
                            <td id="tdL<%=ctr%>" align="left" width="148">
                                <html:select name="Form" property='<%= "valorCampo[" + ctr + "].valor" %>' style="WIDTH:148px; font-size: 9px;">
                    ...
                    <fieldset style="width:690px;">
                        ...
                        <table width="690" style="font-size:9px">
                            <logic:iterate name="FormularioCampoVO" id="itemCampo" indexId="i" type="br.com.vivo.fo.admsistemas.vo.FormularioCampoVODocument.FormularioCampoVO">
                                <tr>
                                    <td id="containerCamposDependentes">
    
                                        <table id="tableDependentes1">
                                            <tr>
                                                ...
                                                <td nowrap>
                                                    ...
                                                    <select name="previewDependentes" style="width:150px">
                                    ...
                                    <td width="25%">
                                        ...
                                        <logic:equal name="TipoCampo" property="sgLayoutApresentacaoCampo" value="TEXT">
                                            ...
                                            <logic:notEqual name="itemCampo" property="inPesquisa" value="1">               
                                                ...
                                                <logic:equal name="TipoCampo" property="sgMascaraApresentacaoCampo" value="data">
                                                    <html:text name="Form" property='<%= "valorCampo[" + qtdeCampos + "].valor" %>' maxlength='<%=(String)TamanhoCampo%>' style="WIDTH:125;"/><img src="<%=request.getContextPath()%>\resources\images\calendario.gif" align="middle" style="cursor:hand;" title="Calendário" onclick="return showCalendar('<%= "valorCampo[" + qtdeCampos + "][" + i + "].valor" %>', '%d/%m/%Y');">
                                                </logic:equal>
                                                ...
                                                <logic:notEqual name="TipoCampo" property="sgMascaraApresentacaoCampo" value="data">
                                                    ...
                                                    idCampos[0] = "dsModeloAparelho";
                                                    idCampos[1] = "dsMarcaAparelho";
                                                    idCampos[2] = "dsTecnologia";
                                                    %>
                                                    <input type="text" name="valorCampo[<%=qtdeCampos%>].valor" id="<%=idCampos[contadorDadosAparelho]%>" value="" maxlength="<%=(String)TamanhoCampo%>" style="width:150px;">
                                                    <% 
                                                    contadorDadosAparelho++;
                                                    } else { %>
                                                    <html:text name="Form" property='<%= "valorCampo[" + qtdeCampos + "].valor" %>' maxlength='<%=(String)TamanhoCampo%>' style="WIDTH:150;"/>
                                                    <% } %>
                                        ...
                                        <logic:equal name="TipoCampo" property="sgLayoutApresentacaoCampo" value="SELECT">
                                            ...
                                            <logic:equal name="itemCampo" property="inPesquisa" value="1">
                                                <html:text readonly="true" name="Form" property='<%= "valorCampo[" + qtdeCampos + "].valor" %>' style="width:125;"/>&nbsp;<img name="customerProfile" align="middle" src="<%=request.getContextPath()%>/resources/images/lupa_bg_ffffff.gif" style="cursor:pointer">
                                            </logic:equal>
                        ...
                        <table width="690" border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <img src="<%=request.getContextPath()%>/resources/images/lupa_bg_ffffff.gif" style="border:none;cursor:pointer">
                                </td>
                            </tr>
                            <tr>
                                <td id="estado">Estado: <span id="spanEstado" style="font-weight:bold;"></span></td>
                                <td id="pais" colspan="2">País: <span id="spanPais" style="font-weight:bold;"></span></td>
                            </tr>
                        </table>
            ...
            <table border="0" width="100%">
                <tr>
                    ...
                    <td id="tdAreaObservacao" align="left" width="480">
                        <textarea name="observacaoAtendimento" style="width:450px;color:#006699;" rows="4"/></textarea>
                    </td>
                </tr>
            </table>
        </td>
