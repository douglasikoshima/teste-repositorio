...
<netui-template:template templatePage="../resources/jsp/CRMTemplate.jsp">
    ...
    <acesso:controlHiddenItem nomeIdentificador="adm_iadmsis_verpagina">
        <!--APLICAÇÃO->MENU-->
                ...
                <tr>                    
                    <td valign="middle" align="center">
                        <table width="462" height="101">
                            <tr>
                                <td><img src="/FrontOfficeWeb/resources/images/inmodulos_sistemas.jpg"></td>
                                <td width="10"></td>
                                <td><img src="/FrontOfficeWeb/resources/images/inmodulos_sistemas.gif"></td>
                            </tr>
                        </table>
                    </td>
                </tr>
