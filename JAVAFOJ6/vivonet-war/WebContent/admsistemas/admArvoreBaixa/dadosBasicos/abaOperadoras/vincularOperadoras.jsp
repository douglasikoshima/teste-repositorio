    ...
    <script language="Javascript">
        function salvar() {
            ...
            if((document.forms[0].dtInicioVigencia.value == '') && (search())){
                ...
                document.forms[0].dtInicioVigencia.value = hoje.getDate()+"/"+parseInt(hoje.getMonth()+1)+"/"+hoje.getFullYear();
            } else
            if((document.forms[0].dtInicioVigencia.value == '') && (!search())){
...
<body bgcolor="#ededed">
<acesso:controlHiddenItem nomeIdentificador="adm_opra_ver_pagina">

        <div><img src="/FrontOfficeWeb/resources/images/transp.gif" width="1" height="10"></div>
        
        <form action="salvaOperadora.do" method="post" name="formOperadora">
            
            <html:hidden name="FormOperadora" property="idBaixa"/>
                ...
                <td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" width="135">
                        ...
                        <tr>
                            ...
                            <td width="105">
                                <div id="dtOperadoraInicio" style="visibility:visible;">
                                    <input type="text" id="dtInicioVigencia" name="dtInicioVigencia" onfocus="this.blur();"  style='width:65px;' maxlength="10"/><img id="imgCalendDtAbFim" src="<%=request.getContextPath()%>/resources/images/calendario.gif" style="cursor:hand;" title="Calendário" onclick="return showCalendar('dtInicioVigencia', '%d/%m/%Y');">
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <div id="calVigencia" style="visibility:hidden;"><input type="text" id="dtFimVigencia"  onfocus="this.blur();" name="dtFimVigencia" style="width:65px;" maxlength="10"/><img id="imgCalendDtAbFim" src="<%=request.getContextPath()%>\resources\images\calendario.gif" style="cursor:hand;" title="Calendário" onclick="return showCalendar('dtFimVigencia', '%d/%m/%Y');"></div></td>
                        </tr>
                    </table>
                </td>
            ...
            <vivo:tbRows>
                <logic:iterate name="FormOperadora" property="listaOperadoras" id="regional">
                    <vivo:tbRow key="linha">
                        ...
                        <vivo:tbRowColumn>
                            <acesso:controlHiddenItem nomeIdentificador="adm_opra_alterar">
                                <a href="Javascript:editaOperadora('<bean:write name="regional" property="idUFOperadora"/>',
                                                                    '<bean:write name="regional" property="dtInicioVigencia"/>',
                                                                    '<bean:write name="regional" property="dtFimVigencia"/>',
                                                                    '<bean:write name="regional" property="sgUf"/>');">
        ...
        <table width="740">
            <tr>
                <td align="right">
                    <acesso:controlHiddenItem nomeIdentificador="adm_opra_salvar">
