        ...
        <script language="javascript" type="text/javascript">        
            ...
            function pesquisar(){
                if(validaForm()){
                    ...
                    new Ajax.Updater('dataTable', '<%=request.getContextPath()%>/admsistemas/relatorioGrupoRepresentante/pesquisar.do', {
                        method: 'post',
                        parameters: params,
                        evalScripts: true,
                        onSuccess: function() {
            ...
            function limpar(){
                document.forms[0].action = '<%=request.getContextPath()%>/admsistemas/relatorioGrupoRepresentante/clean.do';
                document.forms[0].submit();  
            }
            ...
            function exportar(){
                ...
                if(validaForm()){
                    if($F('dataInicio')!=""){
                        ...
                        f.action = "<%=request.getContextPath()%>/admsistemas/relatorioGrupoRepresentante/exportar.do";
                        f.target = "frmDown";
                        f.submit();
                    }else{
