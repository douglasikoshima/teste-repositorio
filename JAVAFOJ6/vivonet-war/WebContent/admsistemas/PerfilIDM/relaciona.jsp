        ...
        <!--
            ...
            validaForm = function(){
                if(($('idPerfil').value=='' || $('idPerfil').value=='0') && $('nmPerfil').value==''){
                    if((parent.$('idPerfil').value=='' || parent.$('idPerfil').value=='0') && parent.$('nmPerfil').value==''){
                ...
                if(!$('arrSeleGrupos').options.length>0){
                    alert('Por favor, selecione pelo menos 1(um) grupo.');
                    return false;
                }

                if(!$('arrSelecionados').options.length>0){
                    alert('Por favor, selecione pelo menos 1(uma) operadora.');
                    return false;
                }
                return true;
            }
            ...
            gravar = function(){
                if(validaForm()){
                    ...
                    for(i = 0; i<$('arrSeleGrupos').options.length; i++)
                        $('arrSeleGrupos').options[i].selected = true;
                    ...
                    <table width="95%" align="center">
                        <tr>
                            <td align="center" colspan="2">
                                <fieldset>
                                <legend style="font-weight:bold;">Relacionar Grupo</legend>
                                    <table width="100%" align="center">
                                        <tr>
                                            <td width="47%" align="center"><b>Disponíveis</b></td>
                                            <td width="5%">&nbsp;</td>
                                            <td width="47%" align="center"><b>Selecionados</b></td>
                                        </tr>
                                        <tr><td height="2"></td></tr>
                                        <tr>
                                            <td width="47%" align="center">&nbsp;
                                                <select name="arrDispGrupos" id="arrDispGrupos" style="width:225px;" size="8" class="SELECT" multiple tabindex="1">
                                                    <logic:present name="Form" property="lstDispGrupo">
                                                        <logic:iterate id="it1" name="Form" property="lstDispGrupo.itArray">
                                            ...
                                            <td width="5%" align="center">
                                                <img onclick="transfereSelecaoLista($('arrDispGrupos'),$('arrSeleGrupos'), false);" src="/FrontOfficeWeb/resources/images/bt_rightaln_nrml.gif" onmouseOut="this.src='/FrontOfficeWeb/resources/images/bt_rightaln_nrml.gif'" onMouseOver="this.src='/FrontOfficeWeb/resources/images/bt_rightaln_over.gif'" style="border:none;cursor:hand;">
                                                <br/><br/>
                                                <img onclick="transfereSelecaoLista($('arrDispGrupos'),$('arrSeleGrupos'), true);" src="/FrontOfficeWeb/resources/images/bt_leftaln_nrml.gif" onmouseOut="this.src='/FrontOfficeWeb/resources/images/bt_leftaln_nrml.gif'" onMouseOver="this.src='/FrontOfficeWeb/resources/images/bt_leftaln_over.gif'" style="border:none;cursor:hand;">
                                            </td>
                                            <td width="47%" align="center">&nbsp;
                                                <select name="arrSeleGrupos" id="arrSeleGrupos" style="width:225px;" size="8" class="SELECT" multiple tabindex="4">
                                                    <logic:present name="Form" property="lstSeleGrupo">
                                                        <logic:iterate id="it2" name="Form" property="lstSeleGrupo.itArray">
                                                            <option value="<bean:write name="it2" property="id"/>"><bean:write name="it2" property="ds"/></option>
                                                        </logic:iterate>
                                                    </logic:present>
                                                </select>
                                            </td>
                        ...
                        <tr>
                            <td align="center" colspan="2">
                                <fieldset>
                                <legend style="font-weight:bold;">Relacionar Operadora</legend>
                                <table width="100%" align="center">
                                    <tr>
                                        <td width="47%" align="center"><b>Disponíveis</b></td>
                                        <td width="5%">&nbsp;</td>
                                    ...
                                    <tr>
                                        <td width="47%" align="center">&nbsp;
                                            <select name="arrDisponiveis" id="arrDisponiveis" style="width:225px;" size="8" class="SELECT" multiple tabindex="5">
                                                <logic:present name="Form" property="lstDisponiveis">
                                                    <logic:iterate id="it3" name="Form" property="lstDisponiveis.itArray">
                                                        <option value="<bean:write name="it3" property="id"/>"><bean:write name="it3" property="ds"/></option>
                                                    </logic:iterate>
                                                </logic:present>
                                            </select>
                                        </td>
                                        ...
                                        <td width="47%" align="center">&nbsp;
                                            <select name="arrSelecionados" id="arrSelecionados" style="width:225px;" size="8" class="SELECT" multiple tabindex="8">
                                                <logic:present name="Form" property="lstSelecionados">
                                                    <logic:iterate id="it4" name="Form" property="lstSelecionados.itArray">
                                                        <option value="<bean:write name="it4" property="id"/>"><bean:write name="it4" property="ds"/></option>
                                                    </logic:iterate>
                                                </logic:present>
                                            </select>
                                        </td>
