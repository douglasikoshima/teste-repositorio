...
<vivo:tbTable selectable="true" resize="false" layoutWidth="765" layoutHeight="230" tableWidth="765" styleId="<%=style%>" sortable="true" onRowClick="">
 <vivo:tbHeader>
 ...
 <vivo:tbRow key="linha"> 
  ...
  <vivo:tbRowColumn>
      ...
      <html:hidden name="atdInBoxVO" property="idAtendimento"/>
  </vivo:tbRowColumn>
...
<script>    
    ...
    parent.startRefresh(3,mlSecondsRefresh);
    parent.showIfr("MensagensRC");
    parent.currentTab=3;
