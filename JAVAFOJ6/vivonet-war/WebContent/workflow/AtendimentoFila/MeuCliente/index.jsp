...
<bean:define id="Form" name="com.bea.wlw.netui.pageflow.PageFlowUtils_currentPageFlow" property="filaMeuClienteFiltrosForm" type="workflow.AtendimentoFila.MeuCliente.formBeans.FilaMeuClienteFiltrosForm" />

<netui-template:template templatePage="/resources/jsp/CRMTemplate.jsp">
<netui-template:setAttribute name="title" value="FrontOffice - Meu Cliente" />
<netui-template:setAttribute name="modulo" value="Fila de Processos Meu Cliente" />
	...
	<script type="text/javascript" language="javascript">
		...
		onload = function() {
            ...
            <logic:equal name="Form" property="inVoltar" value="true">
                ...
                <logic:equal name="Form" property="filtrosPesquisa.inPesquisaFullMC" value="1">
                $('inPesquisaFullMC').checked = true;
                </logic:equal>
        ...
        getUsuariosByIdGrupo = function(idGrupo) {
            ...
            if (idGrupo != '') {
                ...
                new Ajax.Request('/FrontOfficeWeb/workflow/AtendimentoFila/MeuCliente/getUsuariosByIdGrupo.do?' + params.toQueryString(), {
                    method: 'post',
                    onSuccess: function(e) {
                        ...
                        if (e.responseText != '') {
                            ...
                            } else if (jsonObj.AtendimentoInformacaoVO.UsuarioVIVO
                                    && jsonObj.AtendimentoInformacaoVO.UsuarioVIVO.length > 0) {
        ...
        limparCampos = function() {
            ...
            manageBloqueiaFormulario($('inPesquisaFullMC'));
        }
        ...
        getDetalheProcesso = function(obj) {
            ...
            if (controleDetalhe && (!$('divListaAlertas') || $('divListaAlertas').style.display == 'none')) {
                ...
                params.set('fila', escape("/FrontOfficeWeb/workflow/AtendimentoFila/MeuCliente/begin.do"));
                params.set('inCRI', 0);
                params.set('inRC', 0);
                ...
                if (window.top.frameApp.$('dvAnimarAguarde')) top.frameApp.startAnimation();
                top.frameApp.location = '/FrontOfficeWeb/workflow/AtendimentoDetalhe/begin.do?' + params.toQueryString();
...
<netui-template:section name="bodySection">
    ...
    <vivo:sessao id="bodyRelatoriosTracking" height="470" width="790" label="Workflow" operacoes="Fila de Processos Meu Cliente" scroll="N">
        <form name="formPesquisaProcessos" action="pesquisarProcessos" id="formPesquisaProcessos" method="post">
        ...
        <select multiple="true"
                name="indexesProcessosSelecionados"
                id="indexesProcessosSelecionados"
        ...
        <table id="tablePesquisa" width="100%" class="tbl_bggray" align="center">
            ...
            <tr>
                ...
                <td colspan="2" style="padding-left:14px;">
                    ...
                    <img id="imgLupa"
                         align="bottom"
                         src="<%=request.getContextPath()%>/resources/images/lupa_bg_transp.gif"
            ...
            <tr>
                <td colspan="4" align="right">
                    ...
                    <a href="javascript:void(0)" onmouseup="submitForm(false)"><img src="<%=request.getContextPath()%>/resources/images/bt_pesquisar_nrml.gif" border="0" style="margin-right:4px" /></a>
                </td>
            </tr>
        </table>
        <table class="tbl_bggray" width="780" cellspacing="0" cellpadding="0" border="0" height="24" style="margin-top:6px">
            <tr>
                <td width="127" align="center" height="24">Atualização: <span style="color:#1865c5">5 min</span></td>
                <td width="138" align="center">Vermelho: <span id="lblVermelho"></span></td>
                <td width="133" align="center">Amarelo: <span id="lblAmarelo"></span></td>
                <td width="118"  align="center">Normal: <span id="lblNormal"></span></td>
                <td width="178" align="center">Reg. Retornados: <span id="total"></span>
                </td>
        ...
        <span style="float:right;">
            <!--
            <img style="margin:5px 0 0 0;border:none;cursor:pointer"
                 src="<%=request.getContextPath()%>/resources/images/bt_encaminhar_nrml.gif"
                 onmouseup="encaminhar()" />
            <img style="margin:5px 0 0 0;border:none;cursor:pointer"
                 src="<%=request.getContextPath()%>/resources/images/bt_suspeito_nrml.gif"
                 onmouseup="suspeito()" />
            -->
        </span>
        </form>
