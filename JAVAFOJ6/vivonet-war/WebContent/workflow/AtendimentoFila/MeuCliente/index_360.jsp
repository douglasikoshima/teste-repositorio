...
<head>
    ...
    validarPesquisa = function() {
        ...
        if (formatPhoneNumber(document.getElementById('nrLinha').value) == false) {
...
<body id="vivo_360">
    <html:form styleId="formPesquisaProcessos" action="/workflow/AtendimentoFila/MeuCliente/pesquisarProcessos.do">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                Linha <html:text name="Form"
                                                 ...
                                                 styleId="nrLinha"
                                                 styleClass="protocolo camposPermissao"
                                                 onkeyup="managePermissaoEdicao(this);maskPhoneNumberObj(this)"
                                                 onblur="flTratamento=false"
                                                 maxlength="14"
                                                 size="50" />
                            </td>
                            <td>
