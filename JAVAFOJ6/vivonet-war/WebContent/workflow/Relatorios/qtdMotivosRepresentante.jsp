...
<script language="javascript">
    ...
    function submitGerar() {
        ...
        if (erros == "") {
            ...
            document.forms[0].action = "gerarQtdMotivoRepresentante.do";
...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/scripts/toolTip.js"></script>
    ...
    <acesso:controlHiddenItem nomeIdentificador="wor_qtdmr_verpagina">
        <!--APLICAÇÃO->MENU-->
        <jsp:include page="/resources/menus/MenuPrincipal.jsp" />
        <div><img src="<%=request.getContextPath()%>/resources/images/transp.gif" border="0" width="1" height="3"></div>

        <!--APLICACAO-->
            <vivo:sessao id="qdMain" height="475" width="790" label="Vivo Net >> Workflow >> Relatórios" operacoes="Quantidade e Motivos por Representante BKO" scroll="N">
                <form name="relatorioForm" id="formFiltro" action="gerarQtdMotivoRepresentante.do" method="post">
                <table cellpadding="5" cellspacing="0" border="0" width="100%" height="100%">
                            ...
                            <table cellpadding="2" cellspacing="0" border="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <html:checkbox name="relatorioForm" value="nmGrupoOperadora" property="quebra" styleClass="checkbox"> Quebra</html:checkbox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left" width="80%">
                                        ...
                                        <html:checkbox name="relatorioForm" value="UF" property="quebra" styleClass="checkbox"> Quebra</html:checkbox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">
                                    ...
                                    <td align="left">
                                        ...
                                        <html:checkbox name="relatorioForm" value="sgStatusUsuario" property="quebra" styleClass="checkbox"> Quebra</html:checkbox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">
                                    <html:radio name="relatorioForm" property="nivelSel" value="D"/> Diretoria:
                                    </td>
                                    <td align="left">
                                    <html:select name="relatorioForm" property="diretoriaSel" style="width:450px">
                                        <html:option value="-1" key="diretoriaSel">Todos</html:option>
                                        <html:options collection="diretoriaVO" property="idCargo" labelProperty="nmCargo"/>
                                    </html:select>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">
                                    <html:radio name="relatorioForm" property="nivelSel" value="A"/> Área:
                                    </td>
                                    <td align="left">
                                    <html:select name="relatorioForm" property="areaSel" style="width:450px">
                                        <html:option value="-1" key="areaSel">Todos</html:option>
                                        <html:options collection="areaVO" property="idCargo" labelProperty="nmCargo"/>
                                    </html:select>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">
                                    <html:radio name="relatorioForm" property="nivelSel" value="S"/> Sessão:
                                    </td>
                                    <td align="left">
                                    <html:select name="relatorioForm" property="sessaoSel" style="width:450px">
                                        <html:option value="-1" key="sessaoSel">Todos</html:option>
                                        <html:options collection="sessaoVO" property="idCargo" labelProperty="nmCargo"/>
                                    </html:select>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">
                                    <html:radio name="relatorioForm" property="nivelSel" value="C"/> Cargo:
                                    </td>
                                    <td align="left">
                                    <html:select name="relatorioForm" property="cargoSel" style="width:450px">
                                        <html:option value="-1" key="cargoSel">Todos</html:option>
                                        <html:options collection="cargoVO" property="idCargo" labelProperty="nmCargo"/>
                                    </html:select>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td align="left" valign="bottom">
                            <acesso:controlHiddenItem nomeIdentificador="wor_qtdmr_gerar">
