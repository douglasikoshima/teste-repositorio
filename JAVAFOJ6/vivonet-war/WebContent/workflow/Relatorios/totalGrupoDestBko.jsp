...
<netui-template:template templatePage="../../resources/jsp/CRMTemplate.jsp">
    ...
    <acesso:controlHiddenItem nomeIdentificador="wor_rtgrp_verpagina">
...
<script language="javascript">
    ...
    function submitGerar() {
        ...
        campoPrazo = document.forms[0].prazo;

        valida = false;
        for(i=0;i<campoPrazo.length;i++){
            if(campoPrazo[i].checked){
                valida = true;
                break;
            }
        }
        ...
        if (!valida) {
            erros += "Escolha um Prazo (Vivo/Anatel)!";
        }
        ...
        if (erros == "") {
            ...
            document.forms[0].action = "gerarTotalGrupoDestinoBKO.do";
...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/scripts/toolTip.js"></script>
        ...
        <vivo:sessao id="qdMain" height="475" width="790" label="Vivo Net >> Workflow >> Relatórios" operacoes="Total por Grupo de Destino BKO" scroll="N">
            <form id="formFiltro" action="gerarTotalGrupoDestinoBKO.do" method="post">
                <table cellpadding="5" cellspacing="0" border="0" width="100%" height="100%">
                            ...
                            <table cellpadding="2" cellspacing="0" border="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <html:select name="relatorioForm" property="grupoSel" style="width: 450px;" onchange="focaTipCampos(this.options[this.selectedIndex].text,this, 20, 162, 30);" onfocus="focaTipCampos(this.options[this.selectedIndex].text,this, 20, 162, 30);" onmouseover="focaTipCampos(this.options[this.selectedIndex].text,this, 20, 162, 30);" onblur="HideTip();" onmouseout="HideTip();">
                                        ...
                                        <%--<html:hidden name="relatorioForm" value="nmUsuarioAtual" property="quebra"/>--%>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">
                    ...
                    <tr>
                        <td align="left" valign="bottom">
                            <acesso:controlHiddenItem nomeIdentificador="wor_rtgrp_gerar">
