...
<body style="background-color:#E3ECF4;">
    <acesso:controlHiddenItem nomeIdentificador="wor_ic_verpagina">
        <form action="salvarContato.do" target="_parent" method="post">
            ...
            <table border="0" cellspacing="10" cellpadding="0">
                ...
                <tr> 
                    ...
                    <td>
                        <html:text name="Form" property="contato.dsContato" maxlength="255" style="width:350px;" styleId="dsContato" onkeyup="escolheMascara(this);" />
                    </td>
                </tr>
                <tr> 
                ...
                <tr>
                    ...
                    <acesso:controlHiddenItem nomeIdentificador="wor_ic_salvar">
