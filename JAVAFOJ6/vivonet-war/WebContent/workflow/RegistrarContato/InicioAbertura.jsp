...
<head>
    ...
    <body>
    <acesso:controlHiddenItem nomeIdentificador="wor_ia_verpagina">
        <html:form styleId="registrarContatoForm" action="/workflow/RegistrarContato/listarProcessos.do" method="post" onsubmit="return false;">
                    ...
                    <logic:equal name="Form" property="carregaLinha" value="1">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="linhaBusca" id="linhaBusca" value="" size="15" onblur="formatPhoneNumberObj(this);" maxlength="11" />&nbsp; <!-- onkeypress="checaTelefone(this)" -->
                    ...
                    <logic:equal name="Form" property="carregaLinha" value="2">
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                ...
                                <input type="text" name="linhaBusca" id="linhaBusca" value="" size="15" maxlength="11" onblur="formatPhoneNumberObj(this);" />&nbsp; <!-- onkeypress="checaTelefone(this);"  -->
                                <img src="<%=request.getContextPath()%>/resources/images/bt_pesquisar_nrml.gif" onclick="buscaContaByLinha($F('linhaBusca'));" border="0">
                            </td>
                        </tr>
                    </logic:equal>
                            ...
                            <table>
                                <tr>
                                    <td valign=top colspan="2">
                                        <html:select name="Form" property="tipoComunicacaoSelecionada" styleId="tipoComunicacaoSelecionada" onchange="obtemComunicacaoIFrame(this,document.forms['registrarContatoForm'].comunicacaoDisponivel);">
        ...
        <script language="javascript">
            ...
            function obterArvoreBaixa(){
                ...
                for( y = 0; y < registrarContatoForm.comunicacaoSelecionada.options.length; y++ )
                    registrarContatoForm.comunicacaoSelecionada.options[y].selected = true;

                for(x=0;x<$('nrLinhasSelecionadas').options.length;x++){
                    $('nrLinhasSelecionadas').options[x].selected = true;
                }

                idxTipoComunic = registrarContatoForm.tipoComunicacaoSelecionada.options.selectedIndex;
                registrarContatoForm.tipoComunicacaoSelecionada.options[idxTipoComunic].selected = true;
                if(registrarContatoForm.comunicacaoSelecionada.options.length == 0 && idxTipoComunic > 0 && registrarContatoForm.tipoComunicacaoSelecionada.options[idxTipoComunic].value != "0"){
                    //Ricardo
                    alert("Escolha pelo menos um Retorno no Tipo de Retorno!");
                ...
                idxCanal = registrarContatoForm.idCanal.options.value;
                if(idxCanal<1){
                    alert("Escolha um canal!");
                    return false;
                }
                idxProcedencia = registrarContatoForm.idProcedencia.options.value;
                if(idxProcedencia<1){
                ...
                <logic:equal name="Form" property="carregaLinha" value="2">
                    idxConta = registrarContatoForm.contaSelecionada.options.selectedIndex;
                    if(idxConta>0) registrarContatoForm.contaSelecionada.options[idxConta].selected = true;

                    idxLinha = registrarContatoForm.linhaSelecionada.options.selectedIndex;
                    if(idxLinha>0) registrarContatoForm.linhaSelecionada.options[idxLinha].selected = true;
                </logic:equal>
                //Liga animação
                if( top.frameApp.dvAnimarAguarde != null ) top.frameApp.startAnimation();
                /*document.forms["registrarContatoForm"].target = "ifrmAtendimento";
                document.forms["registrarContatoForm"].action = "obterArvoreBaixa.do";
                document.forms["registrarContatoForm"].submit();*/
                //$('ifrmAtendimento').src = "obterArvoreBaixa.do?"+$('registrarContatoForm').serialize();
                parent.document.all['ifrmAtendimento'].src = "obterArvoreBaixa.do?"+$('registrarContatoForm').serialize(); 
                return true;
            }
            ...
            function obtemLinhasIFrame(conta) {
                ...
                /*document.forms["registrarContatoForm"].target = "ifrmRegistrarContato";
                document.forms["registrarContatoForm"].action = "obterLinhas.do?INDEX=" + (conta.selectedIndex - 1);
                document.forms["registrarContatoForm"].submit();*/
            ...
            function obtemTipoComunicacaoIFrame() {
                //Monta o path seleção
                /*document.forms["registrarContatoForm"].target = "ifrmRegistrarContato";
                document.forms["registrarContatoForm"].action = "obterTipoComunicacao.do";
                document.forms["registrarContatoForm"].submit();*/
            ...
            function obtemComunicacaoIFrame(tipoComunicacao, comunicacaoDisponivel) {
                /*
                while(document.forms["registrarContatoForm"].elements["comunicacaoSelecionada"].options.length != 0)
                        document.forms["registrarContatoForm"].elements["comunicacaoSelecionada"].options.remove(0);
                */
                ...
                if(tipoComunicacao.value < 1){
                    ...
                    while(document.forms["registrarContatoForm"].elements["comunicacaoDisponivel"].options.length != 0)
                        document.forms["registrarContatoForm"].elements["comunicacaoDisponivel"].options.remove(0);
                    //limpa o combo de comunicação disponivel
                    while(document.forms["registrarContatoForm"].elements["comunicacaoSelecionada"].options.length != 0)
                        document.forms["registrarContatoForm"].elements["comunicacaoSelecionada"].options.remove(0);
                    return false;
                ...
                if (top.frameApp.document.getElementById("pesquisa")
                    ...
                    var aOptComponentsParentSelec = document.forms["registrarContatoForm"].elements["comunicacaoSelecionada"];
                    ...
                    if( top.frameApp.dvAnimarAguarde != null ) top.frameApp.startAnimation();
                    /*document.forms["registrarContatoForm"].target = "ifrmRegistrarContato";
                    document.forms["registrarContatoForm"].action = "obterComunicacao.do";
                    document.forms["registrarContatoForm"].submit();*/
            ...
            encaminharProcesso = function() {
                ...
                if (top.frameApp.$('divPopupTI') && !top.frameApp.$('divPopupTI').visible()) {
                    ...
                    if( top.frameApp.dvAnimarAguarde != null ) top.frameApp.startAnimation();
                    /*document.forms["registrarContatoForm"].target = "ifrmNumProc";
                    document.forms["registrarContatoForm"].action = "encaminharProcesso.do" + queryString + "&inAjax=false";
                    document.forms["registrarContatoForm"].method = 'POST';
                    document.forms["registrarContatoForm"].submit();*/
                    parent.document.all['ifrmNumProc'].src = "encaminharProcesso.do" + queryString + "&inAjax=false&" + $('registrarContatoForm').serialize();
                    return true;
                }
            };
            ...
            function fecInmediato() {
                ...
                if (top.frameApp.$('divPopupTI') && !top.frameApp.$('divPopupTI').visible()) {
                    ...
                    if( top.frameApp.dvAnimarAguarde != null ) top.frameApp.startAnimation();
                    /*document.forms["registrarContatoForm"].target = "ifrmNumProc";
                    document.forms["registrarContatoForm"].action = "encaminharProcesso.do?inAjax=false" + queryString;
                    document.forms["registrarContatoForm"].method = "POST";
                    document.forms["registrarContatoForm"].submit();*/
                    parent.document.all['ifrmNumProc'].src = "encaminharProcesso.do?inAjax=false" + queryString + "&" + $('registrarContatoForm').serialize();
                    return true;
                }
            ...
            regContato = function () {
                ...
                if (top.frameApp.$('divPopupTI') && !top.frameApp.$('divPopupTI').visible()) {
                    submitProcessoAjax('?inAjax=true' + queryString + "&"+$('registrarContatoForm').serialize());
                    parent.escondeBotoes();
                    return true;
			...
			submitProcessoAjax = function(requestParameters) {
                ...
                new Ajax.Request('encaminharProcesso.do' + requestParametersString, {
                    method: 'post',
                    parameters: $('registrarContatoForm').serialize(),
					onCreate: function() {
						if (window.top.frameApp.$('dvAnimarAguarde')) window.top.frameApp.startAnimation();
						...
						if (jsonObj.AtendimentoVO) {
							...
							if (jsonObj.AtendimentoVO.observacao) {
				                ...
				                if (jsonObj.AtendimentoVO.idAtendimento != 0) {
									var idAtendimento = "";
									idAtendimento = jsonObj.AtendimentoVO.idAtendimento;
				                	parent.ifrmAbas.listarProcessos(idAtendimento, jsonObj.AtendimentoVO.ArvoreAtendimentoVO.descricaoCompleta, jsonObj.AtendimentoVO.nrProtocolo);
            ...
            function listarProcessos(idAtendimento, descricaoArvore, nrProtocolo) {
                ...
                //document.forms["registrarContatoForm"].target = "ifrmListaProcessos";
                //document.forms["registrarContatoForm"].action = "listarProcessos.do";
                //document.forms["registrarContatoForm"].submit();
            }
            ...
            function abreCustomerProfile(){
                ...
                document.forms["registrarContatoForm"].target = "ifrmLupa";
                document.forms["registrarContatoForm"].action = "/FrontOfficeWeb/workflow/RegistrarContato/loadContato.do?idPessoaCliente=<bean:write name="Form" property="idPessoa" />";
                document.forms["registrarContatoForm"].submit();
            }
            ...
            if (document.forms["registrarContatoForm"].elements["comunicacaoSelecionada"].options[0]!=null && document.forms["registrarContatoForm"].elements["comunicacaoSelecionada"].options[0].value==""){
                while(document.forms["registrarContatoForm"].elements["comunicacaoSelecionada"].options.length != 0)
                    document.forms["registrarContatoForm"].elements["comunicacaoSelecionada"].options.remove(0);
            }
        </script>
