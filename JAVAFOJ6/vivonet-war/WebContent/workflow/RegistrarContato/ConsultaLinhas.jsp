...
<html>
    ...
    <body>
    <acesso:controlHiddenItem nomeIdentificador="wor_clinh_verpagina">
        ...
        <script>
            ...
            var aOptComponentsParent = parent.document.forms["registrarContatoForm"].elements["linhaSelecionada"];
