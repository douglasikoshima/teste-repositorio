...
<netui-template:template templatePage="/resources/jsp/templateUsuarioArvore.jsp">
    ...
    <acesso:controlHiddenItem nomeIdentificador="wor_acon_verpagina">
        <html:form action="/workflow/RegistrarContato/expandeArvoreContato" method="post" onsubmit="return false;">
