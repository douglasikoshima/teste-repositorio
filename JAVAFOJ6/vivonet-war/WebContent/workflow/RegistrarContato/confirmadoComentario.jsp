...
<html>
    ...
    <body>
            <center>Comentario do Contato <bean:write name="AtendimentoVO" property="arvoreAtendimentoVO.descricaoCompleta" />
            registrado no processo <bean:write name="AtendimentoVO" property="atendimentoSituacaoVO.nrProtocolo" format="######"/> .
            <br>
