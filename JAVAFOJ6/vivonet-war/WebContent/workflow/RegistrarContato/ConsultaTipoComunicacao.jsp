...
<html>
    ...
    <acesso:controlHiddenItem nomeIdentificador="wor_ctcu_verpagina">
        ...
        <script>
            ...
            var aOptComponentsParent = parent.document.forms["registrarContatoForm"].elements["tipoComunicacaoSelecionada"];
            var aOptComponentsParentDisp = parent.document.forms["registrarContatoForm"].elements["comunicacaoDisponivel"];
