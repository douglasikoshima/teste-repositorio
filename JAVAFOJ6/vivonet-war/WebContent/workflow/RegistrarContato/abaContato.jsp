...
<html>
    ...
    <acesso:controlHiddenItem nomeIdentificador="wor_acto_verpagina">
        <script>
                        ...
                        <vivo:tbRows>
                            <logic:iterate id="aba" name="Form" property="abaContato" indexId="idx">
                                <vivo:tbRow key="Linha">
                                    ...
                                    <vivo:tbRowColumn>
                                        <acesso:controlHiddenItem nomeIdentificador="wor_ac_alterar">
                                    ...
                                    <vivo:tbRowColumn>
                                        <acesso:controlHiddenItem nomeIdentificador="wor_ac_excluir">
        ...
        <table width="100%" height="20" bgcolor="#E3ECF4">
            <tr>
                <td align="right" valign="baseline">
                    <acesso:controlHiddenItem nomeIdentificador="wor_ac_adicionarcontato">
