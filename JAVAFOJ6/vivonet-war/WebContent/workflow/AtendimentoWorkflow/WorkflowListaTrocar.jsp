...
<script language="javascript">
    ...
    function submitAplicar() {
        ...
        document.forms["formTrocar"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/listaEncaminharGravar.do";
    ...
    function fechar()  {
        ...
        document.forms["formTrocar"].method = "POST";
        document.forms["formTrocar"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/atendimentoWorkflowVoltar.do";
    ...
    function submitGrupo() {
        ...
        document.forms["formTrocar"].method = "POST";
        document.forms["formTrocar"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/obterUsuario.do" + meuCliente;
        document.forms["formTrocar"].target = "iframeUsuario";
        document.forms["formTrocar"].submit();
    }
