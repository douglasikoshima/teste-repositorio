...
<acesso:controlHiddenItem nomeIdentificador="wor_wle_verpagina">
...
function carregaToolTip(content) {
 ...
 ttipObj.style.display='';
        ...
        <table border="0" width="100%">
            <tr>
                <td align="right">
                <acesso:controlHiddenItem nomeIdentificador="wor_wle_salvar">
                    <vivo:botao id="btAplicar" width="100px" height="15px" value="Gravar" styleClass="btTemplate" onclick="submitAplicar();"/>
                </acesso:controlHiddenItem>
                </td>
                <td align="left">
                <acesso:controlHiddenItem nomeIdentificador="wor_wle_fechar">
...
<script language="javascript">
    ...
    function submitAplicar() {
        ...
        document.forms["formEncaminhar"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/listaEncaminharGravar.do";
    ...
    function fechar()  {
        ...
        document.forms["formEncaminhar"].method = "POST";
        document.forms["formEncaminhar"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/atendimentoWorkflowVoltar.do";
    ...
    function submitGrupo() {
        ...
        document.forms["formEncaminhar"].method = "POST";
        document.forms["formEncaminhar"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/obterUsuario.do" + meuCliente;
        document.forms["formEncaminhar"].target = "iframeUsuario";
        document.forms["formEncaminhar"].submit();
    }
