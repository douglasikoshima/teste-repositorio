...
<bean:define id="usuariosVO" name="com.bea.wlw.netui.pageflow.PageFlowUtils_currentPageFlow" property="atendimentoForm.usuarioVIVO" />

<html>
    <body>
    <acesso:controlHiddenItem nomeIdentificador="wor_atus_verpagina">
        ...
        <script>
            ...
            var oOptionParent = parent.document.forms[0].elements["usuarioSel"];
