...
<acesso:controlHiddenItem nomeIdentificador="wor_ebko_verpagina">
            ...
            <tr>
        		...
        		<tr>
                    ...
                    <table width="100%" border="0" bgcolor="#E3ECF4">
                        <tr>
                            <td align="left">
                            <acesso:controlHiddenItem nomeIdentificador="wor_ebko_salvar">
...
<script language="javascript">
    ...
    function submitAplicar() {
        ...
        document.forms["formEncerrar"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/listaEncerrarGravar.do";
