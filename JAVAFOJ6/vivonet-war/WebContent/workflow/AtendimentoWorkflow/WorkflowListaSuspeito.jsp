...
<acesso:controlHiddenItem nomeIdentificador="wor_wls_verpagina">
...
<form action="listaSuspeitoGravar.do" name="atendimentoForm" method="post" tagId="formSuspeito" id="formSuspeito">
    ...
    <vivo:tbTable selectable="lista" layoutWidth="740" layoutHeight="110" tableWidth="740" styleId="tableTitle3" sortable="true" onRowClick="">
        ...
        <vivo:tbRows>
            <%String textoContato = ConstantesCRM.SVAZIO;%>
    ...
    <table border="0" width="100%">
        <tr>
            <td align="right">
                <acesso:controlHiddenItem nomeIdentificador="wor_wls_aplicar">
                    <vivo:botao id="btAplicar" width="100px" height="15px" value="Gravar" styleClass="btTemplate" onclick="submitAplicar();"/>
                </acesso:controlHiddenItem>
            </td>
            <td align="left">
                <acesso:controlHiddenItem nomeIdentificador="wor_wls_fechar">
...
<script type="text/javascript">
    <!--
        ...
        function submitAplicar() {
            ...
            document.forms["formSuspeito"].action = "<%=request.getContextPath()%>/workflow/AtendimentoWorkflow/listaSuspeitoGravar.do";
        ...
        function fechar(){
            ...
            document.forms["formSuspeito"].method = "POST";
            document.forms["formSuspeito"].action = "<%=request.getContextPath()%>/workflow/AtendimentoWorkflow/atendimentoWorkflowVoltar.do";
