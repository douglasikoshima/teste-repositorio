...
<head>
    ...
    <script language="JavaScript">
        <!--
            ...
            function voltarFila(){
                top.frameApp.location.href="/FrontOfficeWeb/workflow/AtendimentoFila/beginResp.do?voltar=1";
            }
                ...
                <logic:match value="S" name="wFAcaoRetornoVO" property="acaoExecucao">
                    ...
                    //Retorno do questionario
                        <logic:equal value="quest" name="wFAcaoRetornoVO" property="urlDestino">
                            <logic:empty name="form" property="fila">
                                top.frameApp.location.href='/FrontOfficeWeb/workflow/AtendimentoFila/begin.do';
                                //Fim animação
                        ...
                        <logic:notEqual value="1" name="wFAcaoRetornoVO" property="urlDestino">
                            <logic:equal value="3" name="wFAcaoRetornoVO" property="urlDestino">
                                    ...
                                    <logic:notEmpty name="form" property="fila">
                                        parent.window.location.href = '/FrontOfficeWeb/workflow/AtendimentoDetalhe/begin.do?idAtendimento='+document.all["idAtendimento"].value+'&inMenu=S&fila=<bean:write name="form" property="fila"/>&inCRI='+document.all["inCRI"].value;
                                    </logic:notEmpty>
                            </logic:equal>
                            <logic:notEqual value="3" name="wFAcaoRetornoVO" property="urlDestino">
                                <logic:equal value="2" name="wFAcaoRetornoVO" property="urlDestino">
                                    //parent.document.forms[0].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/atendimentoWorkflowVoltar.do";
                                    ...
                                    <logic:empty name="form" property="fila">
                                        top.frameApp.document.getElementById('ifrmAtendimento').src = '/FrontOfficeWeb/workflow/AtendimentoDetalhe/begin.do?idAtendimento='+document.all["idAtendimento"].value+'&inMenu=N&inCRI='+document.all["inCRI"].value'+'&fila=';
                                    </logic:empty>
                                </logic:equal>
                    ...
                    <%if(request.getAttribute("inRespCliente")!=null && "1".equals(request.getAttribute("inRespCliente").toString())){%>
                        parent.document.forms[0].action = "/FrontOfficeWeb/workflow/AtendimentoInBoxResposta/begin.do";
                        parent.document.forms[0].target = "frameApp";
                        <%request.removeAttribute("inRespCliente"); %>
                    <%}else{%>
                        parent.document.forms[0].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/testesBegin.do";
...
<body>
<acesso:controlHiddenItem nomeIdentificador="wor_eacao_verpagina">
    ...
    <table border="0" width="100%">
        <tr>
            <td align="center">
            <acesso:controlHiddenItem nomeIdentificador="wor_eacao_fechar">
                ...
                <%}else if("/FrontOfficeWeb/workflow/AtendimentoFila/beginResp.do".equals(request.getParameter("fila"))){%>
