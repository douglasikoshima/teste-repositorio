...
<script>
    ...
    function expandirNo(idBaixa) {
        ...
        document.forms[0].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/obtemArvoreBaixaParte.do";
    ...
    function submitAplicar() {
        ...
        if (!erro) {
            ...
            <logic:notEmpty name="ENCERRAROV" scope="request">
                document.forms[0].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/confirmaCancelamentoOV.do";            
            </logic:notEmpty>            
