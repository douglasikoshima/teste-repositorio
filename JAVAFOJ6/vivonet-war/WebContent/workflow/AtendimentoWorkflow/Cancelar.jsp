...
<head>
    ...
    <script language="javascript">
        ...
        function submitAplicar() {
            ...
            document.forms[0].action = "cancelarGravar.do";
...
<acesso:controlHiddenItem nomeIdentificador="wor_can_verpagina">
<form action="cancelarGravar.do" method="post" name="atendimentoForm">
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <acesso:controlHiddenItem nomeIdentificador="wor_can_gravar">
