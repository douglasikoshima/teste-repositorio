...
<acesso:controlHiddenItem nomeIdentificador="wor_fec_verpagina">
<form action="fechamentoGravar.do" method="post" name="atendimentoForm">
    ...
    <table width="100%" border="0">
        ...
        <tr>
            ...
            <acesso:controlHiddenItem nomeIdentificador="wor_fec_gravar">
    ...
    <vivo:quadroFlutuante id="dvPesqForm" idIframe="ifrmPesqForm" width="270" height="200" spacesTop="25" spacesLeft="250" display="none" url="<%=request.getContextPath()%>" src="/FrontOfficeWeb/workflow/AtendimentoWorkflow/pesquisaFormulario.do" onclick="ativar_combos();"/>
