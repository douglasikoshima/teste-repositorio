...
<acesso:controlHiddenItem nomeIdentificador="wor_encto_verpagina">
            ...
            <tr>
                ...
                <td valign="top" width="325">
                    ...
                    <table width="100%" border="0" bgcolor="#E3ECF4">
                        <tr>
                            <td align="left">
                            <acesso:controlHiddenItem nomeIdentificador="wor_encto_salvar">
...
<script language="javascript">
    ...
    function submitAplicar() {
        ...
        document.forms["formEncerrar"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/listaEncerrarGravar.do?idBaixa=" + document.all['dvCodigoBaixa'].innerText;
    ...
    function iniciaEncerramento(codBaixa) {
        ...
        document.forms["formEncerrar"].method = "POST";
        document.forms["formEncerrar"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/listaEncerrarPesquisarResposta.do";
