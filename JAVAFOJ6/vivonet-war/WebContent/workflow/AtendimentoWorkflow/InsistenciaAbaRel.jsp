...
<head>
    ...
    <script language="javascript">
        ...
        function submitAplicar() {
            ...
            document.forms[0].action = "insistenciaGravarAbaRel.do";
...
<body>
<!-- acesso:controlHiddenItem nomeIdentificador="wor_ins_verpagina_abarel"-->
<form action="insistenciaGravarAbaRel.do" method="post" name="atendimentoForm">
    ...
    <table border="0" width="100%">
        ...
        <tr>
            <td colspan="4" valign="bottom" align="right" width="100%">
                <!-- acesso:controlHiddenItem nomeIdentificador="wor_ins_gravar_abarel"-->
