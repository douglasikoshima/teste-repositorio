...
<acesso:controlHiddenItem nomeIdentificador="wor_con_verpagina">
<form action="concluirGravar.do" name="atendimentoForm" method="post">
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <acesso:controlHiddenItem nomeIdentificador="wor_con_gravar">
...
<script language="javascript">
    ...
    function submitAplicar() {
        ...
        document.forms[0].action = "concluirGravar.do";
