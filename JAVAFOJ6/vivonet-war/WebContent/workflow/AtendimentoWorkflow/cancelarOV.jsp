...
<acesso:controlHiddenItem nomeIdentificador="wor_arvba_verpagina">
...
<vivo:body idTable="tbMain" idDiv="dvMain" height="<%=altura%>" width="<%=largura%>">
    ...
    <form action="confirmaCancelamentoOV.do" name="atendimentoForm" method="post">
        ...
        <div id="divQuest" style="width:745px;height:220px;overflow-y:auto;overflow-x:auto">
            <table width="720" border="0" bgcolor="#E3ECF4" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <acesso:controlHiddenItem nomeIdentificador="wor_arvba_salvar">
    ...
    <!--form-->
    <iframe scrolling="yes" style="display:none;" name="iframeCancelarOrdemVenda" height="0" width="0"></iframe>    
    </form>
...
<script>
    ...
    function expandirNo(idBaixa) {
        ...
        document.forms[0].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/obtemArvoreBaixaParteOrdemVenda.do";
        document.forms[0].target = "iframeCancelarOrdemVenda";
    ...
    function lupaDocumentosTecnicos() {
        ...
        document.forms[0].method = "POST";
        document.forms[0].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/documentoAssociadoBegin.do?docTec=1";
    ...
    function submitAplicar() {
        ...
        if (!erro) {
            ...
            document.forms[0].method = "POST";
            document.forms[0].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/listaEncerrarGravar.do";
