...
<vivo:tbTable selectable="true" resize="false" layoutWidth="765" layoutHeight="266" tableWidth="765" styleId="<%=style%>" sortable="true" onRowClick="parent.linhaSel(this);">
 <vivo:tbHeader>
 ...
 <vivo:tbRow key="linha"> 
  <vivo:tbRowColumn><bean:write name="atdInBoxVO" property="dtAbertura"/></vivo:tbRowColumn>
                    <vivo:tbRowColumn><bean:write name="atdInBoxVO" property="nrProtocolo" format="###"/><html:hidden name="atdInBoxVO" property="nrProtocolo"/></vivo:tbRowColumn>
