    ...
    <head>
        ...
        <SCRIPT>        
            ...
            function submitPesquisa(obj) {       
                if(parent.document.getElementById('tipoPesquisaAdq').value=='RAZAO'){
                    if ((window.event && event.keyCode == '13') ||
                        ...
                        if(trim(document.forms[0].nome.value) == ""){
                            ...
                            document.getElementById("tipoPesquisa").value = parent.document.getElementById('tipoPesquisaAdq').value+"RC";
    ...
    <body leftmargin="10">
        ...
        <form action="pesquisarCRI.do" method="post" name="grupoCRIForm">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <% if (request.getParameter("tipoPesquisaAdq").equals("NOME")){ %>
                ...
                <% }else if (request.getParameter("tipoPesquisaAdq").equals("RAZAO")){ %>
                
                    <tr>
                        <td width="100">&nbsp;&nbsp;Razão Social:</td>
                        <td width="460"><html:text name="Form" property="grupoCRI.pesquisa.filtro.dsValor"      style="width:450px;" maxlength="254" styleId="nome"/></td>
                    </tr>
