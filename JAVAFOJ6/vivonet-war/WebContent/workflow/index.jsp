...
<netui-template:template templatePage="../resources/jsp/CRMTemplate.jsp">
    ...
    <netui-template:section name="bodySection">
        <!--APLICAÇÃO->MENU-->
        <jsp:include page="/resources/menus/MenuWorkflow.jsp" />
                ...
                <tr>                    
                    <td valign="middle" align="center">
                        <table width="462" height="101">
                            <tr>
                                <td><img src="/FrontOfficeWeb/resources/images/inmodulos_workflow.jpg"></td>
                                <td width="10"></td>
                                <td><img src="/FrontOfficeWeb/resources/images/inmodulos_workflow.gif"></td>
                            </tr>
                        </table>
                    </td>
                </tr>
