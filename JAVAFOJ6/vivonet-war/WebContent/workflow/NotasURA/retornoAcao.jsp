...
<body>
<acesso:controlHiddenItem nomeIdentificador="ntura_ret_verpagina">
<form>
        ...
        <tr>
            <td align="center">
                ...
                <logic:match value="N" name="acaoVO" property="acaoExecucao">
                    Operação não Concluída!&nbsp;<bean:write name="acaoVO" property="mensagem" />
                </logic:match>
                </b></font>
            </td>
        </tr>
...
<script language=javascript>
    ...
    function fechar() {
        ...
        //parent.document.forms[0].action = '/FrontOfficeWeb/workflow/NotasUra/editarNotaURA.do'; 
        //parent.document.forms[0].target = "ifrmIncluirNota";
