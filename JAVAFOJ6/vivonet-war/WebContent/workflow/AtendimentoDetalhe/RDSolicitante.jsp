    ...
    <tr>
        ...
        <td>
            <img src="<%=request.getContextPath()%>/resources/images/bt_consultargestor_nrml.gif"
                 ...
                 onclick="window.top.frameApp.createNewPopUp('gestorGerenteConta', 'Consultar Gestor/Gerente', 780, 500, null, '/FrontOfficeWeb/workflow/AtendimentoDetalhe/getGestorGerenteConta.do', true, null);"/>
        </td>
    </tr>
</table>
