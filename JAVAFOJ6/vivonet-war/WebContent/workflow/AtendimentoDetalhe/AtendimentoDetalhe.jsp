...
<netui-template:template templatePage="./../../resources/jsp/CRMTemplate.jsp">
    ...
    <acesso:controlHiddenItem nomeIdentificador="wor_ad_verpagina">
        ...
        <vivo:sessao id="qdMain" height="473" width="790" label="Processo" operacoes="Detalhamento" scroll="no">
            ...
            <vivo:abaGrupo id="btAbaInfo" width="778" height="10" styleClass="abatexto">
                <acesso:controlHiddenItem nomeIdentificador="wor_ad_abadetalhes"><vivo:abaItem id="btInfo01" onclick="abaSelected(btAbaInfo, btInfo01); abaDetalhes();" value="Detalhes" select="S"/></acesso:controlHiddenItem>
                <acesso:controlHiddenItem nomeIdentificador="wor_ad_abaatendimento"><vivo:abaItem id="btInfo02" onclick="abaSelected(btAbaInfo, btInfo02); abaAtendimento();" value="Atendimento"/></acesso:controlHiddenItem>
                <acesso:controlHiddenItem nomeIdentificador="wor_ad_abasolicitante"><vivo:abaItem id="btInfo03" onclick="abaSelected(btAbaInfo, btInfo03); abaSolicitante();" value="Solicitante"/></acesso:controlHiddenItem>
                <acesso:controlHiddenItem nomeIdentificador="wor_ad_abanivelprocesso"><vivo:abaItem id="btInfo04" onclick="abaSelected(btAbaInfo, btInfo04); abaNivelProc();" value="N&iacute;vel do Processo"/>    </acesso:controlHiddenItem>            
                        ...
                        <tr>
                            ...
                            <acesso:controlInitEnv/>
                                <vivo:abaGrupo id="btAba" width="300px" height="10px" styleClass="abatexto">
                                    <acesso:controlHiddenItem nomeIdentificador="wor_ad_abahistorico"><vivo:abaItem id="bt01" onclick="abaSelected(btAba, bt01); historico();" value="Histórico" select="S"/></acesso:controlHiddenItem>
                                    <acesso:controlHiddenItem nomeIdentificador="wor_ad_abaselecione"><vivo:abaItem id="bt05" onclick="abaSelected(btAba, bt05); abaDinamica();" value="Selecionar Operação"/>  </acesso:controlHiddenItem>                              
        ...
        <script language="javascript">
            ...
            */
            ...
            function fechamento() {
                ...
                document.forms["frmSelecao"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/fechamentoBegin.do?idAtividade=" + abaValue + "&idTabelaMotivo=4";
                document.forms["frmSelecao"].submit();
            }

            function encerramentoBKO() {
                document.forms["frmSelecao"].target = "ifrmAbas";
                document.forms["frmSelecao"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/encerramentoBegin.do?docTec=0&idAtividade=" + abaValue;
                document.forms["frmSelecao"].submit();
            }
            
            function encerramentoDocTecBKO() {
                document.forms["frmSelecao"].target = "ifrmAbas";
                document.forms["frmSelecao"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/encerramentoBegin.do?docTec=1&idAtividade=" + abaValue;
                document.forms["frmSelecao"].submit();
            }

            function concluir() {
                document.forms["frmSelecao"].target = "ifrmAbas";
                document.forms["frmSelecao"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/concluirBegin.do?idAtividade=" + abaValue + "&idTabelaMotivo=3";
                document.forms["frmSelecao"].submit();
            }
            
            function devolverBKO() {
                document.forms["frmSelecao"].target = "ifrmAbas";
                document.forms["frmSelecao"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/devolverBegin.do?idAtividade=" + abaValue + "&idTabelaMotivo=2";
                document.forms["frmSelecao"].submit();
            }
            
            function encaminhar() {
                document.forms["frmSelecao"].target = "ifrmAbas";
                document.forms["frmSelecao"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/encaminharBegin.do?idAtividade=" + abaValue + "&idTabelaMotivo=1";
                document.forms["frmSelecao"].submit();
            }

            function reabertura() {
                document.forms["frmSelecao"].target = "ifrmAbas";
                document.forms["frmSelecao"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/reaberturaBegin.do?idAtividade=" + abaValue;
                document.forms["frmSelecao"].submit();
            }
            
            function pausa() {
                document.forms["frmSelecao"].target = "ifrmAbas";
                document.forms["frmSelecao"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/pausaBegin.do?idAtividade=" + abaValue + "&idTabelaMotivo=5";
                document.forms["frmSelecao"].submit();
            }
            
            function cancelar() {
                document.forms["frmSelecao"].target = "ifrmAbas";
                document.forms["frmSelecao"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/cancelarBegin.do?idAtividade=" + abaValue;
                document.forms["frmSelecao"].submit();
            }
            
            function insistencia() {
                document.forms["frmSelecao"].target = "ifrmAbas";
                document.forms["frmSelecao"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/insistenciaBegin.do?idAtividade=" + abaValue + '&qtInsistencia=<bean:write name="atdVO" property="qtInsistencia"/>';
                document.forms["frmSelecao"].submit();
            }
            
            function documentoAssociado() {
                document.forms["frmSelecao"].target = "ifrmAbas";
                document.forms["frmSelecao"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/documentoAssociadoBegin.do?idAtividade=" + abaValue + '&idProcedencia=<bean:write name="procVO" property="idProcedencia" format=""/>';
                document.forms["frmSelecao"].submit();
            }
            
            function solucaoTecnica() {
                document.forms["frmSelecao"].target = "ifrmAbas";
                document.forms["frmSelecao"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/testesBegin.do?idAtividade=" + abaValue;
                document.forms["frmSelecao"].submit();
            }
            
            function suspeito() {
                document.forms["frmSelecao"].target = "ifrmAbas";
                document.forms["frmSelecao"].action = "/FrontOfficeWeb/workflow/AtendimentoWorkflow/suspeitoBegin.do?idAtividade=" + abaValue + "&idTabelaMotivo=6";
                document.forms["frmSelecao"].submit();
            }
            ...
            */
            ...
            <logic:notEmpty name="atdVO" property="idAtendimentoOrigem">
                function exibeLinkOrigem(){
                    document.forms["frmSelecao"].action = "/FrontOfficeWeb/workflow/AtendimentoDetalhe/detalheBegin.do?idAtendimento="+<bean:write name="atdVO" property="idAtendimentoOrigem"/>+"&inMenu=N";
