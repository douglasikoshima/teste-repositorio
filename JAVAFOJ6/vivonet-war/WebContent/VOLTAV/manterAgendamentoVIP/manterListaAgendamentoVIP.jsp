...
<bean:define id="Form" name="com.bea.wlw.netui.pageflow.PageFlowUtils_currentPageFlow" property="formManterAgendamentoVIP" type="VOLTAV.manterAgendamentoVIP.ManterAgendamentoVIPController.FormManterAgendamentoVIP"/>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/scripts/validacao.js"></script>
    <script type="text/javascript" language="javascript">
        ...
        function alterarAgendamento(idAgendamentoParam){
            ...
            top.frameApp.showPopupTI('Agendamento VIP > Incluir/Alterar Agendamento',700,550,30,"/FrontOfficeWeb/VOLTAV/manterAgendamentoVIP/buscaAlteracaoAgendamento.do?tipoOperacao=alterar&idAgendamento=" + idAgendamentoParam);
        ...
        {
            top.frameApp.showPopupTI('Agendamento VIP > Detalhe Agendamento',630,320,100,"/FrontOfficeWeb/VOLTAV/manterAgendamentoVIP/visualizarDetalhes.do?idAgendamento=" + idAgendamentoParam);
        }
        
        function incluirAlterarAlerta(idAgendamentoParam){
        
            top.frameApp.showPopupTI('Agendamento VIP > Lembrete de Agendamento',630,220,150,"/FrontOfficeWeb/VOLTAV/manterAgendamentoVIP/buscaAlertaAgendamento.do?idAgendamento=" + idAgendamentoParam);
            
        }
        
        function agendar(){
        
            top.frameApp.showPopupTI('Agendamento VIP > Incluir/Alterar Agendamento',700,550,30,"/FrontOfficeWeb/VOLTAV/manterAgendamentoVIP/buscaAlteracaoAgendamento.do?tipoOperacao=incluir");
...
<acesso:controlHiddenItem nomeIdentificador="voltav_lista_ag_verpagina">
...
<SCRIPT FOR=window EVENT=onload LANGUAGE="JScript">
    ...
    <logic:equal name="fechaJanela" value="true">    
        ...
        <logic:present name="msgPerguntaAlteracao" scope="request">
            ...
            if(confirm('<bean:write name="msgPerguntaAlteracao" scope="request"/>')){
                top.frameApp.showPopupTI('Agendamento VIP > Lembrete de Agendamento',630,220,170,"/FrontOfficeWeb/VOLTAV/manterAgendamentoVIP/buscaAlertaAgendamento.do");
                
            // LEVA PARA A TELA DE DETALHES
            }else{
            
                top.frameApp.showPopupTI('Agendamento VIP > Detalhe Agendamento',630,320,170,"/FrontOfficeWeb/VOLTAV/manterAgendamentoVIP/visualizarDetalhes.do");
            }
            ...
            <logic:present name="listaAlerta" scope="request">
                ...
                top.frameApp.showPopupTI('Agendamento VIP > Lembrete de Agendamento',630,220,170,"/FrontOfficeWeb/VOLTAV/manterAgendamentoVIP/buscaAlertaAgendamento.do","Utilize o botão Gravar para confirmar o envio do lembrete.");
            </logic:present>
    ...
    <logic:present name="msgSucessoAlerta" scope="request">
            ...
            top.frameApp.showPopupTI('Agendamento VIP > Detalhe Agendamento',630,320,170,"/FrontOfficeWeb/VOLTAV/manterAgendamentoVIP/visualizarDetalhes.do?msgSucessoAlertaDetalhe=" + "<bean:write name="msgSucessoAlerta" scope="request"/>");
