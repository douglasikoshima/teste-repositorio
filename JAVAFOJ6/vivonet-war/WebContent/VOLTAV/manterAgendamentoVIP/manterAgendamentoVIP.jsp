...
<head>
    ...
    <script language="javaScript">
        ...
        function buscaCidadePorUF(obj){
            ...
            document.formManterAgendamentoVIP.action = "buscaMunicipioPorUf.do";
        ...
        function buscaLojaPorUfMunicipio(obj){
            ...
            document.formManterAgendamentoVIP.action = "buscaLojaPorUfMunicipio.do";
            top.frameApp.mostrar_div();
            document.formManterAgendamentoVIP.submit();
        ...
        function buscarHorarios(){
            ...
            if(validaDadosBuscaHorario()){
                ...
                if(validarFaixaData()){
                    ...
                    document.formManterAgendamentoVIP.action = "buscarHorarios.do";
                    top.frameApp.mostrar_div();
                    document.formManterAgendamentoVIP.submit();
            ...
            if(valida()){
                if(validarFaixaData()){
                    if(verificaAssunto()){
                        ...
                        document.formManterAgendamentoVIP.action = "agendar.do";
    ...
    function valida(){
          ...
          if((document.formManterAgendamentoVIP.radioQuestionario) && document.formManterAgendamentoVIP.radioQuestionario.value == ''){
        ...
        function validarFaixaData() {
            ...
            dt = document.formManterAgendamentoVIP.dtAgendamento.value;
            dtMin = document.formManterAgendamentoVIP.dataMinima.value;
            dtMax = document.formManterAgendamentoVIP.dataMaxima.value;
        ...
        function assunto1Change() {
            ...
            document.formManterAgendamentoVIP.action = 'obterAssunto2.do';
            document.formManterAgendamentoVIP.target = '';
            top.frameApp.mostrar_div();
            document.formManterAgendamentoVIP.submit();
        ...
        function assunto2Change() {
            ...
            document.formManterAgendamentoVIP.action = 'obterAssunto3.do';
            document.formManterAgendamentoVIP.target = '';
            top.frameApp.mostrar_div();
            document.formManterAgendamentoVIP.submit();
        ...
        function assunto3Change() {
            ...
            document.formManterAgendamentoVIP.action = 'obterAssunto4.do';
            document.formManterAgendamentoVIP.target = '';
            top.frameApp.mostrar_div();
            document.formManterAgendamentoVIP.submit();
        ...
        function carregaRadio(valor){
            document.formManterAgendamentoVIP.radioQuestionario.value = valor;
        }
        ...
        function limpaCampos(obj){
            ...
            document.formManterAgendamentoVIP.dtAgendamento.value = "";
        ...
        function verificaAssunto(){
				...
				for (i=0;i<document.formManterAgendamentoVIP.elements.length;i++) {

					if(document.formManterAgendamentoVIP.elements[i].type == "text"){

						if(document.formManterAgendamentoVIP.elements[i].value == ''){
							alert(msg);
							return false;
						}
					}

					if(document.formManterAgendamentoVIP.elements[i].type == "select-one"){
						if(document.formManterAgendamentoVIP.elements[i].selectedIndex == 0){
							alert(msg);
							return false;
						}
					}
    ...
    function carregaLoja(op){
        ...
        document.formManterAgendamentoVIP.idLoja.value = op;
        document.getElementById('divListaLoja').style.display = 'none';
