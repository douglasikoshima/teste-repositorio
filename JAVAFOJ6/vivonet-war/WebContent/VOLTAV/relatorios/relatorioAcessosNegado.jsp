...
<netui-template:template templatePage="../../resources/jsp/CRMTemplate.jsp">
        ...
        <script language="javascript">
            function submitGerar() {
                ...
                if (erros == "") {
                    ...
                    document["formFiltro"].action = "gerarRelatorioAcessosNegado.do";
    ...
    <netui-template:section name="bodySection">
        ...
        <!--APLICACAO-->
            <vivo:sessao id="qdMain" height="475" width="790" label="Acessos Negado" operacoes="Gerar Relatório">
                <form name="formFiltro" action="/VOLTAV/relatorios/gerarRelatorioAcessosNegado.do" method="post">
