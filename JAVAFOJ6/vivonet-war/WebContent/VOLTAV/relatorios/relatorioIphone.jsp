...
<netui-template:template templatePage="../../resources/jsp/CRMTemplate.jsp">
        ...
        <script language="javascript">
            function submitGerar() {
                ...
                if (erros == "") {
                    ...
                    document["formFiltro"].action = "gerarRelatorioIphone.do";
    ...
    <netui-template:section name="bodySection">
        ...
        <!--APLICACAO--> 
            <vivo:sessao id="qdMain" height="475" width="790" label="Relatorio iPhone" operacoes="Gerar Relatório">
                <html:form styleId="formFiltro" action="/VOLTAV/relatorios/gerarRelatorioIphone.do" method="post">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                       ...
                       <tr>
						...
						<tr>
                            <td align="left"><b>Opt-in:</b></td>
                            <td align="left">
                                <html:radio name="form" property="optIn" value="0" style="border:none;background-color:#E3ECF4;">&nbsp;Todos&nbsp;&nbsp;&nbsp;&nbsp;</html:radio>
                                <html:radio name="form" property="optIn" value="1" style="border:none;background-color:#E3ECF4;">&nbsp;Sim&nbsp;&nbsp;&nbsp;&nbsp;</html:radio>
                                <html:radio name="form" property="optIn" value="2" style="border:none;background-color:#E3ECF4;">&nbsp;N&atilde;o</html:radio>
                            </td>
                        </tr>                          
                    </table>
                    <br>
