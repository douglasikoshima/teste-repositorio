...
<netui-template:template templatePage="../../resources/jsp/CRMTemplate.jsp">
    ...
    <netui-template:section name="bodySection">
        ...
        <vivo:sessao id="qdMain" height="475" width="790" label="Geração de Senhas" operacoes="Relatório">

            <form action="gerarRelatorioBaseClientes.do" method="post" name="relatorioAcessosForm">
                    ...
                    <tr>
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" style="font-family: Tahoma, Arial; font-size: 10px; font-weight: bold; color: #ffffff; border: #D4D7DE 1px solid;">
                                <tr bgcolor="#545454">
                                    <td align="center" width="65" rowspan="3">DIA</td>
                                    <td align="center" width="17%" style="display:<bean:write name="relLayout" property="apenasTAV" />" rowspan="3">Loja</td>
                                    <td align="center" width="11%" style="display:<bean:write name="relLayout" property="apenasTAV" />" rowspan="3">Terminal</td>
                                    <td align="center" width="60" rowspan="3">Total</td>
                                ...
                                <tr bgcolor="#545454">
                                    ...
                                    <td align="center" style="display:<bean:write name="relLayout" property="displayTAVPOS" />" height="25" colspan="2">Controle (<bean:write name="relLayout" property="tipoTecnologia" />)</td>
                                </tr>
                                <tr bgcolor="#545454">
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" style="font-family: Tahoma, Arial; font-size: 10px; color: #000000; border: #D4D7DE 1px solid;">
                                <netui-data:repeater dataSource="{pageContext.form.relatorioAdesoesBaseClientes}">
                                    <netui-data:repeaterItem>
                                        <tr bgcolor="#E3ECF4">
                                            <td align="center" height="25" width="65" valign="middle"><netui:content value="{container.item.dtRegistroHistorico}"/></td>
                                            <td width="17%" style="display:<bean:write name="relLayout" property="apenasTAV" />"><netui:content value="{container.item.dsLoja}"/></td>
                                            <td width="11%" style="display:<bean:write name="relLayout" property="apenasTAV" />"><netui:content value="{container.item.nrTerminal}"/></td>
                                            <td align="center" height="25" width="60" valign="middle"><netui:content value="{container.item.qtTotal}"/></td>
                                    ...
                                    <netui-data:repeaterFooter>
                                        <tr bgcolor="#E3ECF4">
                                            <td align="center" colspan="<bean:write name="relLayout" property="colspanTotal" />" height="25" width="65" valign="middle"></td>
                                            <td align="center" height="25" width="60" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAdesoesBaseClientes[0]}"/></b></td>
                                            <td align="center" style="display:<bean:write name="relLayout" property="displayVOLPRE" />"  height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAdesoesBaseClientes[1]}"/></b></td>
                                            <td align="center" style="display:<bean:write name="relLayout" property="displayVOLPRE" />"  height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAdesoesBaseClientes[2]}"/></b></td>
                                            <td align="center" style="display:<bean:write name="relLayout" property="displayVOLPOS" />"  height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAdesoesBaseClientes[3]}"/></b></td>
                                            <td align="center" style="display:<bean:write name="relLayout" property="displayVOLPOS" />"  height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAdesoesBaseClientes[4]}"/></b></td>
                                            <td align="center" style="display:<bean:write name="relLayout" property="displayVOLCON" />"  height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAdesoesBaseClientes[5]}"/></b></td>
                                            <td align="center" style="display:<bean:write name="relLayout" property="displayVOLCON" />"  height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAdesoesBaseClientes[6]}"/></b></td>
                                            <td align="center" style="display:<bean:write name="relLayout" property="displayTAVPRE" />"  height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAdesoesBaseClientes[7]}"/></b></td>
                                            <td align="center" style="display:<bean:write name="relLayout" property="displayTAVPRE" />"  height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAdesoesBaseClientes[8]}"/></b></td>
                                            <td align="center" style="display:<bean:write name="relLayout" property="displayTAVPOS" />"  height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAdesoesBaseClientes[9]}"/></b></td>
                                            <td align="center" style="display:<bean:write name="relLayout" property="displayTAVPOS" />"  height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAdesoesBaseClientes[10]}"/></b></td>
                                            <td align="center" style="display:<bean:write name="relLayout" property="displayTAVCON" />"  height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAdesoesBaseClientes[11]}"/></b></td>
                                            <td align="center" style="display:<bean:write name="relLayout" property="displayTAVCON" />"  height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAdesoesBaseClientes[12]}"/></b></td>
                                        </tr>
                                    </netui-data:repeaterFooter>
                                </netui-data:repeater>
                            </table>
                ...
                <table width="100%">
                    <tr>
                        <td align="center">
                            <vivo:botao id="btFechar" width="60px" height="10px" value="Voltar" styleClass="btTemplate" onclick="location.href='relatorioBaseClientes.do'"/>
                        </td>
                    </tr>
                </table>
