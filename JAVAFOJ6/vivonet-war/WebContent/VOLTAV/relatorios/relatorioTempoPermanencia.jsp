...
<netui-template:template templatePage="../../resources/jsp/CRMTemplate.jsp">
        ...
        <script language="javascript">
            function submitGerar() {
                ...
                if (erros == "") {
                    ...
                    document["formFiltro"].action = "gerarRelatorioTempoPermanencia.do";
    ...
    <netui-template:section name="bodySection">
        ...
        <!--APLICACAO--> 
            <vivo:sessao id="qdMain" height="475" width="790" label="Tempo Permanência" operacoes="Gerar Relatório">
...
<!--                             <td align="left"> -->
<%--                                 <netui : select tagId="terminais" dataSource="terminalSelecionado" style="width:200px" onChange="setIp(this.options[this.selectedIndex].text);"/> --%>
<!--                             </td> -->
                            <td align="left">
