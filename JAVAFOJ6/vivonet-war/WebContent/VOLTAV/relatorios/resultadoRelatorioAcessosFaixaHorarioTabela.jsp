                    ...
                    <tr>
                        <td>
                            <table  width="100%" border="0" cellpadding="0" cellspacing="1" style="font-family: Tahoma, Arial; font-size: 10px; font-weight: bold; color: #ffffff; border: #D4D7DE 1px solid;">
                                <tr bgcolor="#545454" >
									<td align="center" height="50" width="40">Horário</td>
                                    <td align="center" height="25" width="25"><b>0</b></td>
									<td align="center" height="25" width="25"><b>1</b></td>
									<td align="center" height="25" width="25"><b>2</b></td>
									<td align="center" height="25" width="25"><b>3</b></td>
									<td align="center" height="25" width="25"><b>4</b></td>
									<td align="center" height="25" width="25"><b>5</b></td>
									<td align="center" height="25" width="25"><b>6</b></td>
									<td align="center" height="25" width="25"><b>7</b></td>
									<td align="center" height="25" width="25"><b>8</b></td>
									<td align="center" height="25" width="25"><b>9</b></td>
									<td align="center" height="25" width="25"><b>10</b></td>
									<td align="center" height="25" width="25"><b>11</b></td>
									<td align="center" height="25" width="25"><b>12</b></td>
									<td align="center" height="25" width="25"><b>13</b></td>
									<td align="center" height="25" width="25"><b>14</b></td>
									<td align="center" height="25" width="25"><b>15</b></td>
									<td align="center" height="25" width="25"><b>16</b></td>
									<td align="center" height="25" width="25"><b>17</b></td>
									<td align="center" height="25" width="25"><b>18</b></td>
									<td align="center" height="25" width="25"><b>19</b></td>
									<td align="center" height="25" width="25"><b>20</b></td>
									<td align="center" height="25" width="25"><b>21</b></td>
									<td align="center" height="25" width="25"><b>22</b></td>
									<td align="center" height="25" width="25"><b>23</b></td>
                                </tr>
									<tr bgcolor="#E3ECF4" style="font-family: Tahoma, Arial; font-size: 10px; color: #000000; border: #D4D7DE 1px solid; display:<bean:write name="relLayout" property="displayVOL"/>">
										<td align="center" height="50" bgcolor="#545454"><font color="#FFFFFF">Média de Acessos VOL</font></td>
										<netui-data:repeater dataSource="{pageContext.form.listaVOL}">
											<netui-data:repeaterItem>
												<td align="center" height="25" width="25"><netui:content value="{container.item}"/></td>
											</netui-data:repeaterItem>
										</netui-data:repeater>
									</tr>
									<tr bgcolor="#E3ECF4" style="font-family: Tahoma, Arial; font-size: 10px; color: #000000; border: #D4D7DE 1px solid; display:<bean:write name="relLayout" property="displayTAV"/>"">
										<td align="center" height="50" bgcolor="#545454"><font color="#FFFFFF">Média de Acessos TAV</font></td>
										<netui-data:repeater dataSource="{pageContext.form.listaTAV}">
											<netui-data:repeaterItem>
												<td align="center" height="25" width="25"><netui:content value="{container.item}"/></td>
											</netui-data:repeaterItem>
										</netui-data:repeater>
