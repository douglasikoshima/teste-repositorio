...
<netui-template:template templatePage="../../resources/jsp/CRMTemplate.jsp">
    ...
    <netui-template:section name="bodySection">
        ...
        <vivo:sessao id="qdMain" height="475" width="790" label="Acessos por Dia" operacoes="Relatório">

            <form action="gerarRelatorioAcessos.do" name="relatorioAcessosForm" method="post">
                    ...
                    <tr>
                        <td>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" style="font-family: Tahoma, Arial; font-size: 10px; color: #000000; border: #D4D7DE 1px solid;">
                                <netui-data:repeater dataSource="{pageContext.form.relatorioAcessoDiario}">
                                    ...
                                    <netui-data:repeaterFooter>
                                        <tr bgcolor="#E3ECF4">
											...
											<td align="center" height="25" width="11%" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAcessoDiario[0]}"/></b></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayVOLPRE" />" height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAcessoDiario[1]}"/></b></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayVOLPRE" />" height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAcessoDiario[2]}"/></b></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayVOLPOS" />" height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAcessoDiario[3]}"/></b></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayVOLPOS" />" height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAcessoDiario[4]}"/></b></td>
                                            <td align="center" style="display:<bean:write name="relLayout" property="displayVOLCON" />" height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAcessoDiario[5]}"/></b></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayVOLCON" />" height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAcessoDiario[6]}"/></b></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayTAVPRE" />" height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAcessoDiario[7]}"/></b></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayTAVPRE" />" height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAcessoDiario[8]}"/></b></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayTAVPOS" />" height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAcessoDiario[9]}"/></b></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayTAVPOS" />" height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAcessoDiario[10]}"/></b></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayTAVCON" />" height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAcessoDiario[11]}"/></b></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayTAVCON" />" height="25" width="74" valign="middle"><b><netui:content value="{pageContext.form.totaisRelatorioAcessoDiario[12]}"/></b></td>
                                        </tr>
                                    </netui-data:repeaterFooter>
                                </netui-data:repeater>
                            </table>
