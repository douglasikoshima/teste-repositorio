...
<netui-template:template templatePage="../../resources/jsp/CRMTemplate.jsp">
        ...
        <script language="javascript">
            function submitGerar() {
                ...
                if (erros == "") {
                    ...
                    document["formFiltro"].action = "gerarRelatorioPrimeiroAcesso.do";
    ...
    <netui-template:section name="bodySection">
        ...
        <!--APLICACAO--> 
            <vivo:sessao id="qdMain" height="475" width="790" label="Primeiro Acesso" operacoes="Gerar Relatório">
                <html:form styleId="formFiltro" action="/VOLTAV/relatorios/gerarRelatorioPrimeiroAcesso.do" method="post">
                    <!-- <netui : hidden tagId="ipTerminalSelecionado" dataSource="ipTerminalSelecionado" /> -->
