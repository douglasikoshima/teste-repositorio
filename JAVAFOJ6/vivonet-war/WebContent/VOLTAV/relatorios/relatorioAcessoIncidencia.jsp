...
<netui-template:template templatePage="../../resources/jsp/CRMTemplate.jsp">
        ...
        <script language="javascript">
            function submitGerar() {
                ...
                if (erros == "") {
                    ...
                    document["formFiltro"].action = "gerarRelatorioAcessoIncidencia.do";
    ...
    <netui-template:section name="bodySection">
        ...
        <!--APLICACAO--> 
            <vivo:sessao id="qdMain" height="475" width="790" label="Clientes por Incidência" operacoes="Gerar Relatório">
                <html:form styleId="formFiltro" action="/VOLTAV/relatorios/gerarRelatorioAcessoIncidencia.do" method="post">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            ...
                            <!-- <td align="left"> -->
                                <!-- < netui :select dataSource="operadoraSelecionada" optionsDataSource="operadoras" style="width:200px" onChange="submitOperadoras();"/> -->
                            <!-- </td> -->
                            <td align="left">
                        ...
                        <tr>
                            ...
                            <!-- <td align="left"> -->
                                <!-- <netui : select tagId="regionais" dataSource="regionalSelecionada" style="width:200px" onChange="regionalChange();"/> -->
                            <!-- </td> -->
                            <td align="left">
                        ...
                        <tr>
                            ...
                            <!-- <td align="left"> -->
                                <!-- <netui : select dataSource="carteiraSelecionada" optionsDataSource="carteiras" style="width:200px"/> -->
                            <!-- </td> -->
                            <td align="left">
                        ...
                        <tr>
                            ...
                            <!-- <td align="left"> -->
                                <!-- <netui : select dataSource="segmentoSelecionada" optionsDataSource="segmentos" style="width:200px"/> -->
                            <!-- </td> -->
                            <td align="left">
                       ...
                       <tr>
                        ...
                        <tr>
                            ...
                            <!-- <td align="left"> -->
                                <!-- <netui : select tagId="canal" dataSource="canalSelecionado" optionsDataSource="canais" style="width:200px" onChange="canalChange();"/> -->
                            <!-- </td> -->
                            <td align="left">
                        ...
                        <tr>
                            ...
                            <!-- <td align="left"> -->
                                <!-- <netui : select dataSource="tipoLinhaSelecionado" optionsDataSource="tipoLinha" style="width:200px"/> -->
                            <!-- </td> -->
                            <td align="left">
                        ...
                        <tr>
                            ...
                            <!-- <td align="left"> -->
                                <!-- <netui : select dataSource="tecnologiaSelecionada" optionsDataSource="tecnologias" style="width:200px"/> -->
                            <!-- </td> -->
                            <td align="left">
                        ...
                        <tr id="trLoja" style="display: none;">
                            ...
                            <!-- <td align="left"> -->
                                <!-- <netui : select tagId="lojas" dataSource="lojaSelecionada" style="width:380px" onChange="lojaChange();"/> -->
                            <!-- </td> -->
                            <td align="left">
                        ...
                        <tr id="trTerminal" style="display: none;">
                            ...
                            <!-- <td align="left"> -->
                                <!-- <netui : select tagId="terminais" dataSource="terminalSelecionado" style="width:200px"/> -->
                            <!-- </td> -->
                            <td align="left">
                                <html:select styleId="terminalSelecionado" name="form" property="terminalSelecionado" style="width:200px">
                                </html:select>
                            </td>
                        </tr>
