...
<netui-template:template templatePage="../../resources/jsp/CRMTemplate.jsp">
    ...
    <netui-template:section name="bodySection">
        ...
        <vivo:sessao id="qdMain" height="475" width="790" label="Tempo Permanência" operacoes="Relatório">

            <form action="gerarRelatorioTempoPermanencia.do" method="post" name="relatorioAcessosForm">
                        ...
                        <td>
                            <table  width="100%" border="0" cellpadding="0" cellspacing="1" style="font-family: Tahoma, Arial; font-size: 10px; font-weight: bold; color: #ffffff; border: #D4D7DE 1px solid;">
                                <tr bgcolor="#545454">
                                    ...
                                    <td align="center" width="11%" rowspan="3">Total Acessos</td>
                                    <td align="center" width="11%" rowspan="3">Total Utilização</td>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" style="font-family: Tahoma, Arial; font-size: 10px; color: #000000; border: #D4D7DE 1px solid;">
                                <netui-data:repeater dataSource="{pageContext.form.relatorioTempoPermanencia}">
                                    <netui-data:repeaterItem>
                                        <tr bgcolor="#E3ECF4">
                                            ...
                                            <td align="center" height="25" width="11%" valign="middle"><netui:content value="{container.item.qtTotalAcessos}"/></td>
                                            <td align="center" height="25" width="11%" valign="middle"><netui:content value="{container.item.tmTotalUtilizacao}"/></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayVOLPRE" />" height="25" width="74" valign="middle"><netui:content value="{container.item.tmVOLPreCliente}"/></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayVOLPRE" />" height="25" width="74" valign="middle"><netui:content value="{container.item.tmVOLPreUsuario}"/></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayVOLPOS" />" height="25" width="74" valign="middle"><netui:content value="{container.item.tmVOLPosCliente}"/></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayVOLPOS" />" height="25" width="74" valign="middle"><netui:content value="{container.item.tmVOLPosUsuario}"/></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayVOLCON" />" height="25" width="74" valign="middle"><netui:content value="{container.item.tmVOLConCliente}"/></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayVOLCON" />" height="25" width="74" valign="middle"><netui:content value="{container.item.tmVOLConUsuario}"/></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayTAVPRE" />" height="25" width="74" valign="middle"><netui:content value="{container.item.tmTAVPreCliente}"/></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayTAVPRE" />" height="25" width="74" valign="middle"><netui:content value="{container.item.tmTAVPreUsuario}"/></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayTAVPOS" />" height="25" width="74" valign="middle"><netui:content value="{container.item.tmTAVPosCliente}"/></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayTAVPOS" />" height="25" width="74" valign="middle"><netui:content value="{container.item.tmTAVPosUsuario}"/></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayTAVCON" />" height="25" width="74" valign="middle"><netui:content value="{container.item.tmTAVConCliente}"/></td>
											<td align="center" style="display:<bean:write name="relLayout" property="displayTAVCON" />" height="25" width="74" valign="middle"><netui:content value="{container.item.tmTAVConUsuario}"/></td>
                                        </tr>
                                    </netui-data:repeaterItem>
                                </netui-data:repeater>
                            </table>
                ...
                <table width="100%">
                    <tr>
                        <td align="center">
                            <vivo:botao id="btFechar" width="60px" height="10px" value="Voltar" styleClass="btTemplate" onclick="location.href='relatorioTempoPermanencia.do'"/>
                        </td>
                    </tr>
                </table>
