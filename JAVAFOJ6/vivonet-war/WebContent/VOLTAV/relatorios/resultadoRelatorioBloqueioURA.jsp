...
<netui-template:template templatePage="../../resources/jsp/CRMTemplate.jsp">
    ...
    <netui-template:section name="bodySection">
        ...
        <vivo:sessao id="qdMain" height="475" width="790" label="Bloqueio e Desbloqueio de Acesso" operacoes="Relatório">

            <form action="gerarRelatorioUtilizacaoServicos.do" name="relatorioAcessosForm" method="post">
                        ...
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" style="font-family: Tahoma, Arial; font-size: 10px; font-weight: bold; color: #ffffff; border: #D4D7DE 1px solid;">
                                <tr bgcolor="#545454">
									...
									<td width="10%" id="headerVOL" align="center" height="25">Quantidade</td>
                                </tr>
                            </table>
                            <table border="0" width="100%" cellpadding="0" cellspacing="1" style="font-family: Tahoma, Arial; font-size: 10px; color: #000000; border: #D4D7DE 1px solid;">
                                <netui-data:repeater dataSource="{pageContext.form.relatorioUtilizacaoServicos}">
                                    <tr bgcolor="#E3ECF4">
										...
										<td width="10%" id="contenVOL" align="center" height="25" valign="middle"><netui:content value="{container.item.qtURA}"/></td>
                                    </tr>
                                </netui-data:repeater>
                                ...
                                <tr bgcolor="#E3ECF4">
                                    ...
                                    <td width="10%" id="contenTAV" align="center" height="25" valign="middle"><b><netui:content value="{pageContext.form.vlrURATotalServicos}"/></b></td>
                                </tr>
                            </table>
                ...
                <table width="100%">
                    <tr>
                        <td align="center">
                            <vivo:botao id="btFechar" width="60px" height="10px" value="Voltar" styleClass="btTemplate" onclick="location.href='relatorioBloqueioURA.do'"/>
                        </td>
                    </tr>
                </table>
