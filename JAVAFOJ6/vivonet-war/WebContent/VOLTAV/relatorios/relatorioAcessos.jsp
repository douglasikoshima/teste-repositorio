...
<netui-template:template templatePage="../../resources/jsp/CRMTemplate.jsp">
        ...
        <script language="javascript">
            ...
            function submitGerar() {
                ...
                if (erros == "") {
                    ...
                    document["formFiltro"].action = "gerarRelatorioAcessos.do";
    ...
    <netui-template:section name="bodySection">
        ...
        <!--APLICACAO--> 
            <vivo:sessao id="qdMain" height="475" width="790" label="Acessos" operacoes="Gerar Relatório">
                <html:form styleId="formFiltro" action="/VOLTAV/relatorios/gerarRelatorioAcessos.do" method="post">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <html:radio name="form" property="sumarizacao" value="D" style="border:none;background-color:#E3ECF4;" onclick="mostrarTipo(0);">&nbsp;Dia&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</html:radio>
                                <html:radio name="form" property="sumarizacao" value="H" style="border:none;background-color:#E3ECF4;" onclick="mostrarTipo(1);">&nbsp;Faixa de Horário</html:radio>
                            </td>
                        </tr>
                        <tr id="objtipo" style="display:none">
                            <td align="left">
                                <b>Apresentar:</b>
                            </td>
                            <td align="left">
                                <html:radio name="form" property="isGrafico" value="1" style="border:none;background-color:#E3ECF4;">&nbsp;Gráfico&nbsp;</html:radio>
                                <html:radio name="form" property="isGrafico" value="0" style="border:none;background-color:#E3ECF4;">&nbsp;Tabela&nbsp;</html:radio>
                            </td>
                        </tr>
            ...
            <script language="javascript">
                var apresentar =  document.getElementById("objtipo");
                function mostrarTipo(id){
                    if(id==1)
                        apresentar.style.display = '';
                    else
