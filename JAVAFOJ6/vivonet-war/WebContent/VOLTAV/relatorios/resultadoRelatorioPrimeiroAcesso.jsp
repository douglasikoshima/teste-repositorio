...
<netui-template:template templatePage="../../resources/jsp/CRMTemplate.jsp">
    ...
    <netui-template:section name="bodySection">
        ...
        <vivo:sessao id="qdMain" height="475" width="790" label="Primeiro Acesso" operacoes="Relatório">

            <form action="gerarRelatorioPrimeiroAcesso.do" method="post" name="relatorioAcessosForm">
                    ...
                    <tr>
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" style="font-family: Tahoma, Arial; font-size: 10px; font-weight: bold; color: #ffffff; border: #D4D7DE 1px solid;">
                                <tr bgcolor="#545454">
                                    <td align="center" width="10%" rowspan="3">DIA</td>
                                    ...
                                    <td align="center" width="16%" rowspan="3">Total</td>
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="1" style="font-family: Tahoma, Arial; font-size: 10px; color: #000000; border: #D4D7DE 1px solid;">
                                <netui-data:repeater dataSource="{pageContext.form.relatorioPrimeiroAcesso}">
                                    <netui-data:repeaterItem>
										 <tr bgcolor="#E3ECF4">
                                            <td align="center" height="25" width="10%" valign="middle"><netui:content value="{container.item.dtPrimeiroAcesso}"/></td>
                                            ...
                                            <td align="center" height="25" width="16%" valign="middle"><netui:content value="{container.item.qtTotal}"/></td>
				...
				<br>
				<table bgcolor="#E3ECF4" border="0" style="font-family: Tahoma, Arial; font-size: 10px; color: #000000; border: #D4D7DE 0px solid;">
				<logic:notEmpty name="form" property="vlrTotalPrimeiroAcessoVOL">
					<tr>
						<td align="left" style="display:<bean:write name="relLayout" property="displayVOL" />" height="25" width="43%" valign="middle"><b>Total Clientes VOL até o momento:</b></td>
						<td align="left" style="display:<bean:write name="relLayout" property="displayVOL" />" height="25" width="20%" valign="middle"><netui:content value="{pageContext.form.vlrTotalPrimeiroAcessoVOL}"/></td>
					</tr>
				</logic:notEmpty>
				<logic:notEmpty name="form" property="vlrTotalPrimeiroAcessoTAV">
					<tr>
						<td align="left" style="display:<bean:write name="relLayout" property="displayTAV" />" height="25" width="43%" valign="middle"><b>Total Clientes TAV até o momento:</b></td>
						<td align="left" style="display:<bean:write name="relLayout" property="displayTAV" />" height="25" width="20%" valign="middle"><netui:content value="{pageContext.form.vlrTotalPrimeiroAcessoTAV}"/></td>
					</tr>
				</logic:notEmpty>
				</table>
                ...
                <table width="100%">
                    <tr>
                        <td align="center">
                            <vivo:botao id="btFechar" width="60px" height="10px" value="Voltar" styleClass="btTemplate" onclick="location.href='relatorioPrimeiroAcesso.do'"/>
                        </td>
                    </tr>
                </table>
