...
<bean:define id="aGrupoErro" name="com.bea.wlw.netui.pageflow.PageFlowUtils_currentPageFlow" property="formManterDaemon.filaPrePagoVO.grupoErroVOArray"/>
...
<html>
    ...
    <body>
                            ...
                            <vivo:tbRows>
                                <logic:iterate name="aGrupoErro" id="lista" indexId="idx">
                                    <vivo:tbRow key="linha">
                                        ...
                                        <vivo:tbRowColumn>
                                             <input type="checkbox" name="chk_daemon<%=idx%>" value="<bean:write name="lista" property="idFilaSetClientInfo" />;<%=idx%>" class="radio" onclick="checkLista(this);">
                                        </vivo:tbRowColumn>

                                        <vivo:tbRowColumn>
                                            <bean:write name="lista" property="idFilaSetClientInfo"/>  
                                        </vivo:tbRowColumn>
                                        ...
                                        <vivo:tbRowColumn>
                                            <img src="/FrontOfficeWeb/resources/images/bt_icon_xml.gif" border="0" alt="Visualizar XML" onclick="visualizarXML('<bean:write name="lista" property="idFilaSetClientInfo"/>');">
                                        </vivo:tbRowColumn>
            ...
            <table border="0" width="100%">
                <tr>
                    ...
                    <td align="right">
                        ...
                        <acesso:controlHiddenItem nomeIdentificador="excluir_by_id_daemon_con_fila">
                        ...
                        <acesso:controlHiddenItem nomeIdentificador="atualizar_by_id_daemon_con_fila">
        ...
        <html:hidden name="FormManterDaemon" property="idFilaSetClientInfo"/>
