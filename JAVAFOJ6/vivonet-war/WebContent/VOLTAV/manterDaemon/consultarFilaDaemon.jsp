...
<netui-template:template templatePage="/resources/jsp/CRMTemplate.jsp">
    ...
    <netui-template:section name="headerSection">
        ...
        <script language="Javascript">    
            ...
            function visualizarXML(idFilaSetClient){
                ...
                form.idFilaSetClientInfo.value = idFilaSetClient;
    ...
    <netui-template:section name="bodySection">
        ...
        <vivo:quadro id="qdMain" height="475" width="790" label="Consulta de Fila" scroll="no">
            ...
            <acesso:controlHiddenItem nomeIdentificador="ver_manter_daemon_con_fila">
                                ...
                                <vivo:tbRows>
                                    <logic:iterate name="aGrupoErro" id="lista" indexId="idx">
                                        <vivo:tbRow key="linha">
                                            ...
                                            <vivo:tbRowColumn>
                                                    <acesso:controlHiddenItem nomeIdentificador="excluir_manter_daemon_con_fila">
                                            ...
                                            <vivo:tbRowColumn>
                                                    <acesso:controlHiddenItem nomeIdentificador="atualizar_manter_daemon_con_fila">
                                                        <logic:notEqual name="lista" property="cdErro" value="NULO">
                                            ...
                                            <vivo:tbRowColumn>
                                                    <acesso:controlHiddenItem nomeIdentificador="parametrizar_manter_daemon_con_fila">
                                                        <logic:notEqual name="lista" property="cdErro" value="NULO">
