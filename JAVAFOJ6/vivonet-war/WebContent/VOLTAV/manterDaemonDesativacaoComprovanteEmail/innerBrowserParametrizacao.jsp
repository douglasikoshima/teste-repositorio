...
<html>
    ...
    var nrStatusFila = '<bean:write name="FilaComprovanteEmailVO" property="ativo"/>';
    ...
    if(nrStatusFila == 1)
    {
        ...
        parent.document.forms[0].qtTentativas.disabled = true;
        parent.document.forms[0].tempoReprocessar.disabled = true;
        parent.document.forms[0].tempoInativo.disabled = true;
        ...
        parent.document.forms[0].qtTentativas.disabled = false;
        parent.document.forms[0].tempoReprocessar.disabled = false;
        parent.document.forms[0].tempoInativo.disabled = false;
