...
<bean:define id="FilaComprovanteEmailVO" name="com.bea.wlw.netui.pageflow.PageFlowUtils_currentPageFlow" property="formManterDaemon.filaComprovanteEmailVO"/>
    ...
    <netui-template:section name="headerSection">
        ...
        <script language="Javascript">
            ...
            function valida(){
                ...
                if(trim(form.qtTentativas.value) == '' || trim(form.qtTentativas.value) == '0'){

                    alert('Quantidade de Tentativas é um campo obrigatório, favor preencher.');
                    return false;

                }else if(trim(form.tempoReprocessar.value) == '' || trim(form.tempoReprocessar.value) == '0'){

                    alert('Tempo de Espera para Reprocessamento é um campo obrigatório, favor preencher.');
                    return false;

                }else if(trim(form.tempoInativo.value) == '' || trim(form.tempoInativo.value) == '0'){

                    alert('Tempo de Espera é um campo obrigatório, favor preencher.');
                    return false;

                }else if(trim(form.tmpRegistroLeitura.value) == '' || trim(form.tmpRegistroLeitura.value) == '0'){

                    alert('Tempo de Leitura entre Registros é um campo obrigatório, favor preencher.');
                    return false;

                }else if(trim(form.qtdRegistrosLidos.value) == '' || trim(form.qtdRegistrosLidos.value) == '0'){
    ...
    <netui-template:section name="bodySection">
        ...
        <jsp:include page="/resources/menus/MenuPrincipal.jsp" />
         ...
         <vivo:quadro id="qdMain" height="475" width="790" label="Parametrização do Daemon do Cadastro Pré-Pago" scroll="no">
            ...
            <acesso:controlHiddenItem nomeIdentificador="ver_manter_daemon_parametrizacao_dce">
            ...
            <form name="daemonForm" onsubmit="return false;">
                    ...
                    <table class="tbl_bgGray" width="100%">
                        <tr>
                            <td align="left">
                                ...
                                <logic:equal name="FilaComprovanteEmailVO" property="ativo" value="1">
                                    <span id="div_status_fila">ATIVADO</span>
                                </logic:equal>
                                <logic:equal name="FilaComprovanteEmailVO" property="ativo" value="0">
                            ...
                            <td align="right">
                                <logic:equal name="FilaComprovanteEmailVO" property="ativo" value="1">
                                    ...
                                    <acesso:controlHiddenItem nomeIdentificador="desativar_manter_daemon_parametrizacao_dce">
                                    ...
                                    <acesso:controlHiddenItem nomeIdentificador="ativar_manter_daemon_parametrizacao_dce">
                ...
                <vivo:quadro id="qdMain" height="210" width="780" label="Parametrização do Daemon do Cadastro Pré-Pago" scroll="no">
                    <table class="tbl_bgGray" width="100%" border="0">
                        <tr>
                            <td width="270"><netui:label styleClass="tblEstatica_campoNome" value="Quantidade de Tentativas:" /></td>
                            <td colspan="2">

                                <logic:equal name="FilaComprovanteEmailVO" property="ativo" value="1">
                                    <html:text name="FormManterDaemon" property="qtTentativas" style="width:50px;" disabled="TRUE" maxlength="3" onkeyup="checaInteiro(this)"/>
                                </logic:equal>
                                <logic:equal name="FilaComprovanteEmailVO" property="ativo" value="0">
                                    <html:text name="FormManterDaemon" property="qtTentativas" style="width:50px;" maxlength="3" onkeyup="checaInteiro(this)"/>
                                </logic:equal>
                        ...
                        <tr>
                            ...
                            <td><netui:label styleClass="tblEstatica_campoNome" value="Tempo de Espera para Reprocessamento:" /></td>
                            <td colspan="2">

                                <logic:equal name="FilaComprovanteEmailVO" property="ativo" value="1">
                                    <html:text name="FormManterDaemon" property="tempoReprocessar" style="width:50px;" disabled="TRUE" maxlength="3" onkeyup="checaInteiro(this)"/>
                                </logic:equal>
                                <logic:equal name="FilaComprovanteEmailVO" property="ativo" value="0">
                                    <html:text name="FormManterDaemon" property="tempoReprocessar" style="width:50px;" maxlength="3" onkeyup="checaInteiro(this)"/>
                                </logic:equal>
                                <netui:label styleClass="tblEstatica_campoNome" value=" Horas" />
                            </td>

                        </tr>
                        <tr>

                            <td><netui:label styleClass="tblEstatica_campoNome" value="Tempo de Espera:" /></td>
                            <td colspan="2">

                                <logic:equal name="FilaComprovanteEmailVO" property="ativo" value="1">
                                    <html:text name="FormManterDaemon" property="tempoInativo" style="width:50px;" disabled="TRUE" maxlength="3" onkeyup="checaInteiro(this)"/>
                                </logic:equal>
                                <logic:equal name="FilaComprovanteEmailVO" property="ativo" value="0">
                                    <html:text name="FormManterDaemon" property="tempoInativo" style="width:50px;" maxlength="3" onkeyup="checaInteiro(this)"/>
                                </logic:equal>

                                <netui:label styleClass="tblEstatica_campoNome" value=" Segundos" />
                        ...
                        <tr>
                            ...
                            <td><netui:label styleClass="tblEstatica_campoNome" value="Tempo de Leitura entre Registros: " /></td>
                            <td colspan="2">

                                <logic:equal name="FilaComprovanteEmailVO" property="ativo" value="1">
                                    <html:text name="FormManterDaemon" property="tmpRegistroLeitura" style="width:50px;" disabled="TRUE" maxlength="3" onkeyup="checaInteiro(this)"/>
                                </logic:equal>
                                <logic:equal name="FilaComprovanteEmailVO" property="ativo" value="0">
                                    <html:text name="FormManterDaemon" property="tmpRegistroLeitura" style="width:50px;" maxlength="3" onkeyup="checaInteiro(this)"/>
                                </logic:equal>
                        ...
                        <tr>
                            ...
                            <td>
                            <logic:equal name="FilaComprovanteEmailVO" property="ativo" value="1">
                                <html:text name="FormManterDaemon" property="qtdRegistrosLidos" style="width:50px;" disabled="TRUE" maxlength="3" onkeyup="checaInteiro(this)"/>
                            </logic:equal>

                            <logic:equal name="FilaComprovanteEmailVO" property="ativo" value="0">
                                <html:text name="FormManterDaemon" property="qtdRegistrosLidos" style="width:50px;" maxlength="3" onkeyup="checaInteiro(this)"/>
                            </logic:equal>
                            ...
                            <logic:equal name="FilaComprovanteEmailVO" property="ativo" value="0">
                                ...
                                <acesso:controlHiddenItem nomeIdentificador="gravar_manter_daemon_parametrizacao_dce">
