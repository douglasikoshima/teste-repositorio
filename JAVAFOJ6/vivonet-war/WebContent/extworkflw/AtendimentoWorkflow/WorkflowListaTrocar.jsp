...
<vivo:body idTable="tbMain" idDiv="dvMain" height="290" width="770">
    <form action="listaEncaminharGravar" method="post" name="atendimentoForm" tagId="formTrocar" id="formTrocar">
...
<script language="javascript">
    ...
    function submitAplicar() {
        ...
        document.forms["formTrocar"].method = "POST";
        document.forms["formTrocar"].action = "/FrontOfficeWeb/extworkflw/AtendimentoWorkflow/listaEncaminharGravar.do";
        document.forms["formTrocar"].target = "";
        document.forms["formTrocar"].submit();
    }

    function fechar()  {

        parent.dvTrocar.style.display='none';
        parent.ativar_combos();

        document.forms["formTrocar"].method = "POST";
        document.forms["formTrocar"].action = "/FrontOfficeWeb/extworkflw/AtendimentoWorkflow/atendimentoWorkflowVoltar.do";
        document.forms["formTrocar"].target = "iframeUsuario";
        document.forms["formTrocar"].submit();
    }
    ...
    function submitGrupo() {
        ...
        document.forms["formTrocar"].method = "POST";
        document.forms["formTrocar"].action = "/FrontOfficeWeb/extworkflw/AtendimentoWorkflow/obterUsuario.do" + meuCliente;
        document.forms["formTrocar"].target = "iframeUsuario";
        document.forms["formTrocar"].submit();
    }
