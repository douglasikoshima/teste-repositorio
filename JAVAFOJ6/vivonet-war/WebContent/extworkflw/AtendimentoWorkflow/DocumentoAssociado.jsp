    ...
    <tr>
        <td height="16">
            <vivo:abaGrupo id="abasAcoes" width="400" height="16" styleClass="abatexto">
                ...
                <vivo:abaItem id="abaDocsAssociados" onclick="abaSelected(abasAcoes, abaDocsAssociados); showDivDocsAssociados();" value="Associados" select="yes"/>
                </logic:notEqual>
                <vivo:abaItem id="abaDocumentos" onclick="abaSelected(abasAcoes, abaDocumentos); showDivDocumentos();" value="Associar"/>
                <vivo:abaItem id="abaAbert"      onclick="abaSelected(abasAcoes, abaAbert); showDivAbertura();"        value="Abertura"/>
                <vivo:abaItem id="abaEncer"      onclick="abaSelected(abasAcoes, abaEncer); showDivEncerramento();"    value="Encerramento"/>
            </vivo:abaGrupo>
        </td>
    </tr>
</table>
