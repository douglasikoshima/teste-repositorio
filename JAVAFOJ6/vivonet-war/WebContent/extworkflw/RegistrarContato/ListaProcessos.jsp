...
<html>
    ...
    <body>
        ...
        <html:form action="/extworkflw/RegistrarContato/excluirProcessoCorrente.do" method="post">
        ...
        <script language=javascript>
	        ...
	        function excluir(idAtendimento, imgTD) {
	            ...
	            //Monta os valores no form
	            parent.document.forms["registrarContatoForm2"].elements["idAtendimentoExclusao"].value = idAtendimentoExclusao;
	            parent.document.forms["registrarContatoForm2"].elements["rowIndex"].value = rowIndex;
	
	            //Liga animação
	            if( top.frameApp.dvAnimarAguarde != null ) top.frameApp.startAnimation();
	            //Processa a exclusão
	            parent.document.forms["registrarContatoForm2"].target = "ifrmRegistrarContato";
	            parent.document.forms["registrarContatoForm2"].action = "excluirProcessoCorrente.do";
	            parent.document.forms["registrarContatoForm2"].submit();
	            --%>
	        }
	        ...
	        function detalhe(imgTD) {
	            ...
	            //document.forms["registrarContatoForm"].action = "/FrontOfficeWeb/extworkflw/AtendimentoDetalhe/begin.do?IDATENDIMENTO="+imgTD.childNodes(1).innerText;
