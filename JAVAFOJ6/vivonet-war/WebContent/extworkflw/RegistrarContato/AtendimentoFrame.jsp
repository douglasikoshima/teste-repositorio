...
<head>
    ...
    function controlaProcessosCorrentes(){
        ...
        document.all['ifrmAbas'].src = "/FrontOfficeWeb/extworkflw/RegistrarContato/atendimentosCorrentes.do";
        ...
        if(aba == "formulario"){
            ...
            if (inCelular == false && inCelAlready == false
                ...
                %>
                    ...
                    var aOptComponentsParent = ifrmAbas.document.forms["registrarContatoForm2"].elements["comunicacaoDisponivel"];
                    var aOptComponentsParentSelec = ifrmAbas.document.forms["registrarContatoForm2"].elements["comunicacaoSelecionada"];
    ...
    function refresh(idPessoa){
        ...
        document.forms[0].action ='/FrontOfficeWeb/extworkflw/RegistrarContato/loadContato.do?reload=OK&&idPessoaCliente='+idPessoa;
    ...
    function formatCelular(numCel){
        if (numCel.length == 10) {
            numCel = "("+numCel.substring(0,2)+")"+numCel.substring(2,6)+"-"+numCel.substring(6,10)
...
<body leftmargin="0" topmargin="0">
    ...
    <form id="registrarContatoForm2" name="registrarContatoForm2" method="post">
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td valign="top" class="BorderTable1" width="330">
                            <iframe id="ifrmArvore" name="ifrmArvore" width="330px" height="349px" frameborder=0 scrolling="auto" src="/FrontOfficeWeb/extworkflw/RegistrarContato/arvoreContato.do"></iframe>
                                    ...
                                    <td valign="top">
                                        <logic:notEmpty name="Form" property="abreProcessoReaRei">
                                            <vivo:abaGrupo id="btAba" width="730px" height="10px" styleClass="abatexto">
                                                <vivo:abaItem id="abaFormulario"  onclick="mostrarAba(btAba, abaFormulario, 'formulario');" value="Formulário de Processo"/>
                                                <vivo:abaItem id="abaContato" width="50%" onclick="mostrarAba(btAba, abaContato, 'contato');" value="Contato"/>
                                           </vivo:abaGrupo>
                                        </logic:notEmpty>
                                        <logic:empty name="Form" property="abreProcessoReaRei">
                                            <vivo:abaGrupo id="btAba" width="430px" height="10px" styleClass="abatexto">
                                                <vivo:abaItem id="abaFormulario"  onclick="mostrarAba(btAba, abaFormulario, 'formulario');" value="Formulário de Processo"/>
                                                <vivo:abaItem id="abaContato" onclick="mostrarAba(btAba, abaContato, 'contato');" value="Contato"/>
                                                <vivo:abaItem id="abaPCorrentes" onclick="mostrarAba(btAba, abaPCorrentes, 'pCorrentes');"  value="Processos Correntes"/>
                                           </vivo:abaGrupo>
                                        </logic:empty>
                                    </td>
                                </tr>
    ...
    <vivo:quadroFlutuante id="dvPesqForm" idIframe="ifrmPesqForm" width="270" height="200" spacesTop="5" spacesLeft="250" display="none" url="<%=request.getContextPath()%>"  src="/FrontOfficeWeb/extworkflw/RegistrarContato/pesquisaFormulario.do" onclick="ifrmAbas.ativar_combos();"/>
