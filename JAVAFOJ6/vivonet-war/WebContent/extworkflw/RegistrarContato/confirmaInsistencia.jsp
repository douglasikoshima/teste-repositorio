...
<html>
    <head>
        ...
        <script language="JavaScript">
            ...
            function registrarInsistencia() {
                ...
                document.forms["registrarContatoForm2"].action = "registrarInsistencia.do";
            ...
            function registrarComentario() {
                //Liga animação
                if( top.frameApp.dvAnimarAguarde != null ) top.frameApp.startAnimation();
                document.forms["registrarContatoForm2"].action = "registrarComentario.do";
                document.forms["registrarContatoForm2"].submit();
            }

            function finalizar() {

                if (trim(document.forms["registrarContatoForm2"].observacaoAtendimento.value) != ''){
                    registrarComentario();
                    return;
                }
    ...
    <body>    
        <form name="registrarContatoForm2" action="registrarInsistencia.do">
