...
<html:html>
    <head>
        ...
        <script language="JavaScript">
            ...
            function realizarPesquisa() {   
                ...
                document.forms["registrarContatoForm2"].target = "iPesquisaForm";
                document.forms["registrarContatoForm2"].action = "obterPesquisaFormulario.do";
    ...
    <body>
        ...
        <form name="registrarContatoForm2">
