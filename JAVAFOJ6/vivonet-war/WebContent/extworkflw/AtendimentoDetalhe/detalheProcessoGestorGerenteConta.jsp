...
<bean:define id="Form"
             ...
             type="extworkflw.AtendimentoDetalhe.AtendimentoDetalheController.AtendimentoDetalheForm" />
...
<div id="clienteWrapper">
    <logic:iterate id="gestorGerenteContaForm"
                   ...
                   indexId="c"
                   type="extworkflw.AtendimentoFila.Portabilidade.formBeans.GestorGerenteContaForm">
 ...
 /extworkflw/         <img src="<%=request.getContextPath()%>/resources/images/bt_alterar_nrml.gif"
                             border="0"
