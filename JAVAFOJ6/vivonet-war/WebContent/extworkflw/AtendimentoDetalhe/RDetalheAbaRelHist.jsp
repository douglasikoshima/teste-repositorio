    ...
    <script type="text/javascript" language="javascript">
        <!--
           ...
           function showIfr(a) {
               ...
               cod=cod.replace(exp1,"s rc=\"/FrontOfficeWeb/extworkflw/AtendimentoDetalhe/RDUserEx.do");
               cod=cod.replace(exp2,"s rc=\"/FrontOfficeWeb/extworkflw/AtendimentoDetalhe/RDProcessoEx.do");
               cod=cod.replace(exp3,"s rc=\"/FrontOfficeWeb/extworkflw/AtendimentoDetalhe/RDContatoEx.do");
               d.innerHTML=cod;
               d.style.display='';
               eval(zso);
               if(a != 'NProc')
                ...
                <td valign="top">
                    ...
                    <table width="98%" align="right">
                        <tr valign="top">
                            <td width="">Alerta:</td>
                            <td width="">
                                <iframe id="ifrAlertas" src="/FrontOfficeWeb/extworkflw/AtendimentoDetalhe/RDAlertaEx.do?idAtd=<%=idAtd%>" height="0" width="0" frameborder="0"></iframe>
                                <div id="dAlertas" style="display:none"><a href="/FrontOfficeWeb/extworkflw/AtendimentoDetalhe/RDAlertaEx.do"></a></div>
                            </td>
                            <td>Estado:</td>
...
<table width="768" style="background-color:#ffffff;border:1px solid #adadad;">
    <tr>
        ...
        <td width="698">
            <%--iframe id="ifrOper" src="/FrontOfficeWeb/extworkflw/AtendimentoDetalhe/RDOperacionAbaRelacionamentoEx.do?idAtd=<%=idAtd%>&inCRI=<%=inCRI%>&inRC=<%=inRC%>&inMirrorRC=<%=request.getParameter("inMirrorRC")%>" height="0" width="0" frameborder="0"></iframe>
            <div id="dOper" style="display:none;"><a href="/FrontOfficeWeb/extworkflw/AtendimentoDetalhe/RDOperacionAbaRelacionamentoEx.do"></a></div--%>
        </td>
    </tr>
</table>
<div><img src="/FrontOfficeWeb/resources/images/transp.gif" width="1" height="5"></div>
    ...
    <table width="768" height="260" cellpadding="0" cellspacing="5" style="border:1px solid #adadad;background-color:#ededed;" id="table_hist">
        ...
        <tr>
            <td valign="top" class="BorderTable1" width="768" height="100%">
                <iframe name="ifrHist" id="ifrHist" src="/FrontOfficeWeb/extworkflw/AtendimentoDetalhe/RDHistoricoEx.do?idAtd=<%=idAtd%>&inCRI=<%=inCRI%>&inRC=<%=inRC%>" height="0" width="0" frameborder="0"></iframe>
                <div id="dHist"><a href="/FrontOfficeWeb/extworkflw/AtendimentoDetalhe/RDHistoricoEx.do"></a></div>
            </td>
        </tr>
    </table>
</div>
...
<script language="javascript">
    <!--
        ...
        function submitPesquisarHist() {
            ...
            eval(zsa);
            document.getElementById("ifrHist").src="/FrontOfficeWeb/extworkflw/AtendimentoDetalhe/RDHistoricoEx.do?idAtd=<%=idAtd%>&est="+e+"&subest="+s;
        }
        eval(zso);
