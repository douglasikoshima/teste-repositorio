...
<script type="text/javascript">
    ...
    function showIfrSS(a) {
        d=eval("d"+a);f=eval("ifr"+a);dv=eval("dv"+a);
        d.style.display='';dv.style.display='';
...
<table width="760" cellpadding="0" cellspacing="0" border="0" align="center">
    ...
    <tr>
        ...
        <td>
            <img src="<%=request.getContextPath()%>/resources/images/bt_consultargestor_nrml.gif"
                 valign="top"
                 id="imgConsultarGestor"
                 style="float:right;cursor:pointer;display:none"
                 onclick="window.top.frameApp.createNewPopUp('gestorGerenteConta', 'Consultar Gestor/Gerente', 780, 500, null, '/FrontOfficeWeb/extworkflw/AtendimentoDetalhe/getGestorGerenteConta.do', true, null);"/>
        </td>
    </tr>
</table>
    ...
    <table height="78" width="760" align="center" cellpadding="0" cellspacing="5" style="border:1px solid #adadad;">
        <tr>
            <td valign="top" class="BorderTable1" width="100%">
                ...
                <div id="dUCP" style=""><a href="RDUser.do"></a></div>
             </td>
        </tr>
    </table>
</div>
    ...
    <table height="75" width="760" align="center" cellpadding="0" cellspacing="5" style="border:1px solid #adadad;">
        <tr>
            <td valign="top" class="BorderTable1">
                ...
                <div id="dFProc" style="overflow:auto;width:750px;height:66px;"><a href="RDProcesso.do"></a></div>
             </td>
        </tr>
    </table>
</div>
    ...
    <table height="75" width="760" align="center" cellpadding="0" cellspacing="5" style="border:1px solid #adadad;">
        <tr>
            <td valign="top" class="BorderTable1">
                ...
                <div id="dCont" style="overflow:auto;height:66px;"><a href="RDContato.do"></a></div>
             </td>
        </tr>
    </table>
</div>

<a href="abaVoltarSolicitante.do" target="ifrUCP" id="abaSolicitanteVoltar"></a>
<script type="text/javascript">
