...
<netui-template:section name="headerSection">
    ...
    <script type="text/javascript" language="javascript" src="../../resources/scripts/RWFDetalle2.js"></script>
    ...
    <script type="text/javascript" language="javascript">
        <!--
            ...
            function submitPesquisar() {
                ...
                document.forms["0"].action = 'begin2.do?idAtendimento=<%=idAtd%>&fila='+fl+'&inMenu='+inMenu;
           ...
           function showIfrInf(a) {
            ...
            incluirAlterarGestorGerente = function(idGestorGerente) {
                ...
                window.top.frameApp.createNewPopUp('incluirAlterarGestorGerente', title, 700, 130, null, '/FrontOfficeWeb/extworkflw/AtendimentoDetalhe/getGestorGerenteConta.do', true, params);
            }

            salvarInclusaoAlteracaoGestorGerente = function() {
                if (validarInclusaoAlteracaoGestorGerente()) {
                    new Ajax.Request('/FrontOfficeWeb/extworkflw/AtendimentoDetalhe/setGestorGerenteConta.do', {
                        method: 'post',
                        ...
                        onCreate: function() {
                            ...
                            if (jsonObj.msg.retorno == 'true') {
                                ...
                                var params = $H();
                                if (window.top.frameApp.$('dvAnimarAguarde')) window.top.frameApp.startAnimation();
                                new Ajax.Updater('containerIncluirAlterarGestorGerente', '/FrontOfficeWeb/extworkflw/AtendimentoDetalhe/getGestorGerenteConta.do', {
                                    evalScripts: true,
                                    parameters: params,
                                    method: 'get'
                                });
            ...
            verificaNumeroVivo = function(nrLinha) {
                ...
                new Ajax.Request('/FrontOfficeWeb/extworkflw/AtendimentoDetalhe/verificaNumeroVivo.do', {
                    method: 'post',
                    parameters: params,
                    asynchronous: false,
                    onSuccess: function(transport) {
...
<logic:notEqual parameter="inMenu" value="N"><jsp:include page="/resources/menus/MenuExterno.jsp"/></logic:notEqual>
...
<tr id='btAbaInfo' valign='top'>
    ...
    <td id='btInfo02' style='cursor:pointer;' class='abaUnselected' height='16'><a href="../AtendimentoWorkflow/abaDetalhe.do" target="ifrAtend" onclick="this.href=this.href+'?idAtd=<%=idAtd%>&acao=RDArvoreAtendimento.do';if (at) eval(zsa);return abaAtendimento();">Atendimento</a></td>
    ...
    <td id='btInfo04' style='cursor:pointer;' class='abaUnselected' height='16'><a href="../AtendimentoWorkflow/abaDetalhe.do" onclick="this.href='../AtendimentoWorkflow/abaDetalhe.do?idAtd=<%=idAtd%>&acao=RDNivelProcesso.do';if (niv) eval(zsa);return abaNivelProc();" target="ifrNProc">N&iacute;vel do Processo</a></td>
...
<%
String scriptLupa = ConstantesCRM.SVAZIO;
if ( !"N".equals(request.getParameter("inMenu")) ) {
...
<tr>
    ...
    <td width="698">
        <iframe id="ifrOper" src="RDOperacionAbaRelacionamento.do?idAtd=<%=idAtd%>&inCRI=<%=inCRI%>&inRC=<%=inRC%>&inMirrorRC=<%=request.getParameter("inMirrorRC")%>" height="0" width="0" frameborder="0"></iframe>
...
function exibeLinkOrigem(a){
	...
	if($(fdo)){
		eval(zsa);
		$(fdo).src="begin2.do?idAtendimento="+a+"&inMenu=N&fila="+fl+"&qtd="+qtd;
		$(ddo).style.display='';
	}/* else{
