...
<head>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/resources/scripts/RWFDetalle2.js"></script>
    ...
    <script language="javascript">
        <!--
            ...
            getOperacao = function(o) {
                ...
                var fila = '/FrontOfficeWeb/extworkflw/AtendimentoFila/MeuCliente/begin.do';
                ...
                if (o.selectedIndex > 0) {
                    ...
                    var operacao = new Ajax.Updater('container_historico_operacoes',
                            '/FrontOfficeWeb/extworkflw/AtendimentoWorkflow/' + action + '.do?' + params.toQueryString(), {
                        method: 'post',
                        evalScripts: true,
                        parameters: params,
                        onComplete: function() {
            ...
            submitAplicar = function(action) {
                ...
                var pesquisa = new Ajax.Updater('container_historico_operacoes',
                        '/FrontOfficeWeb/extworkflw/AtendimentoWorkflow/' + action + '.do', {
                    method: 'post',
                    evalScripts: true,
                    parameters: params,
                    onSuccess: function() {
