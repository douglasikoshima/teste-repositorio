...
<div id="clienteWrapper">
    <form id="gestorGerenteContaForm" name="gestorGerenteContaForm" action="" method="POST" style="margin:0px;" onsubmit="return false;">
            ...
            <tr>
                ...
                <td>
                    <html:text name="Form"
                               ...
                               maxlength="14" />
                               <!-- onkeyup="checaTelefone(this)"
                               onblur="checaTelefone(this)" -->
                </td>
