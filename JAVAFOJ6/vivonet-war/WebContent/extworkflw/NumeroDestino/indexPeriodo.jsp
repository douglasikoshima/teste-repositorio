...
<netui-template:template templatePage="/resources/jsp/templateUsuarioClean.jsp">
    <netui-template:section name="headerSection">
        ...
        <script type="text/javascript" language="javascript">
            pesquisar = function() {
                if ($F('dtInicio').blank()) {
                    alert('Por favor, digite a data de início para consulta.');
    ...
    <netui-template:section name="bodySection">
        <vivo:quadro id="divConsultaNumero" height="247" width="660" label="Consulta de Número" scroll="no">
            <html:form styleId="consultarNumeroForm2" action="pesquisarNumero">
            <table width="100%">
                <tr>
                    <td nowrap>
                        Data de início: 
                        ...
                        <img class="calendario" src="<%=request.getContextPath()%>/resources/images/calendario.gif" style="cursor:pointer;" title="Calendário" onclick="return showCalendar('dtInicio', '%d/%m/%Y');">
                    </td>
                    <td nowrap>
                        Data fim: 
                        <html:text name="Form"
                               ...
                               onblur="validaDataInput(this)"
                               onkeyup="Formatar(this.value, this.form.name, this.name, 'data');" />
                        <img class="calendario" src="<%=request.getContextPath()%>/resources/images/calendario.gif" style="cursor:pointer;" title="Calendário" onclick="return showCalendar('dtFim', '%d/%m/%Y');">
                    </td>
                    <td width="100%" nowrap>
                        Número: 
                        <html:text name="Form"
