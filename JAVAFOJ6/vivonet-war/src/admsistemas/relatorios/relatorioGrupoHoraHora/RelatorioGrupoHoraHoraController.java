package admsistemas.relatorios.relatorioGrupoHoraHora;
...
public class RelatorioGrupoHoraHoraController extends AbstractAction {
...
private Disponivel getListaSegmento(){
 ...
 private Disponivel getListaSite(){
	...
	public ActionForward pesquisar(ActionMapping mapping, ActionForm formParam,
        ...
        query.append(" select to_char(recontato.dtultimaalteracao, 'dd/mm/yyyy') as data, ");
        query.append("        to_char(recontato.dtultimaalteracao, 'hh24') || 'h as ' || to_char(recontato.dtultimaalteracao, 'hh24') || 'h59min' as intervalo, ");
        ...
        query.append("    and recontato.idgrupoatual             = grupo.idgrupo(+) ");
        ...
        if (grupo != null && grupo.length() > 0) {
            query.append(" and recontato.idgrupoatual = ").append(grupo);
        }                
        ...
        query.append("    group by recontato.dtultimaalteracao, ");
        ...
        query.append(" order by recontato.dtultimaalteracao ");
