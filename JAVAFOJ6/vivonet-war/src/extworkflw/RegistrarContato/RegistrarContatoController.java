...
import br.com.vivo.fo.ctrls.extworkflw.token.TokenFacade;
...
import br.com.vivo.fo.workflow.vo.WFListaContatosVODocument.WFListaContatosVO.ContatoFolha;
...
public class RegistrarContatoController extends AbstractAction {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    	if ("carregar".equals(mapping.getParameter())) {
            return carregar(mapping, form, request, response);           
        } else if ("index".equals(mapping.getParameter())) {
            return index(mapping, form, request, response);           
        } else if ("begin".equals(mapping.getParameter())) {
	...
	protected ActionForward index(ActionMapping mapping, ActionForm formParam,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {		
		String id = (String) request.getParameter("id");   
		 // recuperar informações sobre token
        DadosTokenVivo360 dadosTokenVivo360 = tokenFacade.getDadosToken(id);
        ConstantesCRM.setCurrentUser(request.getSession(), dadosTokenVivo360.getIdUsuarioAlteracao());
        request.getSession().setAttribute("dadosTokenVivo360", dadosTokenVivo360);
        
		return mapping.findForward(ConstantesCRM.SUCCESS);
	}
	
	protected ActionForward carregar(ActionMapping mapping, ActionForm formParam,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {		        
		return mapping.findForward(ConstantesCRM.SUCCESS);
	}	
    ...
    protected ActionForward begin(ActionMapping mapping, ActionForm formParam, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        DadosTokenVivo360 dadosTokenVivo360 = (DadosTokenVivo360) request.getSession().getAttribute("dadosTokenVivo360");
                
        // recuperar parametros
        ParametrosVO parametros = telaInicialFacadeControl.getParametrosVO(dadosTokenVivo360.getIdUsuarioAlteracao(), dadosTokenVivo360.getNrLinha(), "2");
        parametros.setIdTipoRelacionamento(ConstantesCRM.STWO);
        request.getSession().setAttribute(ConstantesCRM.SPARAMETROS,parametros);
        

        String user = dadosTokenVivo360.getIdUsuarioAlteracao();
        inBegin = true;

        // verifica se o atributo fila está preenchido
        if ((request.getAttribute("fila") != null) && (request.getAttribute("fila").equals(ConstantesCRM.SONE))) {
        ...
        form.setIdGrupoAbertura(parametros.getIdGrupo() == null ? "1" : parametros.getIdGrupo());
        log.debug("RegistrarContatoController:begin.do - [idGrupoAbertura = " + form.getIdGrupoAbertura() + "]");

        if ((parametros.getIdTipoRelacionamento() != null) && ((parametros.getIdTipoRelacionamento().equals(ConstantesCRM.SONE)) || (parametros.getIdTipoRelacionamento().equals(ConstantesCRM.STWO)))) {
            form.setIdSegmentacao(parametros.getIdSegmentacao() == null || parametros.getIdSegmentacao().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SONE : parametros.getIdSegmentacao());
            form.setIdTipoCarteira(parametros.getIdTipoCarteira() == null || parametros.getIdTipoCarteira().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SONE : parametros.getIdTipoCarteira());
            form.setIdTipoLinha(parametros.getIdTipoLinha() == null || parametros.getIdTipoLinha().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SONE : parametros.getIdTipoLinha());
            form.setIdUfOperadora(parametros.getIdUfOperadora() == null || parametros.getIdUfOperadora().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SONE : parametros.getIdUfOperadora());
        } else {
        ...
        form.setNomeContato(parametros.getNmFalandoCom() == null || parametros.getNmFalandoCom().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SVAZIO : parametros.getNmFalandoCom());
        form.setNomeContatoAlterado(parametros.getNmContato() == null || parametros.getNmContato().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SVAZIO : parametros.getNmContato());
        form.setIdChamadaTelefonica(Long.parseLong(parametros.getIdChamadaTelefonica() == null || parametros.getIdChamadaTelefonica().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SONE : parametros.getIdChamadaTelefonica()));
        form.setIdFase((parametros.getIdFase() == null || parametros.getIdFase().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SONE : parametros.getIdFase()));
        ...
        if (parametros.getNrLinha() == null || parametros.getNrLinha().equals(ConstantesCRM.SVAZIO)) {
            if (parametros.getNrTelefone() == null || parametros.getNrTelefone().equals(ConstantesCRM.SVAZIO)) {
        ...
        if (!telContato.equals(ConstantesCRM.SVAZIO) && telContato.length() < 10) {
        ...
        form.setNrConta(parametros.getNrConta() == null || parametros.getNrConta().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SVAZIO : parametros.getNrConta());
        form.setIdConta(parametros.getIdConta() == null || parametros.getIdConta().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SONE : parametros.getIdConta());
        form.setContaSelecionada(parametros.getIdConta() == null || parametros.getIdConta().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SONE : parametros.getIdConta());
        form.setIdLinha(parametros.getIdLinha() == null || parametros.getIdLinha().equals(ConstantesCRM.SVAZIO) ? "0" : parametros.getIdLinha());
        form.setLinhaSelecionada(parametros.getIdLinha() == null || parametros.getIdLinha().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SZERO : parametros.getIdLinha());
        form.setIdClienteDePara(parametros.getIdClienteDePara() == null || parametros.getIdClienteDePara().equals(ConstantesCRM.SZERO) ? ConstantesCRM.SONE : parametros.getIdClienteDePara());
        ...
        if (parametros.getIdLinhaAtendimento() != null && !parametros.getIdLinhaAtendimento().equals(ConstantesCRM.SZERO)) {
        ...
        form.setIdUsuarioDePara(parametros.getIdUsuarioDePara() == null || parametros.getIdUsuarioDePara().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SONE : parametros.getIdUsuarioDePara());
        form.setInTipoPessoa(parametros.getInTipoPessoa() == null || parametros.getInTipoPessoa().equals(ConstantesCRM.SVAZIO) ? "PF" : parametros.getInTipoPessoa());
        ...
        if (parametros.getIdAtendimento() != null && parametros.getIdAtendimento().length()>1) {
            ...
            form.setIdTipoReaberturaProcesso(Integer.parseInt(parametros.getIdTipoReaberturaProcesso() == null || parametros.getIdTipoReaberturaProcesso().equals("") ? "0" : parametros.getIdTipoReaberturaProcesso()));
            ...
            if (form.getInResponsavelAbertura().equals(ConstantesCRM.STWO)) {
        ...
        // form.setAtendimentoVOLista(registrarContatoFacade.verificaProcessosCorrentes(user,
        // form.getIdChamadaTelefonica()));
        ...
        String url = new String(ConstantesCRM.SVAZIO);
        ...
        for (int i = 0; i < admContatoFolhaVO.getAdmContatoFolhaVOArray().length; i++) {
            ...
            if (inFolha) {
                ...
                if (ConstantesCRM.SVAZIO.equals(itemContatoFolha.getUrlFuncionalidade())) {
                    ...
                    String sAction = "javascript:loadPage('" + itemContatoFolha.getIdContato() + "', '" + replaceURL(strUtil.escapaComillasJS2(itemContatoFolha.getUrlFuncionalidade())) + "', '" + itemContatoFolha.getInRelacionamento() + "', '');";
                ...
                node = getWebFXTreeItem(i, false, itemContatoFolha.getNmContato(), sAction, "", "/FrontOfficeWeb/resources/images/foldericon.png", "/FrontOfficeWeb/resources/images/openfoldericon.png", strUtil.escapaComillasJS2(url), "");
            }

            if (!url.equals(ConstantesCRM.SVAZIO)) {
            ...
            if ((itemContatoFolha.getMensagem() != null) && (!"".equals(itemContatoFolha.getMensagem()))) {
        ...
        for (int i = 0; i < admContatoFolhaVO.getAdmContatoFolhaVOArray().length; i++) {
            if (strMensagemAlt[i] != null && !strMensagemAlt[i].equals(ConstantesCRM.SVAZIO)) {
    ...
    protected String replaceURL(String URL) {
    	...
    	if (URL.indexOf("/cliente/ConsultaHexa/startConsHexa.jsp") > -1) {
    		novaURL = "/extworkflw/ConsultaHexa/startConsHexa.jsp";
    	} else if (URL.indexOf("/VOLTAV/denatran/begin.do") > -1) {
    		novaURL = "/extworkflw/denatran/begin.do";
    	} else if (URL.indexOf("/VOLTAV/manterAgendamentoVIP/consultaAcessoAgendamentoVIP.do") > -1) {
    		novaURL = "/extworkflw/manterAgendamentoVIP/consultaAcessoAgendamentoVIP.do";
    	} else if (URL.indexOf("/cliente/TelaInicial/ConsultaWS/NumeroDestino/begin.do") > -1) {
    		novaURL = "/extworkflw/NumeroDestino/begin.do";
    	} else if (URL.indexOf("/cliente/TelaInicial/DetalheFatura/FaturaOnline/begin.do") > -1) {
    		novaURL = "/extworkflw/FaturaOnline/begin.do";
    	} else if (URL.indexOf("/cliente/TelaInicial/DetalheFatura/FaturaOnlineOptin32/begin.do") > -1) {
    		novaURL = "/extworkflw/FaturaOnlineOptin32/begin.do";
    	} else if (URL.indexOf("/cliente/TelaInicial/DetalheFatura/FaturaOnlineOptin32/begin.do?operacao=manutencao") > -1) {
    		novaURL = "/extworkflw/FaturaOnlineOptin32/begin.do?operacao=manutencao";
    	} else if (URL.indexOf("/cliente/TelaInicial/consultarLinhaPUP.do") > -1) {
    		novaURL = "/extworkflw/TelaInicial/consultarLinhaPUP.do";
    	}
    ...
    protected ActionForward beginTeste(ActionMapping mapping, ActionForm formParam, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        form.setNomeContato(parametros.getNmFalandoCom() == null || parametros.getNmFalandoCom().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SVAZIO : parametros.getNmFalandoCom());
        form.setNomeContatoAlterado(parametros.getNmContato() == null || parametros.getNmContato().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SVAZIO : parametros.getNmContato());
        form.setIdChamadaTelefonica(Long.parseLong(parametros.getIdChamadaTelefonica() == null || parametros.getIdChamadaTelefonica().equals(ConstantesCRM.SVAZIO) || parametros.getIdChamadaTelefonica().equals("(null)") ? ConstantesCRM.SONE : parametros.getIdChamadaTelefonica()));
        form.setIdFase((parametros.getIdFase() == null || parametros.getIdFase().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SONE : parametros.getIdFase()));
        ...
        form.setIdConta(parametros.getIdConta() == null || parametros.getIdConta().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SONE : parametros.getIdConta());
        form.setContaSelecionada(parametros.getIdConta() == null || parametros.getIdConta().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SONE : parametros.getIdConta());
        form.setIdLinha(parametros.getIdLinha() == null || parametros.getIdLinha().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SZERO : parametros.getIdLinha());
        form.setLinhaSelecionada(parametros.getIdLinha() == null || parametros.getIdLinha().equals(ConstantesCRM.SVAZIO) ? ConstantesCRM.SZERO : parametros.getIdLinha());
        form.setIdClienteDePara(parametros.getIdClienteDePara() == null || parametros.getIdClienteDePara().equals(ConstantesCRM.SZERO) ? ConstantesCRM.SONE : parametros.getIdClienteDePara());
        form.setIdContato(parametros.getIdContato() == null ? "1" : parametros.getIdContato());
    ...
    protected ActionForward iniciaAtendimento(ActionMapping mapping, ActionForm formParam, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (atendimentoVOFacade.getArvoreAtendimentoVO().getFormularioVO() != null) {
            for (int i = 0; i < atendimentoVOFacade.getArvoreAtendimentoVO().getFormularioVO().getFormularioCampoVOArray().length; i++) {
                if (atendimentoVOFacade.getArvoreAtendimentoVO().getFormularioVO().getFormularioCampoVOArray(i).getTipoCampoVO().getNrTamanho() != null) {
                    if (atendimentoVOFacade.getArvoreAtendimentoVO().getFormularioVO().getFormularioCampoVOArray(i).getTipoCampoVO().getNrTamanho().equals("0")) {
                    ...
                    if (ConstantesCRM.SONE.equals(atendimentoVOFacade.getArvoreAtendimentoVO().getFormularioVO().getAdmGrupoCamposVOArray(i).getIdTipoGrupo())) {
                        for (int j = 0; j < atendimentoVOFacade.getArvoreAtendimentoVO().getFormularioVO().getAdmGrupoCamposVOArray(i).getFormularioCampoVOArray().length; j++) {
                            if (atendimentoVOFacade.getArvoreAtendimentoVO().getFormularioVO().getAdmGrupoCamposVOArray(i).getFormularioCampoVOArray(j).getTipoCampoVO().getNrTamanho() != null) {
                                if (atendimentoVOFacade.getArvoreAtendimentoVO().getFormularioVO().getAdmGrupoCamposVOArray(i).getFormularioCampoVOArray(j).getTipoCampoVO().getNrTamanho().equals("0")) {
        ...
        if ((atendimentoVOFacade.getAtendimentoSituacaoVO() != null) && (atendimentoVOFacade.getAtendimentoSituacaoVO().getQtDias().equals("-1"))) {
    ...
    protected ActionForward pesquisaArvore(ActionMapping mapping, ActionForm formParam, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            log.debug("substituir url pelo caminho extworkflw");
            if (listaContatos != null && listaContatos.getContatoFolhaArray() != null) {
	            for (int i = 0; i < listaContatos.getContatoFolhaArray().length; i++) {
	            	ContatoFolha contato = listaContatos.getContatoFolhaArray(i);
	            	contato.setNmUrlFunc(this.replaceURL(contato.getNmUrlFunc()));
	            }
            }
    ...
    private void montaValidacao(FormularioVO formulario, String inProcessoReaRei, HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            if (inProcessoReaRei.equals(ConstantesCRM.SONE)) {
            ...
            for (int j = 0; j < formulario.getAdmGrupoCamposVOArray().length; j++) {
                ...
                for (int i = 0; i < formulario.getAdmGrupoCamposVOArray(j).getFormularioCampoVOArray().length; i++) {
                    ...
                    if (!ConstantesCRM.SONE.equals(formulario.getAdmGrupoCamposVOArray(j).getIdTipoGrupo()) || formulario.getAdmGrupoCamposVOArray(j).getFormularioCampoVOArray(i).getInObrigatorio().equals("0")) {
                        contadorContinuado++;
                        continue;
                    }

                    if (formulario.getAdmGrupoCamposVOArray(j).getFormularioCampoVOArray(i).getTipoCampoVO().getSgLayoutApresentacaoCampo().equals(ConstantesCRM.CT_Text)
                            || formulario.getAdmGrupoCamposVOArray(j).getFormularioCampoVOArray(i).getTipoCampoVO().getSgLayoutApresentacaoCampo().equals(ConstantesCRM.CT_TextArea)) {
                        ...
                        if (formulario.getAdmGrupoCamposVOArray(j).getFormularioCampoVOArray(i).getInPesquisa().equals("1")) {
                            scriptValidacao = scriptValidacao + "if(document.forms[0].all['valorCampo[" + contadorContinuado + "].valor'].value == ''){\n" + "alert('A questão \""
                                    + formulario.getAdmGrupoCamposVOArray(j).getFormularioCampoVOArray(i).getNmCampo() + "\" deve ser respondida!');\n" + "return false;\n}";
                            contadorContinuado++;
    ...
    private String inserirCarregaCampo(String inPesquisa, String sgLayoutApresentacaoCampo, int indice, int subindice, String valor, int numRegistros) {
        ...
        try {
            if (inPesquisa.equals(ConstantesCRM.SONE)) {
                textoCarregaCampo = "document.all[\"valorCampo[" + indice + "].valor\"].value = '" + valor + "';";
            } else {
                if (sgLayoutApresentacaoCampo.equals(ConstantesCRM.CT_Text) || sgLayoutApresentacaoCampo.equals(ConstantesCRM.CT_TextArea)) {
                    textoCarregaCampo = "document.all[\"valorCampo[" + indice + "].valor\"].value = '" + valor + "';";
                } else if (sgLayoutApresentacaoCampo.equals(ConstantesCRM.CT_Select)) {
                    if (subindice >= 0) {
                        int subIndiceSelect = subindice + 1;
                        textoCarregaCampo = "document.all[\"valorCampo[" + indice + "].valor\"].selectedIndex = " + subIndiceSelect + ";";
                    }
                } else if (sgLayoutApresentacaoCampo.equals(ConstantesCRM.CT_Radio)) {
                    if (subindice >= 0) {
                        if (numRegistros > 1) {
    ...
    protected ActionForward obterLinhas(ActionMapping mapping, ActionForm formParam, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < contaVO.getLinhaVOArray().length; i++) {
                ...
                String nrTelefoneCompleto = area + fone;

                try {
                    nrTelefoneCompleto = ConstantesCRM.formatPhoneNumber(area + fone);
    ...
    protected ActionForward obterComunicacao(ActionMapping mapping, ActionForm formParam, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            AtendimentoVO atendimentoVO = registrarContatoFacade.obtemComunicacao(form.getIdPessoa(), 
                                                                                  form.getTipoComunicacaoSelecionada() == null ? "" : form.getTipoComunicacaoSelecionada(), 
                                                                                  user);
    ...
    protected ActionForward encaminharProcesso(ActionMapping mapping, ActionForm formParam, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        // Monta a tag nmFalandoCom
        // com valor de NomeContato
        ...
        try {
            ...
            atendimentoRegistroVO.getDadosProtocoloVO().setDddSMSProtocolo(nrLinha.replaceAll("[^0-9]", "").substring(0, 2));
            atendimentoRegistroVO.getDadosProtocoloVO().setNrLinhaSMSProtocolo(nrLinha.replaceAll("^0-9", "").substring(2, nrLinha.replaceAll("^0-9", "").length()));
            ...
            if (form.getIdLinhaAtendimento() != null && form.getIdLinhaAtendimento() != ConstantesCRM.SVAZIO) {
                idTipoAberturaProtocolo = IDTIPOABERTURAPROTOCOLO_LINHACLIENTE;
            } else if (form.getIdClienteDePara() != null && form.getIdClienteDePara() != ConstantesCRM.SVAZIO) {
                idTipoAberturaProtocolo = IDTIPOABERTURAPROTOCOLO_PESSOA;
            } else if (parametros.getNrConta() != null && parametros.getNrConta() != ConstantesCRM.SVAZIO) {
            ...
            if (atendimentoRegistroVO.getAtendimentoSituacaoVO() == null && registrarContatoForm.getAtendimentoVO().getIdAtendimento().length() < 2) {
                ...
                registrarContatoForm.getAtendimentoVO().setInResponsavelAbertura(parametros.getIdTipoRelacionamento() == null ? "1" : parametros.getIdTipoRelacionamento());

            } else // Reabertura de Processo
        ...
        if (request.getParameter("inAjax") != null && "true".equals(request.getParameter("inAjax"))) {
            ...
            if ((!(form.getQtDias().equals(ConstantesCRM.SVAZIO))) && (!(form.getQtDias().equals("-1")))) {
                request.setAttribute(ConstantesCRM.SKEY_REQUEST_PAGEFLOW, this);
    ...
    private String getTelMask(String nrTelefone) {
        if (nrTelefone.length() >= 10) {
            ...
            //nrTelefone = "(" + nrTelefone.substring(0, 2) + ")" + nrTelefone.substring(2, 6) + "-" + nrTelefone.substring(6, 10);
        } else if (nrTelefone.length() == 9) {
    ...
    protected ActionForward listarProcessos(ActionMapping mapping, ActionForm formParam, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            String user = ConstantesCRM.getCurrentUser(request.getSession());
            atendimentoVOLista = registrarContatoFacade.verificaProcessosCorrentes(user, new Integer(request.getParameter("idChamadaTelefonica")).intValue());
            form.setAtendimentoVOLista(atendimentoVOLista);
            registrarContatoForm = form;
    ...
    protected ActionForward obterArvoreBaixa(ActionMapping mapping, ActionForm formParam, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        AdmFolhaBaixaVO admFolhaBaixaVO = atendimentoWorkflowFacade.obtemArvoreBaixaParte(user, "0", "", form.getIdContato(), new Integer(idTipoComunicacao).toString());
    ...
    protected ActionForward obtemArvoreBaixaParte(ActionMapping mapping, ActionForm formParam, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        AdmFolhaBaixaVO admFolhaBaixaVO = atendimentoWorkflowFacade.obtemArvoreBaixaParte(user, "0", idBaixa, form.getIdContato(), new Integer(idTipoComunicacao).toString());
        String script = ConstantesCRM.SVAZIO;
        String node = ConstantesCRM.SVAZIO;
        String dsMensagem = ConstantesCRM.SVAZIO;
        String idBaixaMensagem = ConstantesCRM.SVAZIO;
     ...
     * int tamanho = 0;
     * int contador = 0;
     * if (form.getIdAtendimento() != null && !(form.getIdAtendimento().equals(""))) {
     ...
     * if (form.getContaSelecionada() != null && !(form.getContaSelecionada().equalsIgnoreCase(""))) {
     * atendimentoFechamentoVO.getContas().getContaVOArray(0).setIdConta(Integer.parseInt(form.getContaSelecionada()));
     * }
     * if (form.getLinhaSelecionada() != null && !(form.getLinhaSelecionada().equalsIgnoreCase(""))) {
     ...
     * }
     * } else {
     * formularioCampoValorVO.setValor("");
     * formularioCampoValorVO.setIdFormularioCampoValor("");
     * }
     * list.add(formularioCampoValorVO);
     * FormularioCampoGruposArray[i].setFormularioCampoValorVOArray((FormularioCampoValorVO[]) list.toArray(new FormularioCampoValorVO[0]));
     * }
