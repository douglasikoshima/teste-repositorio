...
/**
 * Indica o tipo de pagamento se dinheiro, cheque, credito,
 * 				etc.
 */
public class TipoPagamento  implements java.io.Serializable {
     ...
     * 
     * @return descricao   * Descricao do tipo de pagamento, de credito, dinheiro etc.
     */
     ...
     * 
     * @param descricao   * Descricao do tipo de pagamento, de credito, dinheiro etc.
     */
