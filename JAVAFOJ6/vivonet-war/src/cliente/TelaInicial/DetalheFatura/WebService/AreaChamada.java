...
/**
 * Indica se a chamada ocorreu dentra da area de cobertura
 * 				ou fora.
 */
public class AreaChamada  implements java.io.Serializable {
    /* Tipo de Area da chamada (Dominio: 0- Todos, 1 -
     * 						Dentro da Area e 2 -Fora da Area) */
     ...
     * 
     * @return codigo   * Tipo de Area da chamada (Dominio: 0- Todos, 1 -
     * 						Dentro da Area e 2 -Fora da Area)
     */
     ...
     * 
     * @param codigo   * Tipo de Area da chamada (Dominio: 0- Todos, 1 -
     * 						Dentro da Area e 2 -Fora da Area)
     */
     ...
     * 
     * @param data.descricao   * Descricao da area de cobertura da chamada.
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AreaChamada)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AreaChamada.class, true);
