...
/**
 * Mantem informacoes dos contatos disponiveis nas agendas
 * 				de clientes vivo.
 */
public class AgendaContato  implements java.io.Serializable {
    ...
    /* Indica o tipo do telefone do contato, se
     * 						celular, comercial, residencial, etc */
     ...
     * 
     * @param nome   * Nome do contato da agenda
     */
     ...
     * 
     * @param apelido   * Apelido do contato
     */
     ...
     * 
     * @return tipoTelefone   * Indica o tipo do telefone do contato, se
     * 						celular, comercial, residencial, etc
     */
     ...
     * 
     * @param tipoTelefone   * Indica o tipo do telefone do contato, se
     * 						celular, comercial, residencial, etc
     */
     ...
     * 
     * @return grupoContato   * Grupo em que o contato esta, se Familia, Empresa, VIP, etc.
     */
     ...
     * 
     * @param grupoContato   * Grupo em que o contato esta, se Familia, Empresa, VIP, etc.
     */
     ...
     * 
     * @return telefone   * Numero do telefone que foi cadastrado na agenda do contato
     */
     ...
     * 
     * @param telefone   * Numero do telefone que foi cadastrado na agenda do contato
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AgendaContato)) return false;
        ...
        _equals = true && 
            ...
            ((this.grupoContato==null && other.getGrupoContato()==null) || 
             (this.grupoContato!=null &&
              this.grupoContato.equals(other.getGrupoContato()))) &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AgendaContato.class, true);
