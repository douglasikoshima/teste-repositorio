...
public class CabecalhoVivo implements java.io.Serializable {
    ...
    private br.com.vivo.fo.ctrls.workflow.atendimentoWorkflow.ws.MC.Geral.CabecalhoVivoNomeAplicacao nomeAplicacao;
    ...
    public CabecalhoVivo(
            ...
            br.com.vivo.fo.ctrls.workflow.atendimentoWorkflow.ws.MC.Geral.CabecalhoVivoNomeAplicacao nomeAplicacao,
     ...
     */
    public br.com.vivo.fo.ctrls.workflow.atendimentoWorkflow.ws.MC.Geral.CabecalhoVivoNomeAplicacao getNomeAplicacao() {
        return nomeAplicacao;
    }
     ...
     * @param nomeAplicacao
     */
    public void setNomeAplicacao(br.com.vivo.fo.ctrls.workflow.atendimentoWorkflow.ws.MC.Geral.CabecalhoVivoNomeAplicacao nomeAplicacao) {
        this.nomeAplicacao = nomeAplicacao;
    }
     ...
     * 
     * @return versao   * Defini a versao do servico que esta sendo
     * 						invocado. O formato da versao deve sempre ser
     * 						99.99
     */
     ...
     * 
     * @param versao   * Defini a versao do servico que esta sendo
     * 						invocado. O formato da versao deve sempre ser
     * 						99.99
     */
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.vivo.com.br/MC/Geral", "versao"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
