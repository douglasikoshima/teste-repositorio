...
public class CabecalhoVivo implements java.io.Serializable {
	...
	private static final long serialVersionUID = -3508322757636350920L;

	private java.lang.String loginUsuario;

	/*
	 * Descricao do canal de atendimento que e enviado pelo SCA.
	 */
	private java.lang.String canalAtendimento;

	/*
	 * Codigo da sessao, codigo unico que identifica uma sessao.
	 */
	private java.lang.String codigoSessao;

	private br.com.vivo.fo.ctrls.workflow.sap.MC.Geral.CabecalhoVivoNomeAplicacao nomeAplicacao;
	...
	/*
	 * Codigo que identifica uma funcionalidade do sistema. Exemplos de
	 * funcionalidade para o sistema Vivo360: Ativacao e desativacao de
	 * servicos, Migracao para GSM, Migracao para CDMA, Troca de aparelho CDMA e
	 * GSM, Troca de chip, troca de plano e etc.
	 */
	...
	/*
	 * Nome do servico que foi invocado, exemplo: consultaPessoa, consultaLinha,
	 * etc.
	 */
	private java.lang.String nomeServico;

	/*
	 * Defini a versao do servico que esta sendo invocado. O formato da versao
	 * deve sempre ser 99.99
	 */
	...
	public CabecalhoVivo(
			...
			br.com.vivo.fo.ctrls.workflow.sap.MC.Geral.CabecalhoVivoNomeAplicacao nomeAplicacao,
			java.lang.String token, java.lang.String enderecoIP,
			java.lang.String codigoFuncionalidade,
			java.util.Calendar dataTransacao, java.lang.String nomeServico,
	 ...
	 * 
	 * @return canalAtendimento * Descricao do canal de atendimento que e
	 *         enviado pelo SCA.
	 */
	 ...
	 * 
	 * @return codigoSessao * Codigo da sessao, codigo unico que identifica uma
	 *         sessao.
	 */
	 ...
	 */
	public br.com.vivo.fo.ctrls.workflow.sap.MC.Geral.CabecalhoVivoNomeAplicacao getNomeAplicacao() {
		return nomeAplicacao;
	}
	 ...
	 * 
	 * @return codigoFuncionalidade * Codigo que identifica uma funcionalidade
	 *         do sistema. Exemplos de funcionalidade para o sistema Vivo360:
	 *         Ativacao e desativacao de servicos, Migracao para GSM, Migracao
	 *         para CDMA, Troca de aparelho CDMA e GSM, Troca de chip, troca de
	 *         plano e etc.
	 */
	 ...
	 *            * Codigo que identifica uma funcionalidade do sistema.
	 *            Exemplos de funcionalidade para o sistema Vivo360: Ativacao e
	 *            desativacao de servicos, Migracao para GSM, Migracao para
	 *            CDMA, Troca de aparelho CDMA e GSM, Troca de chip, troca de
	 *            plano e etc.
	 */
	 ...
	 * 
	 * @param nomeServico
	 *            * Nome do servico que foi invocado, exemplo: consultaPessoa,
	 *            consultaLinha, etc.
	 */
	...
	/**
	 * Gets the versao value for this CabecalhoVivo.
	 * 
	 * @return versao * Defini a versao do servico que esta sendo invocado. O
	 *         formato da versao deve sempre ser 99.99
	 */
	...
	/**
	 * Sets the versao value for this CabecalhoVivo.
	 * 
	 * @param versao
	 *            * Defini a versao do servico que esta sendo invocado. O
	 *            formato da versao deve sempre ser 99.99
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof CabecalhoVivo))
			return false;
		...
		boolean _equals;
		_equals = true
				&& ((this.loginUsuario == null && other.getLoginUsuario() == null) || (this.loginUsuario != null && this.loginUsuario
						.equals(other.getLoginUsuario())))
				&& ((this.canalAtendimento == null && other
						.getCanalAtendimento() == null) || (this.canalAtendimento != null && this.canalAtendimento
						.equals(other.getCanalAtendimento())))
				&& ((this.codigoSessao == null && other.getCodigoSessao() == null) || (this.codigoSessao != null && this.codigoSessao
						.equals(other.getCodigoSessao())))
				&& ((this.nomeAplicacao == null && other.getNomeAplicacao() == null) || (this.nomeAplicacao != null && this.nomeAplicacao
						.equals(other.getNomeAplicacao())))
				&& ((this.token == null && other.getToken() == null) || (this.token != null && this.token
						.equals(other.getToken())))
				&& ((this.enderecoIP == null && other.getEnderecoIP() == null) || (this.enderecoIP != null && this.enderecoIP
						.equals(other.getEnderecoIP())))
				&& ((this.codigoFuncionalidade == null && other
						.getCodigoFuncionalidade() == null) || (this.codigoFuncionalidade != null && this.codigoFuncionalidade
						.equals(other.getCodigoFuncionalidade())))
				&& ((this.dataTransacao == null && other.getDataTransacao() == null) || (this.dataTransacao != null && this.dataTransacao
						.equals(other.getDataTransacao())))
				&& ((this.nomeServico == null && other.getNomeServico() == null) || (this.nomeServico != null && this.nomeServico
						.equals(other.getNomeServico())))
				&& ((this.versao == null && other.getVersao() == null) || (this.versao != null && this.versao
						.equals(other.getVersao())));
		__equalsCalc = null;
		return _equals;
	}
	...
	static {
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://www.vivo.com.br/MC/Geral", "loginUsuario"));
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://www.vivo.com.br/MC/Geral", "canalAtendimento"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://www.vivo.com.br/MC/Geral", "codigoSessao"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://www.vivo.com.br/MC/Geral", "nomeAplicacao"));
		elemField.setXmlType(new javax.xml.namespace.QName(
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://www.vivo.com.br/MC/Geral", "token"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://www.vivo.com.br/MC/Geral", "enderecoIP"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://www.vivo.com.br/MC/Geral", "codigoFuncionalidade"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(true);
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://www.vivo.com.br/MC/Geral", "dataTransacao"));
		elemField.setXmlType(new javax.xml.namespace.QName(
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://www.vivo.com.br/MC/Geral", "nomeServico"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://www.vivo.com.br/MC/Geral", "versao"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
