...
/**
 * Indica se a tarifa eh normal ou reduzida.
 */
public class TipoTarifa implements java.io.Serializable {

	private static final long serialVersionUID = 4946548186340439843L;

	/*
	 * Tarifa da Ligacao Dominio: 0 - Normal 1 - Reduzida
	 */
	...
	public TipoTarifa(java.math.BigInteger codigo, java.lang.String descricao) {
		this.codigo = codigo;
		this.descricao = descricao;
	}

	/**
	 * Gets the codigo value for this TipoTarifa.
	 * 
	 * @return codigo * Tarifa da Ligacao Dominio: 0 - Normal 1 - Reduzida
	 */
	...
	/**
	 * Sets the codigo value for this TipoTarifa.
	 * 
	 * @param codigo
	 *            * Tarifa da Ligacao Dominio: 0 - Normal 1 - Reduzida
	 */
	...
	/**
	 * Gets the descricao value for this TipoTarifa.
	 * 
	 * @return descricao * Descricao do tipo de tarifa
	 */
	...
	/**
	 * Sets the descricao value for this TipoTarifa.
	 * 
	 * @param descricao
	 *            * Descricao do tipo de tarifa
	 */
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			TipoTarifa.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.vivo.com.br/MC/Conta", "TipoTarifa"));
