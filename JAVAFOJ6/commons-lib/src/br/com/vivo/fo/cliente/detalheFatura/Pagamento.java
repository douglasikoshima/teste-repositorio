...
public class Pagamento implements java.io.Serializable {
	...
	private static final long serialVersionUID = -8649379395287440984L;

	private java.lang.String dataPagamento;

	/*
	 * Valor pago pela fatura que pode ser diferente do valor da fatura.
	 */
	...
	public Pagamento(java.lang.String dataPagamento, java.math.BigDecimal valorPagamento, TipoPagamento tipoPagamento,
			java.util.Date dataReversaoPagamento, java.math.BigDecimal valorReversaoPagamento) {
	 ...
	 *            * Valor pago pela fatura que pode ser diferente do valor da
	 *            fatura.
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		boolean _equals;
		_equals = true
				&& ((this.dataPagamento == null && other.getDataPagamento() == null) || (this.dataPagamento != null && this.dataPagamento
						.equals(other.getDataPagamento())))
				&& ((this.valorPagamento == null && other.getValorPagamento() == null) || (this.valorPagamento != null && this.valorPagamento
						.equals(other.getValorPagamento())))
				&& ((this.tipoPagamento == null && other.getTipoPagamento() == null) || (this.tipoPagamento != null && this.tipoPagamento
						.equals(other.getTipoPagamento())))
				&& ((this.dataReversaoPagamento == null && other.getDataReversaoPagamento() == null) || (this.dataReversaoPagamento != null && this.dataReversaoPagamento
						.equals(other.getDataReversaoPagamento())))
				&& ((this.valorReversaoPagamento == null && other.getValorReversaoPagamento() == null) || (this.valorReversaoPagamento != null && this.valorReversaoPagamento
						.equals(other.getValorReversaoPagamento())));
		__equalsCalc = null;
		return _equals;
	}
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("http://www.vivo.com.br/MC/Conta", "valorReversaoPagamento"));
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "decimal"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
