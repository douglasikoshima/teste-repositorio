...
/**
 * Indica se a chamada eh originada, internacional, nacional, a cobrar etc.
 */
public class TipoDetalheChamada implements java.io.Serializable {

	private static final long serialVersionUID = -8296064157752155007L;

	/*
	 * Detalhe da ligacao (Dominio: 0 - Todas 1 - Originada 2 - Local 3 - Longa
	 * Distancia Nacional 4 - Longa Distancia Internacional 5 - A cobrar)
	 */
	...
	public TipoDetalheChamada(java.math.BigInteger codigo, java.lang.String descricao) {
		this.codigo = codigo;
	 ...
	 * 
	 * @return codigo * Detalhe da ligacao (Dominio: 0 - Todas 1 - Originada 2 -
	 *         Local 3 - Longa Distancia Nacional 4 - Longa Distancia
	 *         Internacional 5 - A cobrar)
	 */
	 ...
	 * 
	 * @param codigo
	 *            * Detalhe da ligacao (Dominio: 0 - Todas 1 - Originada 2 -
	 *            Local 3 - Longa Distancia Nacional 4 - Longa Distancia
	 *            Internacional 5 - A cobrar)
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof TipoDetalheChamada))
			return false;
