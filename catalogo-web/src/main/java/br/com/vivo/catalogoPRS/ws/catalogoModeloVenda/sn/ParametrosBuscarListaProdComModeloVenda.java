/**
 * ParametrosBuscarListaProdComModeloVenda.java
 *
...
public class ParametrosBuscarListaProdComModeloVenda  implements java.io.Serializable {
    private br.com.vivo.catalogoPRS.ws.catalogoGeral.sn.PaginacaoIn paginacaoIn;

    private long idModeloVenda;

    public ParametrosBuscarListaProdComModeloVenda() {
    }
    ...
    /**
     * Gets the paginacaoIn value for this ParametrosBuscarListaProdComModeloVenda.
     * 
     * @return paginacaoIn
     */
    ...
    /**
     * Sets the paginacaoIn value for this ParametrosBuscarListaProdComModeloVenda.
     * 
     * @param paginacaoIn
     */
    ...
    /**
     * Gets the idModeloVenda value for this ParametrosBuscarListaProdComModeloVenda.
     * 
    ...
    /**
     * Sets the idModeloVenda value for this ParametrosBuscarListaProdComModeloVenda.
     * 
     * @param idModeloVenda
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ParametrosBuscarListaProdComModeloVenda)) return false;
        ParametrosBuscarListaProdComModeloVenda other = (ParametrosBuscarListaProdComModeloVenda) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ParametrosBuscarListaProdComModeloVenda.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.vivo.com.br/SN/CatalogoModeloVenda", ">ParametrosBuscarListaProdComModeloVenda"));
