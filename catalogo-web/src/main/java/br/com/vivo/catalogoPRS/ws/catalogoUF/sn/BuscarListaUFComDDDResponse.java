/**
 * BuscarListaUFComDDDResponse.java
 *
...
public class BuscarListaUFComDDDResponse  implements java.io.Serializable {
    private br.com.vivo.catalogoPRS.ws.catalogoUF.sn.ResultadoBuscarListaUFUF[] resultadoBuscarListaUF;

    public BuscarListaUFComDDDResponse() {
    }
    ...
    /**
     * Gets the resultadoBuscarListaUF value for this BuscarListaUFComDDDResponse.
     * 
    ...
    /**
     * Sets the resultadoBuscarListaUF value for this BuscarListaUFComDDDResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BuscarListaUFComDDDResponse)) return false;
        BuscarListaUFComDDDResponse other = (BuscarListaUFComDDDResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BuscarListaUFComDDDResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.vivo.com.br/SN/CatalogoUF", ">buscarListaUFComDDDResponse"));
