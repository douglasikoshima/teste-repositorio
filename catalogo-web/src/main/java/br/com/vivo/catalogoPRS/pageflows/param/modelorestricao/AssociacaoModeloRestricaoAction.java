package br.com.vivo.catalogoPRS.pageflows.param.modelorestricao;
...
public class AssociacaoModeloRestricaoAction extends BaseMappingDispatchAction {
	...
	public ActionForward carregarTipoRestricao(ActionMapping mapping, ActionForm form, HttpServletRequest request,	HttpServletResponse response) {
		...
		GrupoProdutoDelegate grupoProdutoDelegate = new GrupoProdutoDelegate();
		request.setAttribute("nmModelo", grupoProdutoDelegate.findById(doGrupoProdutoTO(associacaoModeloRestricaoForm)).getNmGrupoProduto());
