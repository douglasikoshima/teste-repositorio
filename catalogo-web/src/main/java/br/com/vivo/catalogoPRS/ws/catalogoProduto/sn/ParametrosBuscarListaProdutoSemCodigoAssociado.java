/**
 * ParametrosBuscarListaProdutoSemCodigoAssociado.java
 *
...
public class ParametrosBuscarListaProdutoSemCodigoAssociado  implements java.io.Serializable {
    private br.com.vivo.catalogoPRS.ws.catalogoProduto.sn.ParametrosProdutosIn parametrosProdutosIn;

    public ParametrosBuscarListaProdutoSemCodigoAssociado() {
    }
    ...
    /**
     * Gets the parametrosProdutosIn value for this ParametrosBuscarListaProdutoSemCodigoAssociado.
     * 
    ...
    /**
     * Sets the parametrosProdutosIn value for this ParametrosBuscarListaProdutoSemCodigoAssociado.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ParametrosBuscarListaProdutoSemCodigoAssociado)) return false;
        ParametrosBuscarListaProdutoSemCodigoAssociado other = (ParametrosBuscarListaProdutoSemCodigoAssociado) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ParametrosBuscarListaProdutoSemCodigoAssociado.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.vivo.com.br/SN/CatalogoProduto", ">ParametrosBuscarListaProdutoSemCodigoAssociado"));
