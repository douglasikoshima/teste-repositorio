 ...
 */
public class ErroComumFormBean extends TradutorFormBean {
	...
	private Collection colPesquisarErrosCadastrados;
	...
	public Collection getColPesquisarErrosCadastrados() {
		return colPesquisarErrosCadastrados;
	}

	public void setColPesquisarErrosCadastrados(Collection colPesquisarErrosCadastrados) {
		this.colPesquisarErrosCadastrados = colPesquisarErrosCadastrados;
	}
