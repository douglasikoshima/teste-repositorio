/**
 * BuscarListaUFComDDDPorIdPlanoResponse.java
 *
...
public class BuscarListaUFComDDDPorIdPlanoResponse  implements java.io.Serializable {
    private br.com.vivo.catalogoPRS.ws.catalogoUF.sn.ResultadoBuscarListaUFUF[] resultadoBuscarListaUF;

    public BuscarListaUFComDDDPorIdPlanoResponse() {
    }
    ...
    /**
     * Gets the resultadoBuscarListaUF value for this BuscarListaUFComDDDPorIdPlanoResponse.
     * 
    ...
    /**
     * Sets the resultadoBuscarListaUF value for this BuscarListaUFComDDDPorIdPlanoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BuscarListaUFComDDDPorIdPlanoResponse)) return false;
        BuscarListaUFComDDDPorIdPlanoResponse other = (BuscarListaUFComDDDPorIdPlanoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BuscarListaUFComDDDPorIdPlanoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.vivo.com.br/SN/CatalogoUF", ">buscarListaUFComDDDPorIdPlanoResponse"));
