/**
 * ResultadoBuscarListaModeloListaModelosRetornoModeloLink.java
 *
...
public class ResultadoBuscarListaModeloListaModelosRetornoModeloLink  implements java.io.Serializable {
    private java.lang.Long idMultimidiaLink;

    private java.lang.String nmMultimidiaLink;

    public ResultadoBuscarListaModeloListaModelosRetornoModeloLink() {
    }
    ...
    /**
     * Gets the idMultimidiaLink value for this ResultadoBuscarListaModeloListaModelosRetornoModeloLink.
     * 
    ...
    /**
     * Sets the idMultimidiaLink value for this ResultadoBuscarListaModeloListaModelosRetornoModeloLink.
     * 
    ...
    /**
     * Gets the nmMultimidiaLink value for this ResultadoBuscarListaModeloListaModelosRetornoModeloLink.
     * 
    ...
    /**
     * Sets the nmMultimidiaLink value for this ResultadoBuscarListaModeloListaModelosRetornoModeloLink.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ResultadoBuscarListaModeloListaModelosRetornoModeloLink)) return false;
        ResultadoBuscarListaModeloListaModelosRetornoModeloLink other = (ResultadoBuscarListaModeloListaModelosRetornoModeloLink) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ResultadoBuscarListaModeloListaModelosRetornoModeloLink.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.vivo.com.br/SN/CatalogoModelo", ">>>>ResultadoBuscarListaModelo>ListaModelos>RetornoModelo>Link"));
