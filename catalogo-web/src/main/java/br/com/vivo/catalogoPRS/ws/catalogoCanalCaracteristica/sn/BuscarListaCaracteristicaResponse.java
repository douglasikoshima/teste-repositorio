/**
 * BuscarListaCaracteristicaResponse.java
 *
...
public class BuscarListaCaracteristicaResponse  implements java.io.Serializable {
    private br.com.vivo.catalogoPRS.ws.catalogoCanalCaracteristica.sn.ResultadoCaracteristica resultadoCaracteristica;

    public BuscarListaCaracteristicaResponse() {
    }
    ...
    /**
     * Gets the resultadoCaracteristica value for this BuscarListaCaracteristicaResponse.
     * 
    ...
    /**
     * Sets the resultadoCaracteristica value for this BuscarListaCaracteristicaResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BuscarListaCaracteristicaResponse)) return false;
        BuscarListaCaracteristicaResponse other = (BuscarListaCaracteristicaResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BuscarListaCaracteristicaResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.vivo.com.br/SN/CatalogoCaracteristica", ">buscarListaCaracteristicaResponse"));
