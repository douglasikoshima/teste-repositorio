package br.com.vivo.catalogoPRS.pageflows.param.gerenciadorregras.filtro1;
...
public class GerenciadorRegrasConfiguracaoFiltro1Action extends BaseMappingDispatchAction implements Serializable {

	private static final long serialVersionUID = 8095816128686672544L;
	private static final Long IN_TIPO_FILTRO = new Long(1);
	...
	public ActionForward begin(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		gerenciadorRegrasConfiguracaoTO.setInTipoFiltro(GerenciadorRegrasConfiguracaoFiltro1Action.IN_TIPO_FILTRO);
	...
	public ActionForward pesquisar(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if(formBean.getIdCanalAtendimento() != null && !formBean.getIdCanalAtendimento().equals(0)){
			...
			gerenciadorRegrasConfiguracaoTOList = null;
			formBean.setGerenciadorRegrasConfiguracaoTOJSONNew(null);
		}
	...
	private GerenciadorRegrasConfiguracaoTO doGerenciadorRegrasConfiguracaoTO(JSONObject gerenciadorRegrasConfiguracaoJSON) throws JSONException{
		...
		result.setInTipoFiltro(GerenciadorRegrasConfiguracaoFiltro1Action.IN_TIPO_FILTRO);
