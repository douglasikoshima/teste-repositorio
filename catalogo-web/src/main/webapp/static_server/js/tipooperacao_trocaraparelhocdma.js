$(document).ready(function() {
	...
	// UC-04 trocar aparelho CDMA
	$('#aquisicao-radio').click(function() {
		$('#formOperacao').attr('action','UC005-TrocarAparelhoCDMAPre-Consultar_Dados_Aparelho.html');
	...
	$('#semaquisicao-radio').click(function() {
		$('#formOperacao').attr('action','UC033-TrocarAparelhoCDMAPre-Configurar_Promocao_SemAquisicao.html');
