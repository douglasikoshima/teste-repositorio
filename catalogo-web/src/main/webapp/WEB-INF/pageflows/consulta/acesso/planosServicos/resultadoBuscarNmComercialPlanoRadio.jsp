	...
	<div id="resultado_pesquisa_planos" style="width:100% ;position: relative">
			<div class="both-scroll" style="height: 300px; width: 100%;">
						...
						<logic:iterate id="planos" property="arrayListaPlanos" name="consultaAcessoPlanosServicosForm">
								<tr>
									<td class="center">
									    <html:radio property="nmComercialSelecionados" value="${planos.idPlano}" onClick="selecionaCheckBoxPopup('hidden_nmComercial_planoRadio', this); verificarSelecaoAll(this, 'radio_nmComercial_${planos.nmComercial}');" styleId="radio_nmComercial_${planos.nmComercial}" styleClass="semBorda belongsToForm checkbox" />
									</td>
