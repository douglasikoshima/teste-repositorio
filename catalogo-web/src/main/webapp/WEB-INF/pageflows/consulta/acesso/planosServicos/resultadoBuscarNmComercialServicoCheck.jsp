	...
	<div id="resultado_pesquisa_servicos" style="width:100% ;position: relative">
			<div class="both-scroll" style="height: 300px; width: 100%;">
						...
						<logic:iterate id="servicos" property="arrayListaServicos" name="consultaAcessoPlanosServicosForm">
								<tr>
									<td class="center">
									    <html:checkbox property="nmComercialSelecionados" value="${servicos.idServico}" onClick="selecionaCheckBoxPopup('hidden_nmComercial_servicoCheck', this); verificarSelecaoAll(this, 'radio_nmComercial_${servicos.nmComercial}');" styleId="radio_nmComercial_${servicos.nmComercial}" styleClass="semBorda belongsToForm checkbox"/>
									</td>
