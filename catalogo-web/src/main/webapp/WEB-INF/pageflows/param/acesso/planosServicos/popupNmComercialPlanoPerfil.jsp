...
<catalogo:popupWidthFull>
	...
	<div id="popup_nmcomercial_plano_perfil" style="width: 100%;">
		...
		<html:text property="alturaPopup" styleId="alturaPopup" value="400px" styleClass="hide" />
		...
		<jsp:include page="/templates/box_pre.jsp"/>
			...
			<br clear="all"/>			
			<html:form action="/br/com/vivo/catalogoPRS/pageflows/param/acesso/planosServicos/pesquisarNmComercialNoPopupPlanoPerfil">
				...
				<div class="botao">
					<html:button bundle="messages" tabindex="8" onClick="$('resultado_pesquisa_popup').hide();limparForm(this);return false;" value="Limpar" styleClass="btNavegacao74"  property="btn_limpar" styleId="btn_limpar" altKey="catalogo.global.Limpar" titleKey="catalogo.global.Limpar"/>					
					<span>&nbsp;</span>
					<html:button bundle="messages" tabindex="7" property="botao_pesquisar_nome_comercial_plano_popup" styleId="botao_pesquisar_nome_comercial_plano_popup" onMouseDown="$('pagina_solicitada').value='';return true;" onClick="clearAndShow('resultado_pesquisa_popup');send(this, 'resultado_pesquisa_popup', null , 'div_erro_popup_nmcomercial_plano_perfil', null);" styleClass="btNavegacao74" value="Pesquisar" altKey="catalogo.paramProdutos.Pesquisar" titleKey="catalogo.paramProdutos.Pesquisar" />					
				</div>
			</html:form>
			<div class="barra"></div>
