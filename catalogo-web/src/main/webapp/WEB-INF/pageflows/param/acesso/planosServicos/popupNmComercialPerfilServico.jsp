...
<catalogo:popupWidthFull>
	...
	<div id="popup_nmcomercial_perfil_servico" style="width: 100%;">
		...
		<div id="div_erro_popup_nmcomercial_perfil_servico"></div>
		...
		<jsp:include page="/templates/box_pre.jsp"/>
			...
			<html:form action="/br/com/vivo/catalogoPRS/pageflows/param/acesso/pesquisarNmComercialNoPopupPerfilServico.do">
				...
				<div class="fleft">
					...
					<html:select tabindex="2" property="idGrupoServico" styleId="select_categoria" style="width:144px;">
						<html:option value="">-- Selecione --</html:option>
				...
				<div class="fleft">
					...
					<html:text tabindex="4" size="27" property="nmComPerfilServicoPop" styleId="nmComPerfilServicoPop" styleClass="min_size_required"/>
				</div>
				...
				<div class="barra"></div>
				<div class="botao">
					<html:button bundle="messages" tabindex="7" property="btn_limpar" styleId="btn_limpar" onClick="$('resultado_pesquisa_popup').hide();limparForm(this);return false;" value="Limpar" styleClass="btNavegacao74" altKey="catalogo.global.Limpar" titleKey="catalogo.global.Limpar"/>
					<span>&nbsp;</span>
					<html:button bundle="messages" tabindex="6" property="botao_pesquisar_nome_comercial_plano_popup" styleId="botao_pesquisar_nome_comercial_plano_popup" onMouseDown="$('pagina_solicitada').value='';return true;" onClick="clearAndShow('resultado_pesquisa_popup');send(this, 'resultado_pesquisa_popup', null , 'div_erro_popup_nmcomercial_perfil_servico', null);" styleClass="btNavegacao74" value="Pesquisar" altKey="catalogo.paramProdutos.Pesquisar" titleKey="catalogo.paramProdutos.Pesquisar"/>					
				</div>
			</html:form>
