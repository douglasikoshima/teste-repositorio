...
<catalogo:popupPadrao >
		<div id="popup_lista_perfil" style="width: 100%">
			...
			<div align="left" class="vertical-scroll" style="height:300px">
				<html:form action="/br/com/vivo/catalogoPRS/pageflows/param/acesso/planosServicos/buscarListaPerfilSCAPlanoPerfilServicoPerfil.do">
					<table class="tabConteudoGeral" width="100%">
						<tr>
							<td>
								<html:checkbox bundle="messages" property="chkTodos" styleId="chkTodos" styleClass="semBorda" onclick="selecionarTodosCheckbox($(this).up('table').select('.checkbox'), this.checked);" />							
							</td>
						    <td><b>Todas</b></td>
						</tr>
						<logic:iterate id="perfilSCA" property="arrayPerfil" name="parametrizacaoAcessoForm"> 
							<tr onmouseover="$(this).className='mouseOver'" onmouseout="$(this).className='mouseOut'">	
								<td width="10px">					 											
									<html:multibox bundle="messages" property="perfilSelecionados" styleId="perfil_cb${perfilSCA.idPerfilSCA}" value="${perfilSCA.idPerfilSCA}" onClick="selecionaCheckBoxPopup('hidden_lista_perfil_plano_perfil', this);" styleClass="semBorda checkbox">
