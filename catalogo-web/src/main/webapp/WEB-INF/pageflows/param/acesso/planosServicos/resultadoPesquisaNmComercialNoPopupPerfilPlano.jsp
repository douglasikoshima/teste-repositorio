...
<html:form action="/br/com/vivo/catalogoPRS/pageflows/param/acesso/pesquisarNmComercialNoPopupPerfilPlano">
...
<!--			<table cellspacing="0" cellpadding="0" class="tabela-padrao tablesorter table_header">
					...
					<tbody>		
						<c:if test="${not empty parametrizacaoAcessoForm.planoLista}">			
							<logic:iterate id="planos" property="planoLista" name="parametrizacaoAcessoForm">												
								...
								<tr>
									<td class="center">
										<html:checkbox property="nmComercialSelecionados" onClick="selecionaCheckBoxPopup('hidden_nmComercial_perfil_plano', this)" styleId="plano_cb${planos.idPlano}" value="${planos.idPlano}" styleClass="semBorda checkbox"  />
							        </td>
									<td>
		...
		<div style="margin: 5px;" class="botao">
			<html:button styleClass="btOk" property="btOk" onclick="fecharPopup('popup1');" value="OK" title="Ok"/>
		</div>
</html:form>