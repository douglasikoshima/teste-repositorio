...
<fmt:bundle basename="catalogoprs_messages" >
	<div id="popup_nmcomercial_perfil_plano" style="width: 100%;">
		...
		<div id="div_erro_popup_nmcomercial_perfil_plano"></div>
		<c:set var="nomeBox" scope="application"  value="Nome Comercial do Plano" />
		<jsp:include page="/templates/box_pre.jsp"/>
		
			<br clear="all"/>
			<html:form action="/br/com/vivo/catalogoPRS/pageflows/param/acesso/pesquisarNmComercialNoPopupPerfilPlano.do">
				...
				<div class="fleft">
					...
					<html:select tabindex="3" property="idPlataforma" styleId="select_plataforma" style="width:150px;">
				...
				<div class="fleft">
					...
					<html:text tabindex="5" size="28" property="nmComPerfilPlanoPop" styleId="nmComPerfilPlanoPop" styleClass="min_size_required"/>
				</div>
				...
				<div class="botao">
					<html:button bundle="messages" property="btn_limpar" styleId="btn_limpar" tabindex="8" onClick="$('resultado_pesquisa_popup').hide();limparForm(this);return false;" value="Limpar" styleClass="btNavegacao74" altKey="catalogo.global.Limpar" titleKey="catalogo.global.Limpar" />
					<span>&nbsp;</span>
				    <html:button bundle="messages" tabindex="7" styleId="botao_pesquisar_nome_comercial_plano_popup" property="botao_pesquisar_nome_comercial_plano_popup" onMouseDown="$('pagina_solicitada').value='';return true;" onClick="clearAndShow('resultado_pesquisa_popup');send(this, 'resultado_pesquisa_popup', null , 'div_erro_popup_nmcomercial_perfil_plano', null);" styleClass="btNavegacao74" value="Pesquisar" altKey="catalogo.paramProdutos.Pesquisar" titleKey="catalogo.paramProdutos.Pesquisar"/>						
				</div>
			</html:form>
			<div class="barra"></div>
