	...
	<div>
		<div class="conteudo_box_middle">
			<div class="conteudo_box_middle_mg">
				<html:form action="/br/com/vivo/catalogoPRS/pageflows/param/acesso/salvarAlteracoesRestricoesAcessoServico.do" styleId="lista_perfil_servico">
									...
									<logic:iterate id="servicos" property="acessoServicoLista" name="parametrizacaoAcessoForm" indexId="index">							
										<c:set value="true" var="firstPass"/>
											<tr>
												...
												<td style="width: 30%">${servicos.nmComercial}</td>
					...
					<div class="botao">
						<cata:temPermissao acao="configurarPerfilAcesso">
							<html:button bundle="messages" tabindex="13" property="btn_gravar" styleId="botao_gravar_restricoes_alteradas" onClick="if(send(this, 'resultado_pesquisa', null, 'resultado_pesquisa')){};return false" styleClass="btNavegacao74" value="Salvar" altKey="catalogo.matrizOferta.cabecalho.Alterar" titleKey="catalogo.matrizOferta.cabecalho.Alterar"/>
							<label>&nbsp;</label>
						</cata:temPermissao>
