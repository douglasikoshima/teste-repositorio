...
<catalogo:popupPadrao >
	<div id="popup_lista_perfil" style="width: 100%">
		...
		<div align="left" class="vertical-scroll" style="height:300px">
			<html:form action="/br/com/vivo/catalogoPRS/pageflows/param/acesso/buscarListaPerfilSCANovaRestricaoPlanoServico.do">
				<table class="tabConteudoGeral" width="100%">
					...
					<logic:iterate id="perfilSCA" property="arrayPerfil" name="parametrizacaoAcessoForm"> 
						<tr onmouseover="$(this).className='mouseOver'" onmouseout="$(this).className='mouseOut'">
							<td width=10px">
								<html:multibox property="perfilSelecionados" styleId="perfil_cb${perfilSCA.idPerfilSCA}" value="${perfilSCA.idPerfilSCA}_${perfilSCA.idSistema}" onClick="selecionaCheckBoxPopup('hidden_lista_perfil_nova_restricao_plano_servico', this)" styleClass="semBorda checkbox" >
