	...
	<div>
		<div class="conteudo_box_middle">
			<div class="conteudo_box_middle_mg">
				<html:form action="/br/com/vivo/catalogoPRS/pageflows/param/acesso/salvarAlteracoesRestricoesAcessoPlano.do" styleId="lista_plano_perfil">
													...
													<tr>
														...
														<td>
															<c:if test="${firstPass == true}">
																<c:choose>
																	<c:when test="${not empty perfilSCA[planos.idPerfilSCA]}">
																		${perfilSCA[planos.idPerfilSCA]}
																	</c:when>
																	<c:otherwise>
																		${perfilScaMap[planos.idPerfilSCA].name}
																	</c:otherwise>
																</c:choose>
