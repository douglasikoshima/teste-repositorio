...
<html:form action="/br/com/vivo/catalogoPRS/pageflows/param/acesso/planosServicos/pesquisarNmComercialNoPopupPlanoPerfil.do">
					...
					<tbody>
						<c:if test="${not empty parametrizacaoAcessoForm.planoLista}">
							<logic:iterate id="planos" property="planoLista" name="parametrizacaoAcessoForm">						
								...
								<tr>
									<td class="center">
										<html:radio property="nmComercialSelecionados" value="${planos.idPlano}" onClick="selecionaRadioGroupPopup('hidden_nmComercial_plano_perfil', this)" styleId="plano_cb${planos.idPlano}" styleClass="semBorda checkbox" />
							        </td>
									<td>
