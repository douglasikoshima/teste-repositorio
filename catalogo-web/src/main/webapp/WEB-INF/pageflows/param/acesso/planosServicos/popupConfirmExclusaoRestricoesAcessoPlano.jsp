...
<catalogo:popupConfirmacao>
	...
	<html:text property="alturaPopup" styleId="alturaPopup" value="150px" styleClass="hide"/>
		<div>
			...
			<br clear="all" /><br clear="all" /><br clear="all" />
			<html:form action="/br/com/vivo/catalogoPRS/pageflows/param/acesso/excluirRestricoesAcessoPlano.do">
				<html:hidden property="idAcessoPlanoExcluirPlano" value="${idAcessoPlano}"/>				
