...
<html:form action="/br/com/vivo/catalogoPRS/pageflows/param/acesso/planosServicos/pesquisarNmComercialNoPopupServicoPerfil.do">
					...
					<tbody>					
						<c:if test="${not empty parametrizacaoAcessoForm.retornoServicoLista}">
							<logic:iterate id="servicos" property="retornoServicoLista" name="parametrizacaoAcessoForm" >												
								...
								<tr>
									<td class="center">
										<html:radio property="nmComercialSelecionados" value="${servicos.idServico}" onClick="selecionaRadioGroupPopup('hidden_nmComercial_servico_perfil', this)" styleId="plano_cb${servicos.idServico}" styleClass="semBorda checkbox" />
