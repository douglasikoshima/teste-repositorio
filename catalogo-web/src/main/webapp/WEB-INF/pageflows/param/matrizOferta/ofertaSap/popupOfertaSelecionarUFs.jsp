...
<html:form action="/br/com/vivo/catalogoPRS/pageflows/param/matrizOferta/ofertaSap/pesquisarListaUfs.do">
		<c:set var="nomeBox" scope="application"  value="UF:"/>
		<jsp:include page="/templates/box_pre.jsp"/>
			<table width="100%">
				<tr>
					<td valign="top" width="50%">
						<div style="height:280px" class="vertical-scroll">
							<form>
					...
					<td valign="top" width="50%">
						<div id="div_valores" class="fleft vertical-scroll" style="height:280px;width:100%;">
						  <logic:iterate id="ddds" property="listUF" name="ofertaSapForm">
		...
		<div class="botao">
			<html:button property="btOk" styleClass="btOk" onclick="fecharPopup('popup1');" value="OK" titleKey="catalogo.popupSelecionarUfs.OK"/>
		</div>
</html:form>
</catalogo:popupPadrao>
