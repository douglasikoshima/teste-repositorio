...
<netui-temp:template templatePage="/templates/popupPadrao.jsp">
	<netui-temp:section name="conteudo">
		<div id="popup_selecionar_carteira" style="width: 100%">
			<c:set var="nomeBox" scope="application"  value="Carteira"/>
					...
					<div style="padding: 10px 0px 0xp 10px; float: left; width: 100%; height: 280px; overflow-y: auto;">
						<form>
							<table class="tabConteudoGeral" width="100%">
								...
								<netui:checkBoxGroup dataSource="pageFlow.carteirasSelecionadas" optionsDataSource="${carteiras}" repeater="true">
								<tr onmouseover="$(this).className='mouseOver'" onmouseout="$(this).className='mouseOut'">
									<td width=10px">
										<netui:checkBoxOption onClick="selecionaCheckBoxPopup('hidden_lista_carteira', this)" tagId="carteiras_cb_${container.item.sgCarteira}" value="${container.item.sgCarteira}" styleClass="semBorda checkbox"/>
									</td>
									<td nowrap="nowrap">
										<label for="carteiras_cb_${container.item.sgCarteira}">${container.item.dsCarteira}</label>
									</td>
								</tr>
								</netui:checkBoxGroup>
							</table>
