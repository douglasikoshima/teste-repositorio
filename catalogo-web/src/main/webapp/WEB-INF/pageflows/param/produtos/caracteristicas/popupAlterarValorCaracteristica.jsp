...
<netui-temp:template templatePage="/templates/popupConfirmacao.jsp">
	...
	<netui-temp:section name="conteudo">
		...
		<input type="button" id="botao_sim" onclick="if(checkRequired($(this).form, 'div_erros_popup_confirmacao')){return false;};$('justificativa_alterar_valor_caracteristica').value=$F('justificativa_temp');fecharPopup('popup2');$('botao_alterar_valor_caracteristica').onclick();" class="btNavegacao74" value="Sim" title="${bundle.default['catalogo.popupAlterarValorCaracteristica.Sim']}"/>
		&nbsp;
		<input type="button" onclick="fecharPopup('popup2');setEditando();" class="btNavegacao74" value="Não" title="${bundle.default['catalogo.popupAlterarValorCaracteristica.Nao']}"/>
		</form>
		<br/><br/>
	</netui-temp:section>
