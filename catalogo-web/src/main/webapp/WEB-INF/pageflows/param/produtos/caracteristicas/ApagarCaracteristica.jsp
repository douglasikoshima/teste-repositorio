...
<netui-temp:template templatePage="/templates/popupConfirmacao.jsp">
	...
	<netui-temp:section name="conteudo">
				...
				<tr>
					...
					<td>
						<div class="box_middle_center">
							<div class="box_middle_center_conteudo scroll-popup-apagar">
		...
		Confirme a exclusão:
		<br clear="all"/>
		<netui:form action="apagarCaracteristica">
		<div style="width:70%;">
			<c:if test="${modelos_afetados != null}">
			...
			<netui:hidden dataSource="actionForm.idEntidade" dataInput="${id_caracteristica}"/>
		</div>
		<br clear="all"/>
		<input type="button" onclick="send(this, null , 'popup1', 'right_section', null, 'div_erros_popup_confirmacao');" class="btNavegacao74" value="Sim" title="${bundle.default['catalogo.ApagarCaracteristica.Sim']}"/>
		</netui:form>
		&nbsp;
		<input type="button" onclick="fecharPopup('popup1');" class="btNavegacao74" value="Não" title="${bundle.default['catalogo.ApagarCaracteristica.Nao']}"/>
		<br/><br/>
	</netui-temp:section>
