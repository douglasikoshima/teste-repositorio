		...
		<div class="conteudo_box_middle">
			<div class="conteudo_box_middle_mg">
				<div style="width: 100%; position:relative;">		
					<netui:form action="associarVariaveisModelo">
						<div style="width: 100%; position:relative;" id="lista_variaveis">	
												...
												<netui-data:repeaterItem>
													<c:set value="true" var="firstPass"/>
														<tr>
															...
															<td class="center">
																	${container.item.modelo}
																<%--
																<netui:anchor action="mostrarDetalhesModelo">
																</netui:anchor>
																--%>
															</td>
						...
						<div class="botao">
							...
							<span>&nbsp;</span>
							<netui:anchor action="listarModeloDisponivalParaAssociacao" onClick="if(checkSelecaoProdutos($('lista_variaveis').select('input.belongsToForm').collect(function(n){if(n.checked)return n; else return null;}))){return false;}abrirLink('lista_variaveis_disponivel', this.href, 'resultado_pesquisa');return false;">
								<input type="button" onclick="return false" class="btNavegacao74" value="Associar" title="${bundle.default['catalogo.resultadoPesquisarProdutos.BtListarModelo']}"/>
							</netui:anchor>							
						</div>
					</netui:form>
				</div>
...
<br/>
<div id="lista_variaveis_disponivel" style="position: relative;"></div>