...
<netui-temp:template templatePage="/templates/popupPadrao.jsp">
	<netui-temp:section name="conteudo">
		<div id="popup_selecionar_canal" style="width: 100%">
			<c:set var="nomeBox" scope="application"  value="Canal"/>
					...
					<div style="padding: 10px 0px 0xp 10px; float: left; width: 100%; height: 280px; overflow-y: auto;">
						<form>
							<table class="tabConteudoGeral" width="100%">
								...
								<netui:checkBoxGroup dataSource="pageFlow.canaisSelecionadas" optionsDataSource="${canais}" repeater="true">
								<tr onmouseover="$(this).className='mouseOver'" onmouseout="$(this).className='mouseOut'">
									<td width=10px">
										<netui:checkBoxOption onClick="selecionaCheckBoxPopup('hidden_lista_canal', this)" tagId="canais_cb_${container.item.idCanal}" value="${container.item.idCanal}" styleClass="semBorda checkbox"/>
									</td>
									<td nowrap="nowrap">
										<label for="canais_cb_${container.item.idCanal}">${container.item.nmCanal}</label>
									</td>
								</tr>
								</netui:checkBoxGroup>
							</table>
