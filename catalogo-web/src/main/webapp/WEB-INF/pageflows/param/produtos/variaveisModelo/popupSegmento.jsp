...
<netui-temp:template templatePage="/templates/popupPadrao.jsp">
	<netui-temp:section name="conteudo">
		<div id="popup_selecionar_segmento" style="width: 100%">
			<c:set var="nomeBox" scope="application"  value="Segmento"/>
					...
					<div style="padding: 10px 0px 0xp 10px; float: left; width: 100%; height: 280px; overflow-y: auto;">
						<form>
							<table class="tabConteudoGeral" width="100%">
								...
								<netui:checkBoxGroup dataSource="pageFlow.segmentosSelecionadas" optionsDataSource="${segmentos}" repeater="true">
								<tr onmouseover="$(this).className='mouseOver'" onmouseout="$(this).className='mouseOut'">
									<td width=10px">
										<netui:checkBoxOption onClick="selecionaCheckBoxPopup('hidden_lista_segmento', this)" tagId="segmentos_cb_${container.item.sgSegmento}" value="${container.item.sgSegmento}" styleClass="semBorda checkbox"/>
									</td>
									<td nowrap="nowrap">
										<label for="segmentos_cb_${container.item.sgSegmento}">${container.item.dsSegmento}</label>
									</td>
								</tr>
								</netui:checkBoxGroup>
							</table>
