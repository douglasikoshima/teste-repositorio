...
<netui-temp:template templatePage="/templates/popupPadrao.jsp">
	<netui-temp:section name="conteudo">
		<div id="popup_selecionar_ufs" style="width: 100%">
			<c:set var="nomeBox" scope="application"  value="UFs"/>
					...
					<div style="padding: 10px 0px 0xp 10px; float: left; width: 100%; height: 280px; overflow-y: auto;">
						<form>
							<table class="tabConteudoGeral" width="100%">
								...
								<netui:checkBoxGroup dataSource="pageFlow.ufsSelecionadas" optionsDataSource="${ufs}" repeater="true">
								<tr onmouseover="$(this).className='mouseOver'" onmouseout="$(this).className='mouseOut'">
									<td width=10px">
										<netui:checkBoxOption onClick="selecionaCheckBoxPopup('hidden_lista_uf', this)" tagId="ufs_cb_${container.item.idUf}" value="${container.item.idUf}" styleClass="semBorda checkbox"/>
									</td>
									<td nowrap="nowrap">
										<label for="ufs_cb_${container.item.idUf}">${container.item.nmUF}</label>
									</td>
								</tr>
								</netui:checkBoxGroup>
							</table>
