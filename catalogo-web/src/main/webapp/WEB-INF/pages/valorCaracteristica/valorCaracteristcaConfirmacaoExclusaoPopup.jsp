...
<catalogo:popupConfirmacao>	
		...
		<html:form action="/br/com/vivo/catalogoPRS/pageflows/param/caracteristica/remove.do" styleId="caracteristicaForm" onsubmit="false">
			...
			<input type="button" id="botao_sim" class="btNavegacao74" value="Sim" title="Sim" onclick="document.all('btExcluir${idValorCaracteristica}').click();fecharPopup('popup2');"/>
			&nbsp;
			<input type="button" onclick="fecharPopup('popup2');" class="btNavegacao74" value="Não" title="Não"/>
		</html:form>
		<br/><br/>	
</catalogo:popupConfirmacao>
