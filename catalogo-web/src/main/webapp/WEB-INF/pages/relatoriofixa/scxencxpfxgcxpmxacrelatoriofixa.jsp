...
<catalogo:blankTemplate titulo="Home Catalogo">
    	...
    	<script>
			...
			function exportar(obj) {
				...
				if (clazz == "btNavegacao74") {
					document.location.href ='/catalogo/br/com/vivo/catalogoPRS/pageflows/param/relatoriofixa/scxencxpfxgcxpmxac/exportar.do';
				}
			}
    ...
    <jsp:body>
        <html:form styleId="acaoForm" action="/br/com/vivo/catalogoPRS/pageflows/param/relatoriofixa/scxencxpfxgcxpmxac/search.do" >
	        	...
	        	<div class="line">
			        <catalogo:contentBox title="Pesquisa" doubt="false" requiredFields="false">
						...
						<div class="line">
							...
							<div class="linerow bold"><label for="cdEncargo">C&oacute;digo do Encargo:</label></div>
							<div class="linerow bold"><label for="dsEncargo">Nome do Encargo:</label></div>
							<div class="linerow bold"><label for="cdPlanoFinanciamento">C&oacute;digo do Plano de Financiamento:</label></div>
						</div>
						<div class="line">
							<div class="linerow bold"><html:text property="nmSolicitacaoComercial" styleId="nmSolicitacaoComercial" style="width: 150px"/></div>
							<div class="linerow bold"><html:text property="cdEncargo" styleId="cdEncargo" style="width: 150px"/></div>
							<div class="linerow bold"><html:text property="dsEncargo" styleId="dsEncargo" style="width: 150px"/></div>
							<div class="linerow bold"><html:text property="cdPlanoFinanciamento" styleId="cdPlanoFinanciamento" style="width: 150px"/></div>
						</div>
						<div class="line">
							<div class="linerow bold"><label for="nmPlanoFinanciamento">Nome do Plano de Financiamento:</label></div>
						...
						<div class="line">
							<div class="linerow bold"><html:text property="nmPlanoFinanciamento" styleId="nmPlanoFinanciamento" style="width: 150px"/></div>
					...
					<c:if test="${sCxENCxPFxGCxPMxACRelatorioFixaTOList != null}">
						<div = id="resultado_pesquisa">
							<catalogo:contentBox  title="Resultado da Pesquisa" doubt="false" requiredFields="false">
								<display:table name="sCxENCxPFxGCxPMxACRelatorioFixaTOList" id="sCxENCxPFxGCxPMxACRelatorioFixaTO" pagesize= "15" cellspacing="0" cellpadding="0" style="width: 99%;" requestURI = "ordenar.do" class="tabela-padrao-new tablesorter table_body" >
									...
									<display:column property="cdEncargo" title="C&oacute;digo do Encargo" sortable="true" headerClass="sortable" />
									<display:column property="cdPlanoFinanciamento" title="C&oacute;digo do Plano de Financiamento" sortable="true" headerClass="sortable" />
								...
								<div class="barra"></div>
								<div class="botao">
								    <cata:temPermissao acao="exportarRelatoriosSCxENCxPFxGCxPMxAC">
