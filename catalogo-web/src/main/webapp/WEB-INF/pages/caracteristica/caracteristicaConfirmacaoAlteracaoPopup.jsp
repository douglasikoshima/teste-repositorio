...
<catalogo:popupConfirmacao>		
		...
		<br clear="all"/>
		<br clear="all"/>
		<html:form action="/br/com/vivo/catalogoPRS/pageflows/param/caracteristica/save.do" styleId="caracteristicaForm" onsubmit="false">
			<html:hidden property="idCaracteristica" styleId="idCaracteristica"/>
		<input type="button" id="botao_sim" onclick="parent.save()" class="btNavegacao74" value="Sim" title="Sim"/>
		&nbsp;
		<input type="button" onclick="fecharPopup('popup1');" class="btNavegacao74" value="Não" title="Não"/>
		</html:form>
		<br/><br/>	
</catalogo:popupConfirmacao>
