...
<catalogo:defaultTemplate titulo="Home Catalogo">
    ...
    <jsp:body>
		...
		<html:form action="/br/com/vivo/catalogoPRS/pageflows/param/gerenciadorregras/filtro1/pesquisar.do" styleId="actionForm" onsubmit="false">
			...
			<div id="caixa">
				<span id="abas">
					<a href="#abaFiltro1" class="selected">Filtro I</a>
					<a id="abaFiltro2" href="javascript:abrirAba('abaFiltro1','abaFiltro2')" >Filtro II</a>
					<a id="abaDocumentos" href="javascript:abrirAba('abaFiltro1','abaDocumentos')" >Documentos</a>
				</span>
				<ul id="conteudos">
					<!-- Aba FILTRO I #aba1 !-->
						...
						<div id="regraFiltroI">
							<div class="box">
								...
								<div class="linerow clear">
	                                <html:select property="idCanalAtendimento" styleId="idCanalAtendimento" onChange="pesquisarIndicadores('abaFiltro1')" styleClass="required" style="width:140px;">
							...
							<div class="scroll-pane">
								...
								<cata:temPermissao acao="gravarGerenciadorRegras">
									<div class="barra"></div>
										<div class="botao">
											<html:button property="botao_gravar_form" styleId="botao_gravar_form" onClick="salvarIndicadores('abaFiltro1')" styleClass="btNavegacao74" value="Gravar" alt="Gravar" title=""/><span>&nbsp;</span>
										</div>
									</div>
								</cata:temPermissao>
							</div>
