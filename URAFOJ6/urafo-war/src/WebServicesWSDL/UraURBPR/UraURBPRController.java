package WebServicesWSDL.UraURBPR;
...
public class UraURBPRController extends AbstractAction {

    private static final long serialVersionUID = -3962080971916868837L;
    
    private transient WebServicesWSDL.commons.utils.geral.Log logURA = new WebServicesWSDL.commons.utils.geral.Log("UraURBPRController");
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        } else if ("URBPR".equals(mapping.getParameter())) {
            return URBPR(mapping, form, request, response);
        }
    ...
    public ActionForward URBPR(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {

        // <msg><msgHdr><user>URA</user><service>URBPR</service><uuid>99999</uuid><subSystem>07</subSystem><creationTimestamp>0000-00-00 00:00:00 000</creationTimestamp><sequence>99999</sequence><corrid>99999</corrid><timeout>0</timeout></msgHdr><msgBody><cdDDD>11</cdDDD><numTelefone>99765215</numTelefone></msgBody></msg>
