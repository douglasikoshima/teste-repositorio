package WebServicesWSDL.UraURGPR;
...
public class UraURGPRController extends AbstractAction {

    private static final long serialVersionUID = -5098087717449831861L;

    private transient WebServicesWSDL.commons.utils.geral.Log logURA = new WebServicesWSDL.commons.utils.geral.Log("UraURGPRController");
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        } else if ("URGPR".equals(mapping.getParameter())) {
            return URGPR(mapping, form, request, response);
        }
    ...
    public ActionForward URGPR(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {

        // <msg><msgHdr><user>URA</user><service>URGPR</service><uuid>99999</uuid><subSystem>07</subSystem><creationTimestamp>0000-00-00 00:00:00 000</creationTimestamp><sequence>99999</sequence><corrid>99999</corrid><timeout>0</timeout></msgHdr><msgBody><cdDDD>11</cdDDD><numTelefone>99765215</numTelefone></msgBody></msg>
