...
import WebServicesWSDL.commons.utils.exceptions.ServiceLocatorException;

@SuppressWarnings({"unused","rawtypes","unchecked"})
public class ServiceLocator implements Serializable {

	private static final long serialVersionUID = -6878811426002672415L;
	private String TUXEDO_SERVICE_URL="t3://172.17.79.241:7001";
	private String TUXEDO_CONTEXT_FACTORY="weblogic.jndi.WLInitialContextFactory";
    ...
    private ServiceLocator()  throws ServiceLocatorException  {
        try {
            ...
            //_prop.put (Context.INITIAL_CONTEXT_FACTORY,TUXEDO_CONTEXT_FACTORY);
            //_prop.put (Context.PROVIDER_URL, TUXEDO_SERVICE_URL);

            //ic = new InitialContext(_prop);
