...
@Entity
@Table(name = "VW_FIXA_CLASSELINHA", schema = "CATALOGOPRS_OW")
public class VwFixaClasseLinha implements Serializable {

    private static final long serialVersionUID = -1803452260579012317L;
