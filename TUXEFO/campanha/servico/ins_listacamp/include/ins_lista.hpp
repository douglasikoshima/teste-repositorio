//
// $Id: ins_lista.hpp,v 1.1.2.1 2010/01/13 22:57:17 a5110702 Exp $
//
#ifndef _INS_LISTA_HPP_
#define _INS_LISTA_HPP_
...
extern int ins_lista(char*, char*,int*,int,char*,char*);
