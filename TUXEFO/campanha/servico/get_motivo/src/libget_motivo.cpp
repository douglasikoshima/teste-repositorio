//
// $Id: libget_motivo.cpp,v 1.1 2009/07/31 15:35:02 a5110702 Exp $
//

#include "../../negocio/cmputil/include/campanha.hpp"

DECLARE_TUXEDO_SERVICE(GETMOTIVO);

extern int get_motivo(char * usuario,DOMNode*dnode,XMLGen*xml);
int codErroBase = COD_BASE_CAMPANHA;

void implGETMOTIVO::Execute(DOMNode*dnode,XMLGen*xml_g)
{
  char parm[255];
  char *ptUsr;

  ULOG_START("GETMOTIVO");
