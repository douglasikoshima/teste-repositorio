//
// $Id: libget_grupo.cpp,v 1.1 2009/07/31 15:33:18 a5110702 Exp $
//

#include "../../negocio/cmputil/include/campanha.hpp"

DECLARE_TUXEDO_SERVICE(GETGRUPO);

extern int get_listagrupo(char * usuario,DOMNode*dnode,XMLGen*xml);
int codErroBase = COD_BASE_CAMPANHA;

void implGETGRUPO::Execute(DOMNode*dnode,XMLGen*xml_g)
{
  char parm[255];
    char * ptUsr;
  ...
  xml_g->createTag("tns:GrupoCampanhaApoioVO");
	...
	xml_g->createTag("tns:SubGrupoApoioVO");
		get_listagrupo(ptUsr,dnode,xml_g);
	xml_g->closeTag();
  xml_g->closeTag();
