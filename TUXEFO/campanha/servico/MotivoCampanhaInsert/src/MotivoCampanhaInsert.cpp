...
DECLARE_TUXEDO_SERVICE(INSMOTIVOCMP);
void implINSMOTIVOCMP::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	...
	if( oMotivoCampanha.Insert( cidSubCampanhaHistorico, 
	...
	{
		setStatusCode("00E0000","Falha na insercao de MotivoCampanha");
	}
