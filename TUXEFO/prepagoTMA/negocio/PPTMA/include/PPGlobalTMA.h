...
#define LEN_NUMBER_ORA                  38
#define LEN_DATE_ORA                    14    // YYYYMMDDHHMMSS
#define LEN_HEADER                      LEN_NUMBER_ORA
#define LEN_DSTIPOOPERACAO              25
#define QTD_ARRAY_PESSOA_DE_PARA        2
#define LEN_TPOPERACAO                  20
#define LEN_INENDPRINCIPAL              1
#define LEN_NMPAIS                      255
#define LEN_IDFILAPREENVIOSETCLIINFO    LEN_NUMBER_ORA
...
#define ID_TIPO_COMUNICACAO_EMAIL_COME  "12"
...
#define LEN_IDCLASSIFICACAOTPLINHA      20
 ...
 *******************************************************************************/
#define LEN_IDTIPOENDERECOCOBRANCA     LEN_NUMBER_ORA
#define LEN_SGTIPOENDERECOCOBRANCA     355
#define LEN_SGCLASSIFICACAO            255
...
/*******************************************************************************
 * Estrutura referente ao processamento do SETPPTMA
 *******************************************************************************/
typedef struct {
    ...
    char szDsTipoOperacao[LEN_DSTIPOOPERACAO + LEN_EOS];
...
/*******************************************************************************
 * Tabela de pré-processamento de mudanças de endereço principal
 *******************************************************************************/
typedef struct {
    char idFilaPreEnvioSetCliInfo[LEN_IDPESSOAENDERECO + LEN_EOS];
    char idPessoaEndereco[LEN_IDPESSOAENDERECO + LEN_EOS];
    char idAreaRegistro[LEN_IDAREAREGISTRO + LEN_EOS];
    char nrLinha[LEN_NRLINHA + LEN_EOS];
    char dtUltimaAlteracao[LEN_DTULTIMAALTERACAO + LEN_EOS];
    char idUsuarioAlteracao[LEN_IDUSUARIOALTERACAO + LEN_EOS];
} TFilaPreEnvioSetCliInfo;
...
{\
    ...
    {\
        ...
        {\
            ...
            throw PPExceptionTMA(ERRO_PARAMETRO_NULL, szMessage); \
        }\
