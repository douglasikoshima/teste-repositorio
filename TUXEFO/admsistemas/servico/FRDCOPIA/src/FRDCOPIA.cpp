...
DECLARE_TUXEDO_SERVICE(FRDCOPIA);
 ...
 *
 *************************************************************************/
void implFRDCOPIA::Execute(DOMNode*dnode,XMLGen*xml_g)
{
   ULOG_START("implFRDCOPIA::Execute()");
