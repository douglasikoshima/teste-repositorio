...
CPessoaDocumento::CPessoaDocumento(void)
{
	...
	memset(&tPessoaDocumentoB01a, 0x00, sizeof(TPessoaDocumentoB01));
	memset(&tPessoaDocumentoB01b, 0x00, sizeof(TPessoaDocumentoB01));
}
...
bool CPessoaDocumento::buscaPessoaDocumentoB01(char *pszIdPessoa)
{
	return(clPessoaDocumentopc.proCBuscaPessoaDocumentoB01(&tPessoaDocumentoB01,
		&tPessoaDocumentoB01a,
		&tPessoaDocumentoB01b,
		pszIdPessoa));
}
...
{
    clPessoaDocumentopc.proCApagaPessoaDocumento(tPessoaDocumentoB01);
}
...
void CPessoaDocumento::setSqSincronismo(int iSqSincronismo)
{
    sprintf(tPessoaDocumento.szSqSincronismo, "%d", iSqSincronismo);
}
...
void CPessoaDocumento::setData(TPessoaJuridicaXML xmj)
{
    this->setIdSistemaOrigem( "7" ); 
}

void CPessoaDocumento::setData(TPessoaFisicaXML xmj)
{
    this->setIdSistemaOrigem( "7" ); 
}
