...
public:
    ...
    TPessoaDocumentoB01 tPessoaDocumentoB01a;
    TPessoaDocumentoB01 tPessoaDocumentoB01b;
    ...
    bool	buscaPessoaDocumentoB01(char *);
    ...
    void    setSqSincronismo(int iSqSincronismo);
