...
bool CTipoDocumento::buscaTipoDocumentoInscricao(void) {
    return clTipoDocumentopc.proCBuscaTipoDocumentoInscricao(&tTipoDocumento);
}
...
void CTipoDocumento::clearStruct(void) {
    memset(&tTipoDocumento, 0x00, sizeof(TTipoDocumento));
}
