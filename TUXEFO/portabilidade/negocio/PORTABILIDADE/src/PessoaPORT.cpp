...
char *CPessoa::getNmNome(void) {
    static char szAUX[LEN_NMNOME + LEN_EOS];

    strcpy(szAUX, tPessoa.szNmNome);
    return szAUX;
}

char *CPessoa::getNmNomeMeio(void) {
    static char szAUX[LEN_NMNOMEMEIO + LEN_EOS];

    strcpy(szAUX, tPessoa.szNmNomeMeio);
    return szAUX;
}

char *CPessoa::getNmSobreNome(void) {
    static char szAUX[LEN_NMSOBRENOME + LEN_EOS];

    strcpy(szAUX, tPessoa.szNmSobreNome);
    return szAUX;
}
