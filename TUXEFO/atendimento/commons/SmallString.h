 ...
 * @CVS     $Author: a5114878 $ - $Date: 2011/07/12 20:36:26 $
 **/
...
struct SmallString
{
    ...
    int Size() { return this->tamUsado; }
    int size() { return this->tamUsado; }
    void Clean() { delete this->valor; this->valor=0; this->tamUsado=this->tamAlocado=0; }
    void clean() { delete this->valor; this->valor=0; this->tamUsado=this->tamAlocado=0; }
    ...
    SmallString& operator=(const char *x)
    {
        ...
        this->tamUsado = strlen(this->valor);
