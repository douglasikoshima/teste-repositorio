...
DECLARE_TUXEDO_SERVICE(ATDALTERPROT);

void implATDALTERPROT::Execute(DOMNode*dnode,XMLGen*xml_g)
{
    ULOG_START("implATDALTERPROT::Execute()");
    ...
    cWfAtdAlterProt cwfatdabreprot(dnode,xml_g);
    ...
    xml_g->createTag("AlterProtocoloOutTO");
    ...
    ULOG_END("implATDALTERPROT::Execute()");
}
