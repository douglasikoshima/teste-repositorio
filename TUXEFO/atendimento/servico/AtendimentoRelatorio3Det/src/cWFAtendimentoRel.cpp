...
extern bool proCExecutarRelatorio3Det( st_AtendimentoRel *dados
                                     , st_vlAtendimentoRel *status
                                     , XMLGen *saida
                                     , DOMNode *dnode );

cWFAtdRel3Det::cWFAtdRel3Det(DOMNode *dnode, XMLGen *xml_g)
{
    entrada = dnode;
    saida = xml_g;
...
bool cWFAtdRel3Det::Executar()
{
    return proCExecutarRelatorio3Det( &m_stDados
                                    , &m_vlDados
                                    , saida
                                    , entrada );
}

void cWFAtdRel3Det::carregaDados()
{
    char *p;
