...
extern bool proCExecutarRelatorio2( st_AtendimentoRel *dados
                                  , st_vlAtendimentoRel *status
                                  , XMLGen *saida
                                  , DOMNode *dnode );

cWFAtdRel2::cWFAtdRel2(DOMNode *dnode, XMLGen *xml_g)
{
    entrada = dnode;
    saida = xml_g;
...
bool cWFAtdRel2::Executar()
{
    return proCExecutarRelatorio2( &m_stDados
                                 , &m_vlDados
                                 , saida
                                 , entrada );
}

void cWFAtdRel2::carregaDados()
{
    char *p;
