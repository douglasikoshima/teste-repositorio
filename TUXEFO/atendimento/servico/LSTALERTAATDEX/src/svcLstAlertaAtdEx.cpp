...
DECLARE_TUXEDO_SERVICE( LSTALERTAATDEX )

void implLSTALERTAATDEX::Execute(DOMNode*dnode,XMLGen*xml_g)
{
    ULOG_START("implLSTALERTAATDEX::Execute()");
	...
	atd.consultarAlertaEx(&idAtendimento, isSimplificado, xml_g);

	xml_g->closeTag();

	setStatusCode("04I0000","Consulta Concluída.");

    ULOG_END("implLSTALERTAATDEX::Execute()");
}
