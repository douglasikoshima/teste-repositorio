...
DECLARE_TUXEDO_SERVICE(ATDDETACAO);

void implATDDETACAO::Execute(DOMNode*dnode,XMLGen*xml_g) 
{
    ULOG_START("implATDDETACAO::Execute()"); 
    ...
    ULOG_END("implATDDETACAO::Execute()"); 
}
