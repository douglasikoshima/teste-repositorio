...
DECLARE_TUXEDO_SERVICE(CONSULTACONTA);

void implCONSULTACONTA::Execute( DOMNode * dnode,XMLGen * xml_g ) 
{
    ULOG_START("implCONSULTACONTA::Execute()");
    ...
    ULOG_END("implCONSULTACONTA::Execute()");
}
