...
extern bool proCExecutarRelatorio6E( st_AtendimentoRel *dados
                                   , st_vlAtendimentoRel *status
                                   , XMLGen *saida
                                   , DOMNode *dnode );

cWFAtdRel6E::cWFAtdRel6E(DOMNode *dnode, XMLGen *xml_g)
{
    entrada = dnode;
    saida = xml_g;
...
bool cWFAtdRel6E::Executar()
{
    return proCExecutarRelatorio6E( &m_stDados
                                  , &m_vlDados
                                  , saida
                                  , entrada );
}

void cWFAtdRel6E::carregaDados()
{
    char *p;
