 ...
 * @CVS     $Author: a5110702 $ - $Date: 2009/07/31 15:35:01 $
 **/

#include "../include/cWFAtdDetDSarv.h"
#include "../../../commons/msgPadrao.h"

DECLARE_TUXEDO_SERVICE(ATDDETDSARV);

void implATDDETDSARV::Execute(DOMNode*dnode,XMLGen*xml_g) 
{
    ULOG_START("implATDDETDSARV::Execute()");

    char *msgErro = 0;
    char *codErro = 0;
    char *usuario;

    cWFAtdDetDSarv ob(dnode,xml_g);
    ...
    ULOG_END("implATDDETDSARV::Execute()");
}
