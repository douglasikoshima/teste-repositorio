...
extern bool proCExecutarRelatorio6BDet( st_AtendimentoRel *dados
                                      , st_vlAtendimentoRel *status
                                      , XMLGen *saida
                                      , DOMNode *dnode );

cWFAtdRel6BDet::cWFAtdRel6BDet(DOMNode *dnode, XMLGen *xml_g)
{
    entrada = dnode;
    saida = xml_g;
...
bool cWFAtdRel6BDet::Executar()
{
    return proCExecutarRelatorio6BDet( &m_stDados
                                     , &m_vlDados
                                     , saida
                                     , entrada );
}

void cWFAtdRel6BDet::carregaDados()
{
    char *p;
