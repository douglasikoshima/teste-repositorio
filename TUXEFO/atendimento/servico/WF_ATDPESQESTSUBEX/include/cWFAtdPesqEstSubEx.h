...
#ifndef __CWFATDPESQESTSUBEX_H__
#define __CWFATDPESQESTSUBEX_H__

#include <tuxfw.h>
#include "../../../commons/SmallString.h"

#include "stWFAtdPesqEstSubEx.h"

class cWFAtdPesqEstSubEx : public TuxBasicSvc
{
    public:
        cWFAtdPesqEstSubEx() { entrada=0; saida=0; }
        cWFAtdPesqEstSubEx(DOMNode* entrada,XMLGen* saida);
        ~cWFAtdPesqEstSubEx() {}
