...
extern bool proCExecutarRelatorio4( st_AtendimentoRel *dados
                                  , st_vlAtendimentoRel *status
                                  , XMLGen *saida
                                  , DOMNode *dnode );

cWFAtdRel4::cWFAtdRel4(DOMNode *dnode, XMLGen *xml_g)
{
    entrada = dnode;
    saida = xml_g;
...
bool cWFAtdRel4::Executar()
{
    return proCExecutarRelatorio4( &m_stDados
                                 , &m_vlDados
                                 , saida
                                 , entrada );
}

void cWFAtdRel4::carregaDados()
{
    char *p;
