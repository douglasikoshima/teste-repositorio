...
extern bool proCExecutarRelatorio6CDet( st_AtendimentoRel *dados
                                      , st_vlAtendimentoRel *status
                                      , XMLGen *saida
                                      , DOMNode *dnode );

cWFAtdRel6CDet::cWFAtdRel6CDet(DOMNode *dnode, XMLGen *xml_g)
{
    entrada = dnode;
    saida = xml_g;
...
bool cWFAtdRel6CDet::Executar()
{
    return proCExecutarRelatorio6CDet( &m_stDados
                                     , &m_vlDados
                                     , saida
                                     , entrada );
}

void cWFAtdRel6CDet::carregaDados()
{
    char *p;
