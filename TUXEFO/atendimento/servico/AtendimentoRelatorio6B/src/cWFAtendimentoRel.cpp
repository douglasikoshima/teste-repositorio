...
extern bool proCExecutarRelatorio6B( st_AtendimentoRel *dados
                                   , st_vlAtendimentoRel *status
                                   , XMLGen *saida
                                   , DOMNode *dnode );

cWFAtdRel6B::cWFAtdRel6B(DOMNode *dnode, XMLGen *xml_g)
{
    entrada = dnode;
    saida = xml_g;
...
bool cWFAtdRel6B::Executar()
{
    return proCExecutarRelatorio6B( &m_stDados
                                  , &m_vlDados
                                  , saida
                                  , entrada );
}

void cWFAtdRel6B::carregaDados()
{
    char *p;
