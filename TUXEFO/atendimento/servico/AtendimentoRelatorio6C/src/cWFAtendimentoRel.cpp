...
extern bool proCExecutarRelatorio6C( st_AtendimentoRel *dados
                                   , st_vlAtendimentoRel *status
                                   , XMLGen *saida
                                   , DOMNode *dnode );

cWFAtdRel6C::cWFAtdRel6C(DOMNode *dnode, XMLGen *xml_g)
{
    entrada = dnode;
    saida = xml_g;
...
bool cWFAtdRel6C::Executar()
{
    return proCExecutarRelatorio6C( &m_stDados
                                  , &m_vlDados
                                  , saida
                                  , entrada );
}

void cWFAtdRel6C::carregaDados()
{
    char *p;
