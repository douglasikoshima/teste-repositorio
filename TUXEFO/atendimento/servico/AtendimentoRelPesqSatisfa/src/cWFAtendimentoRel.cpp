...
extern bool proCExecutarRelatorioPSS( st_AtendimentoRel *dados
...
bool cWFAtdRelPSS::Executar()
{
    return proCExecutarRelatorioPSS( &m_stDados
                                   , &m_vlDados
                                   , saida
                                   , entrada );
}

void cWFAtdRelPSS::carregaDados()
{
    char *p;
