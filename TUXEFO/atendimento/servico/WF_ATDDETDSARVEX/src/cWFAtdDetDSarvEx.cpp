...
cWFAtdDetDSarvEx::cWFAtdDetDSarvEx(DOMNode *dnode, XMLGen *xml_g)
{
    entrada = dnode;
    saida = xml_g;
...
bool cWFAtdDetDSarvEx::executar(char **codErro,char **msgErro)
{
    bool retorno;
    int idContato;
...
bool cWFAtdDetDSarvEx::ConsultarAtendimento(int &idContato)
{
    ULOG_START("cWFAtdDetDSarvEx::ConsultarAtendimento()");
    ...
    ULOG_END("cWFAtdDetDSarvEx::ConsultarAtendimento()");

    return retorno;
}

void cWFAtdDetDSarvEx::carregaDados()
{
    ULOG_START("cWFAtdDetDSarvEx::carregaDados()");
    ...
    ULOG_END("cWFAtdDetDSarvEx::carregaDados()");
}
