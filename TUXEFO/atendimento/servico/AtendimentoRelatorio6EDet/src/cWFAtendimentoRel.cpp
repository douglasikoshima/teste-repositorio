...
extern bool proCExecutarRelatorio6EDet( st_AtendimentoRel *dados
                                      , st_vlAtendimentoRel *status
                                      , XMLGen *saida
                                      , DOMNode *dnode );

cWFAtdRel6EDet::cWFAtdRel6EDet(DOMNode *dnode, XMLGen *xml_g)
{
    entrada = dnode;
    saida = xml_g;
...
bool cWFAtdRel6EDet::Executar()
{
    return proCExecutarRelatorio6EDet( &m_stDados
                                     , &m_vlDados
                                     , saida
                                     , entrada );
}

void cWFAtdRel6EDet::carregaDados()
{
    char *p;
