...
extern bool proCExecutarRelatorio6A( st_AtendimentoRel *dados
                                   , st_vlAtendimentoRel *status
                                   , XMLGen *saida
                                   , DOMNode *dnode );

cWFAtdRel6A::cWFAtdRel6A(DOMNode *dnode, XMLGen *xml_g)
{
    entrada = dnode;
    saida = xml_g;
...
bool cWFAtdRel6A::Executar()
{
    return proCExecutarRelatorio6A( &m_stDados
                                  , &m_vlDados
                                  , saida
                                  , entrada );
}

void cWFAtdRel6A::carregaDados()
{
    char *p;
