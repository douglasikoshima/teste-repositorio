 ...
 * @CVS     $Author: a5110702 $ - $Date: 2009/07/31 15:33:25 $
 **/
...
DECLARE_TUXEDO_SERVICE(ATDDETATEND);

void implATDDETATEND::Execute(DOMNode*dnode,XMLGen*xml_g) 
{
