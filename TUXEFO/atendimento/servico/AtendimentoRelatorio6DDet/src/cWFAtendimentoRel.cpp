...
extern bool proCExecutarRelatorio6DDet( st_AtendimentoRel *dados
                                      , st_vlAtendimentoRel *status
                                      , XMLGen *saida
                                      , DOMNode *dnode );

cWFAtdRel6DDet::cWFAtdRel6DDet(DOMNode *dnode, XMLGen *xml_g)
{
    entrada = dnode;
    saida = xml_g;
...
bool cWFAtdRel6DDet::Executar()
{
    return proCExecutarRelatorio6DDet( &m_stDados
                                     , &m_vlDados
                                     , saida
                                     , entrada );
}

void cWFAtdRel6DDet::carregaDados()
{
    char *p;
