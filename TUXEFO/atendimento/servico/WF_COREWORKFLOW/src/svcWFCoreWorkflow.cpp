...
DECLARE_TUXEDO_SERVICE(COREWORKFLOW);

void implCOREWORKFLOW::Execute(DOMNode*dnode,XMLGen*xml_g) 
{
    ULOG_START("implCOREWORKFLOW::Execute()");
    ...
    try
    {
        ...
        cWFCoreWorkflow ob(dnode,xml_g);
    ...
    ULOG_END("implCOREWORKFLOW::Execute()");
}
