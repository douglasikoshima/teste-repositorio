...
cWFAtdDetPessoa::cWFAtdDetPessoa(DOMNode *dnode, XMLGen *xml_g)
{
    entrada = dnode;
    saida = xml_g;
...
bool cWFAtdDetPessoa::executar(char **codErro,char **msgErro)
{
...
void cWFAtdDetPessoa::ObterAtendPessoa()
{
    ULOG_START("cWFAtdDetPessoa::ObterAtendPessoa()");
    ...
    ULOG_END("cWFAtdDetPessoa::ObterAtendPessoa()");
}

void cWFAtdDetPessoa::ObterEnderecoPessoa(long idPessoa,SmallString &xmlPessoaEndereco)
{
    ULOG_START("cWFAtdDetPessoa::ObterEnderecoPessoa()");
    ...
    ULOG_END("cWFAtdDetPessoa::ObterEnderecoPessoa()");
}

void cWFAtdDetPessoa::MontarXMLPessoaSaida(SmallString &xmlPessoa,SmallString &xmlPessoaEndereco)
{
    ULOG_START("cWFAtdDetPessoa::MontarXMLPessoaSaida()");
    ...
    ULOG_END("cWFAtdDetPessoa::MontarXMLPessoaSaida()");
}

void cWFAtdDetPessoa::carregaDados()
{
    ULOG_START("cWFAtdDetPessoa::carregaDados()");
    ...
    ULOG_END("cWFAtdDetPessoa::carregaDados()");
}
