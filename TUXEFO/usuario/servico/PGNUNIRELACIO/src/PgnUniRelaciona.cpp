...
DECLARE_TUXEDO_SERVICE(PGNUNIRELACIO);
 ...
 *
 *************************************************************************/
void implPGNUNIRELACIO::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implPGNUNIRELACIO::Execute()");
	...
	ULOG_END("implPGNUNIRELACIO::Execute()");
	return;
}
