...
DECLARE_TUXEDO_SERVICE(IMNPGNRELACIO);
 ...
 *
 *************************************************************************/
void implIMNPGNRELACIO::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implIMNPGNRELACIO::Execute()");
	...
	ULOG_END("implIMNPGNRELACIO::Execute()");
	return;
}
