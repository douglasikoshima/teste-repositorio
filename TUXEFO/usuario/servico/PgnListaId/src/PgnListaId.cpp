...
DECLARE_TUXEDO_SERVICE(PgnListaId);

/**************************************************************************
 *  Funcao de Negocios:  PgnListaId
 *
 ...
 *
 *************************************************************************/
void implPgnListaId::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implPgnListaId::Execute()");
	/* Chamada de Funcao de Negocios */
	CPgn oPgn;
	switch (oPgn.PgnListaId(dnode,xml_g)) {
	...
	ULOG_END("implPgnListaId::Execute()");
	return;
}
