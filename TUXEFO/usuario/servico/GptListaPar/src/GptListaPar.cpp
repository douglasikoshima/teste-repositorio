...
DECLARE_TUXEDO_SERVICE(GptListaPar);

/**************************************************************************
 *  Funcao de Negocios:  GptListaPar
 *
 ...
 *
 *************************************************************************/
void implGptListaPar::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implGptListaPar::Execute()");
	/* Chamada de Funcao de Negocios */
	CGpt oGpt;
	switch (oGpt.GptListaPar(dnode,xml_g)) {
	...
	ULOG_END("implGptListaPar::Execute()");
	return;
}
