...
DECLARE_TUXEDO_SERVICE(USRIMNRELACIO);
 ...
 *
 *************************************************************************/
void implUSRIMNRELACIO::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implUSRIMNRELACIO::Execute()");
	...
	switch (oUsr.UsrImnRelaciona(dnode,xml_g, getUser())) {
		...
		case 4: setStatusCode("08E0400","idSubSistema esta nulo"); break;
		default: setStatusCode("08E9999","Erro nao classificado."); break;
	}
	ULOG_END("implUSRIMNRELACIO::Execute()");
	return;
}
