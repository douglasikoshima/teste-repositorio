...
DECLARE_TUXEDO_SERVICE(SisListaPar);

/**************************************************************************
 *  Funcao de Negocios:  SisListaPar
 *
 ...
 *
 *************************************************************************/
void implSisListaPar::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implSisListaPar::Execute()");
	/* Chamada de Funcao de Negocios */
	CSis oSis;
	switch (oSis.SisListaPar(dnode,xml_g)) {
	...
	ULOG_END("implSisListaPar::Execute()");
	return;
}
