...
DECLARE_TUXEDO_SERVICE(SrvListaId);

/**************************************************************************
 *  Funcao de Negocios:  SrvListaId
 *
 ...
 *
 *************************************************************************/
void implSrvListaId::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implSrvListaId::Execute()");
	/* Chamada de Funcao de Negocios */
	CSrv oSrv;
	switch (oSrv.SrvListaId(dnode,xml_g)) {
	...
	ULOG_END("implSrvListaId::Execute()");
	return;
}
