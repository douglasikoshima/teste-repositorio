...
DECLARE_TUXEDO_SERVICE(UsrInserir);

/**************************************************************************
 *  Funcao de Negocios:  UsrInserir
 *
 ...
 *
 *************************************************************************/
void implUsrInserir::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implUsrInserir::Execute()");
