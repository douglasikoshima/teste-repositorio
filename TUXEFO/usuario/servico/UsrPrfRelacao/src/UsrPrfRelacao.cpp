/*****************************************************************************
 *
 * Modulo:    UsrPrfRelacao
 * Arquivo:   UsrPrfRelacao.cpp
...
DECLARE_TUXEDO_SERVICE(UsrPrfRelacao);

/**************************************************************************
 *  Funcao de Negocios:  UsrPrfRelacao
 *
 ...
 *
 *************************************************************************/
void implUsrPrfRelacao::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implUsrPrfRelacao::Execute()");
	
	/* Chamada de Funcao de Negocios */
	CUsr oUsr;
	switch (oUsr.UsrPrfRelacao(dnode,xml_g)) {
	...
	ULOG_END("implUsrPrfRelacao::Execute()");
	return;
}
