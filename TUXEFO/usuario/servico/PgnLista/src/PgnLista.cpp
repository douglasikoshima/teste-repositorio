...
DECLARE_TUXEDO_SERVICE(PgnLista);
 ...
 *
 *************************************************************************/
void implPgnLista::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implPgnLista::Execute()");
	/* Chamada de Funcao de Negocios */
	CPgn oPgn;
	switch (oPgn.PgnLista(dnode,xml_g)) {
