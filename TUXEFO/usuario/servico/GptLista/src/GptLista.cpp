...
DECLARE_TUXEDO_SERVICE(GptLista);

/**************************************************************************
 *  Funcao de Negocios:  GptLista
 *
 ...
 *
 *************************************************************************/
void implGptLista::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implGptLista::Execute()");
	/* Chamada de Funcao de Negocios */
	CGpt oGpt;
	switch (oGpt.GptLista(dnode,xml_g)) {
