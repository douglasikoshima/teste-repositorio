...
DECLARE_TUXEDO_SERVICE(SisListaId);

/**************************************************************************
 *  Funcao de Negocios:  SisListaId
 *
 ...
 *
 *************************************************************************/
void implSisListaId::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implSisListaId::Execute()");
	/* Chamada de Funcao de Negocios */
	CSis oSis;
	switch (oSis.SisListaId(dnode,xml_g)) {
	...
	ULOG_END("implSisListaId::Execute()");
	return;
}
