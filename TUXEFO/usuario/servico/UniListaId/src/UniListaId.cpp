...
DECLARE_TUXEDO_SERVICE(UniListaId);

/**************************************************************************
 *  Funcao de Negocios:  UniListaId
 *
 ...
 *
 *************************************************************************/
void implUniListaId::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implUniListaId::Execute()");
	...
	ULOG_END("implUniListaId::Execute()");
	return;
}
