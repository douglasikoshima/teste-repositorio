/*****************************************************************************
 *
 * Modulo:    GrpPrfRelacao
 * Arquivo:   GrpPrfRelacao.cpp
...
DECLARE_TUXEDO_SERVICE(GrpPrfRelacao);

/**************************************************************************
 *  Funcao de Negocios:  GrpPrfRelacao
 *
 ...
 *
 *************************************************************************/
void implGrpPrfRelacao::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implGrpPrfRelacao::Execute()");
	/* Chamada de Funcao de Negocios */
	CGrp oGrp;
	switch (oGrp.GrpPrfRelacao(dnode,xml_g)) {
	...
	ULOG_END("implGrpPrfRelacao::Execute()");
	return;
}
