/*****************************************************************************
 *
 * Modulo:    SisSrvRelaciona
 * Arquivo:   SisSrvRelaciona.cpp
...
DECLARE_TUXEDO_SERVICE(SisSrvRelaciona);

/**************************************************************************
 *  Funcao de Negocios:  SisSrvRelaciona
 *
 ...
 *
 *************************************************************************/
void implSisSrvRelaciona::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implSisSrvRelaciona::Execute()");
	/* Chamada de Funcao de Negocios */
	CSis oSis;
	switch (oSis.SisSrvRelaciona(dnode,xml_g, getUser())) {
		case 0:	oSis.SisSrvRelacao(dnode,xml_g); setStatusCode("08I0000","Servico executado com sucesso."); break;
    ...
    ULOG_END("implSisSrvRelaciona::Execute()");
	return;
}
