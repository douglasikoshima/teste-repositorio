...
DECLARE_TUXEDO_SERVICE(SISSRVRELACIO);
 ...
 *
 *************************************************************************/
void implSISSRVRELACIO::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implSISSRVRELACIO::Execute()");
	...
	ULOG_END("implSISSRVRELACIO::Execute()");
	return;
}
