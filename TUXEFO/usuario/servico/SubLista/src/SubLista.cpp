...
DECLARE_TUXEDO_SERVICE(SubLista);

/**************************************************************************
 *  Funcao de Negocios:  SubLista
 *
 ...
 *
 *************************************************************************/
void implSubLista::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implSubLista::Execute()");
	/* Chamada de Funcao de Negocios */
	CSub oSub;
	switch (oSub.SubLista(dnode,xml_g)) {
