...
DECLARE_TUXEDO_SERVICE(PrfListaId);

/**************************************************************************
 *  Funcao de Negocios:  PrfListaId
 *
 ...
 *
 *************************************************************************/
void implPrfListaId::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implPrfListaId::Execute()");
	/* Chamada de Funcao de Negocios */
	CPrf oPrf;
	switch (oPrf.PrfListaId(dnode,xml_g)) {
	...
	ULOG_END("implPrfListaId::Execute()");
	return;
}
