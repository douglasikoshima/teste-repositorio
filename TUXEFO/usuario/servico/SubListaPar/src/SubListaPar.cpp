...
DECLARE_TUXEDO_SERVICE(SubListaPar);

/**************************************************************************
 *  Funcao de Negocios:  SubListaPar
 *
 ...
 *
 *************************************************************************/
void implSubListaPar::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implSubListaPar::Execute()");
	/* Chamada de Funcao de Negocios */
	CSub oSub;
	switch (oSub.SubListaPar(dnode,xml_g)) {
    ...
    ULOG_END("implSubListaPar::Execute()");
	return;
}
