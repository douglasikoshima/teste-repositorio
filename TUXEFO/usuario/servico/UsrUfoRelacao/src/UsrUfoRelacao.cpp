/*****************************************************************************
 *
 * Modulo:    UsrUfoRelacao
 * Arquivo:   UsrUfoRelacao.cpp
...
DECLARE_TUXEDO_SERVICE(UsrUfoRelacao);

/**************************************************************************
 *  Funcao de Negocios:  UsrUfoRelacao
 *
 ...
 *
 *************************************************************************/
void implUsrUfoRelacao::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implUsrUfoRelacao::Execute()");
	
	/* Chamada de Funcao de Negocios */
	CUsr oUsr;
	switch (oUsr.UsrUfoRelacao(dnode,xml_g)) {
	...
	ULOG_END("implUsrUfoRelacao::Execute()");
	return;
}
