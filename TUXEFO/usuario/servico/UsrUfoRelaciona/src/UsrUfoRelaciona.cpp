...
DECLARE_TUXEDO_SERVICE(UsrUfoRelaciona);
 ...
 *
 *************************************************************************/
void implUsrUfoRelaciona::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implUsrUfoRelaciona::Execute()");
	...
	ULOG_END("implUsrUfoRelaciona::Execute()");
	return;
}
