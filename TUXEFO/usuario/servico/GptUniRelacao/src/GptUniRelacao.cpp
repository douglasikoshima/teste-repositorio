/*****************************************************************************
 *
 * Modulo:    GptUniRelacao
 * Arquivo:   GptUniRelacao.cpp
...
DECLARE_TUXEDO_SERVICE(GptUniRelacao);

/**************************************************************************
 *  Funcao de Negocios:  GptUniRelacao
 *
 ...
 *
 *************************************************************************/
void implGptUniRelacao::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implGptUniRelacao::Execute()");
	/* Chamada de Funcao de Negocios */
	CGpt oGpt;
	switch (oGpt.GptUniRelacao(dnode,xml_g)) {
	...
	ULOG_END("implGptUniRelacao::Execute()");
	return;
}
