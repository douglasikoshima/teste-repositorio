...
DECLARE_TUXEDO_SERVICE(GptListaId);

/**************************************************************************
 *  Funcao de Negocios:  GptListaId
 *
 ...
 *
 *************************************************************************/
void implGptListaId::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implGptListaId::Execute()");
	/* Chamada de Funcao de Negocios */
	CGpt oGpt;
	switch (oGpt.GptListaId(dnode,xml_g)) {
	...
	ULOG_END("implGptListaId::Execute()");
	return;
}
