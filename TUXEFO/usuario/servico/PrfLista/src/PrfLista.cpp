...
DECLARE_TUXEDO_SERVICE(PrfLista);

/**************************************************************************
 *  Funcao de Negocios:  PrfLista
 *
 ...
 *
 *************************************************************************/
void implPrfLista::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implPrfLista::Execute()");
