...
DECLARE_TUXEDO_SERVICE(USRPRFRELACIO);
 ...
 *
 *************************************************************************/
void implUSRPRFRELACIO::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implUSRPRFRELACIO::Execute()");
	...
	ULOG_END("implUSRPRFRELACIO::Execute()");
	return;
}
