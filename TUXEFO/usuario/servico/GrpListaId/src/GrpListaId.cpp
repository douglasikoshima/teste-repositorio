...
DECLARE_TUXEDO_SERVICE(GrpListaId);

/**************************************************************************
 *  Funcao de Negocios:  GrpListaId
 *
 ...
 *
 *************************************************************************/
void implGrpListaId::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implGrpListaId::Execute()");
	/* Chamada de Funcao de Negocios */
	CGrp oGrp;
	switch (oGrp.GrpListaId(dnode,xml_g)) {
	...
	ULOG_END("implGrpListaId::Execute()");
	return;
}
