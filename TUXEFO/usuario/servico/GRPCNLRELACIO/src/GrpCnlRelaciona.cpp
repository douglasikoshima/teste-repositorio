...
DECLARE_TUXEDO_SERVICE(GRPCNLRELACIO);
 ...
 *
 *************************************************************************/
void implGRPCNLRELACIO::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implGRPCNLRELACIO::Execute()");
	...
	ULOG_END("implGRPCNLRELACIO::Execute()");
	return;
}
