...
DECLARE_TUXEDO_SERVICE(GrpLista);

/**************************************************************************
 *  Funcao de Negocios:  GrpLista
 *
 ...
 *
 *************************************************************************/
void implGrpLista::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implGrpLista::Execute()");
	/* Chamada de Funcao de Negocios */
	CGrp oGrp;
	switch (oGrp.GrpLista(dnode,xml_g)) {
