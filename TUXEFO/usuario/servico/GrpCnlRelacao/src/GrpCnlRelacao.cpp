/*****************************************************************************
 *
 * Modulo:    GrpCnlRelacao
 * Arquivo:   GrpCnlRelacao.cpp
...
DECLARE_TUXEDO_SERVICE(GrpCnlRelacao);

/**************************************************************************
 *  Funcao de Negocios:  GrpCnlRelacao
 *
 ...
 *
 *************************************************************************/
void implGrpCnlRelacao::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implGrpCnlRelacao::Execute()");
	/* Chamada de Funcao de Negocios */
	CGrp oGrp;
	switch (oGrp.GrpCnlRelacao(dnode,xml_g)) {
	...
	ULOG_END("implGrpCnlRelacao::Execute()");
	return;
}
