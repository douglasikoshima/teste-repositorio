...
DECLARE_TUXEDO_SERVICE(SisLista);

/**************************************************************************
 *  Funcao de Negocios:  SisLista
 *
 ...
 *
 *************************************************************************/
void implSisLista::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implSisLista::Execute()");
