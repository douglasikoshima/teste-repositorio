...
DECLARE_TUXEDO_SERVICE(PRFGPTRELACIO);
 ...
 *
 *************************************************************************/
void implPRFGPTRELACIO::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implPRFGPTRELACIO::Execute()");
	...
	ULOG_END("implPRFGPTRELACIO::Execute()");
	return;
}
