/*****************************************************************************
 *
 * Modulo:    UsrGrpRelacao
 * Arquivo:   UsrGrpRelacao.cpp
...
DECLARE_TUXEDO_SERVICE(UsrGrpRelacao);

/**************************************************************************
 *  Funcao de Negocios:  UsrGrpRelacao
 *
 ...
 *
 *************************************************************************/
void implUsrGrpRelacao::Execute(DOMNode*dnode,XMLGen*xml_g)
{
    ULOG_START("implUsrGrpRelacao::Execute()");
	/* Chamada de Funcao de Negocios */
	CUsr oUsr;
	switch (oUsr.UsrGrpRelacao(dnode,xml_g)) {
    ...
    ULOG_END("implUsrGrpRelacao::Execute()");
	return;
}
