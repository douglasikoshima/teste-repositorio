...
DECLARE_TUXEDO_SERVICE(GrpListaPar);

/**************************************************************************
 *  Funcao de Negocios:  GrpListaPar
 *
 ...
 *
 *************************************************************************/
void implGrpListaPar::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implGrpListaPar::Execute()");
	/* Chamada de Funcao de Negocios */
	CGrp oGrp;
	switch (oGrp.GrpListaPar(dnode,xml_g)) {
	...
	ULOG_END("implGrpListaPar::Execute()");
	return;
}
