...
void implGrpRemover::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	...
	switch (oGrp.GrpRemover(dnode,xml_g, cidUser)) 
	{
		...
		case 2: setStatusCode("08E0200","idGrupo inválido"); break;
		case 3: setStatusCode("08E0300","Grupo não existe"); break;
		case 4: setStatusCode("08W0100","Grupo pertence a um atendimento em andamento"); break;
		case 5: setStatusCode("08W0200","Este grupo não pode ser apagado, pois existem contatos configurados somente com este grupo"); break;
		case 6: setStatusCode("08E0001","Houve uma falha na exclusão do grupo"); break;
