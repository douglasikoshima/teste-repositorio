...
DECLARE_TUXEDO_SERVICE(SisEditar);

/**************************************************************************
 *  Funcao de Negocios:  SisEditar
 *
 ...
 *
 *************************************************************************/
void implSisEditar::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implSisEditar::Execute()");
	/* Chamada de Funcao de Negocios */
	CSis oSis;
	switch (oSis.SisEditar(dnode,xml_g, getUser())) {
	...
	ULOG_END("implSisEditar::Execute()");
	return;
}
