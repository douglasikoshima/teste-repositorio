...
DECLARE_TUXEDO_SERVICE(SubListaId);

/**************************************************************************
 *  Funcao de Negocios:  SubListaId
 *
 ...
 *
 *************************************************************************/
void implSubListaId::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implSubListaId::Execute()");
	/* Chamada de Funcao de Negocios */
	CSub oSub;
	switch (oSub.SubListaId(dnode,xml_g)) {
	...
	ULOG_END("implSubListaId::Execute()");
	return;
}
