...
DECLARE_TUXEDO_SERVICE(UniLista);

/**************************************************************************
 *  Funcao de Negocios:  UniLista
 *
 ...
 *
 *************************************************************************/
void implUniLista::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implUniLista::Execute()");
	/* Chamada de Funcao de Negocios */
	CUni oUni;
	switch (oUni.UniLista(dnode,xml_g)) {
