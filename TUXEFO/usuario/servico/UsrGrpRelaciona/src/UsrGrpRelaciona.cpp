...
DECLARE_TUXEDO_SERVICE(UsrGrpRelaciona);
 ...
 *
 *************************************************************************/
void implUsrGrpRelaciona::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implUsrGrpRelaciona::Execute()");
	/* Chamada de Funcao de Negocios */
	CUsr oUsr;
	switch (oUsr.UsrGrpRelaciona(dnode,xml_g, getUser())) {
		case 0:	oUsr.UsrGrpRelacao(dnode,xml_g); setStatusCode("08I0000","Servico executado com sucesso."); break;
		case 1: setStatusCode("08E0100","Falha ao tentar limpar os grupos relacionados"); break;
		case 2: setStatusCode("08E0200","Falha na insercao de grupos relacionados"); break;
		case 3: setStatusCode("08E0300","idUsuario esta nulo"); break;
		default: setStatusCode("08E9999","Erro nao classificado."); break;
	}
	ULOG_END("implUsrGrpRelaciona::Execute()");
	return;
}
