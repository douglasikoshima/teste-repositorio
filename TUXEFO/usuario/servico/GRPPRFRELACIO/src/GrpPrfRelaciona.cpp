...
DECLARE_TUXEDO_SERVICE(GRPPRFRELACIO);
 ...
 *
 *************************************************************************/
void implGRPPRFRELACIO::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implGRPPRFRELACIO::Execute()");
	...
	ULOG_END("implGRPPRFRELACIO::Execute()");
	return;
}
