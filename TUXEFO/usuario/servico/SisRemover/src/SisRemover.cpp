...
DECLARE_TUXEDO_SERVICE(SisRemover);

/**************************************************************************
 *  Funcao de Negocios:  SisRemover
 *
 ...
 *
 *************************************************************************/
void implSisRemover::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implSisRemover::Execute()");
	/* Chamada de Funcao de Negocios */
	CSis oSis;
	switch (oSis.SisRemover(dnode,xml_g, getUser())) {
		case 0:	oSis.SisLista(dnode,xml_g); setStatusCode("08I0000","Servico executado com sucesso."); break;
		case 1: setStatusCode("08E0100","Erro ao excluir registros."); break;
		case 2: setStatusCode("08E0200","idSistema invalido"); break;
	...
	ULOG_END("implSisRemover::Execute()");
	return;
}
