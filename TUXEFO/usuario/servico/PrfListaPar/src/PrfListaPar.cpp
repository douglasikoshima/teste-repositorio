...
DECLARE_TUXEDO_SERVICE(PrfListaPar);

/**************************************************************************
 *  Funcao de Negocios:  PrfListaPar
 *
 ...
 *
 *************************************************************************/
void implPrfListaPar::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implPrfListaPar::Execute()");
	/* Chamada de Funcao de Negocios */
	CPrf oPrf;
	switch (oPrf.PrfListaPar(dnode,xml_g)) {
	...
	ULOG_END("implPrfListaPar::Execute()");
	return;
}
