...
DECLARE_TUXEDO_SERVICE(SrvLista);

/**************************************************************************
 *  Funcao de Negocios:  SrvLista
 *
 ...
 *
 *************************************************************************/
void implSrvLista::Execute(DOMNode*dnode,XMLGen*xml_g)
{
	ULOG_START("implSrvLista::Execute()");
	/* Chamada de Funcao de Negocios */
	CSafePointer oSafePointer;
	CSrv oSrv;
	char* cdsServidor = oSafePointer.getTag( dnode, "dsServidor", 0 );
	switch (oSrv.SrvLista( cdsServidor,xml_g)) {
