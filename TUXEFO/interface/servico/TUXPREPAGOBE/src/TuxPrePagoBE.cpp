...
DECLARE_TUXEDO_SERVICE(TUXPREPAGOBE);


void implTUXPREPAGOBE::Execute(DOMNode* dnode, XMLGen* xml_g)
{
	char*     pc_Linha    = NULL;
	...
	tuxfw_getlogger()->debug("Executando TuxPrePagoBE");
