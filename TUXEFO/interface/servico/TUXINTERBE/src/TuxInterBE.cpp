...
DECLARE_TUXEDO_SERVICE(TUXINTERBE);


void implTUXINTERBE::Execute(DOMNode* dnode, XMLGen* xml_g)
{
	char*     pc_Linha    = NULL;
	...
	tuxfw_getlogger()->debug("Executando TuxInterBE");
