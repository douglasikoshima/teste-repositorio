 ...
 * @ID      $Id: tuxfwreleases.h,v 1.1.6.1 2012/08/14 22:23:48 a5110706 Exp $
 **/

///
// Macro para documentação de disponibilização de releases oficiais do framework
//
#define TUXFW_SIGNATURE  "TUXFW v. 2.1.24 - $Revision: 1.1.6.1 $ $Date: 2012/08/14 22:23:48 $\0"
//
//  Historico parcial de releases oficiais do framework a partir de 03/08/2004
//
// $Log: tuxfwreleases.h,v $
// Revision 1.1.6.1  2012/08/14 22:23:48  a5110706
// no message
//
