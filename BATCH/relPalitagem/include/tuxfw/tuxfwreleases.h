 ...
 * @ID      $Id: tuxfwreleases.h,v 1.1.4.1 2007/11/13 23:57:52 rrusso Exp $
 **/

///
// Macro para documentação de disponibilização de releases oficiais do framework
//
#define TUXFW_SIGNATURE  "TUXFW v. 2.1.24 - $Revision: 1.1.4.1 $ $Date: 2007/11/13 23:57:52 $\0"
//
//  Historico parcial de releases oficiais do framework a partir de 03/08/2004
//
// $Log: tuxfwreleases.h,v $
// Revision 1.1.4.1  2007/11/13 23:57:52  rrusso
// no message
//
// Revision 1.1  2007/11/13 21:39:08  rrusso
// *** empty log message ***
//
