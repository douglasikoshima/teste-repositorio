/* Formatted on 05/07/2014 15:49:09 (QP5 v5.115.810.9015) */
set echo on
set serveroutput on
...
DECLARE
   ...
   IS
      SELECT   ROWID rid,
       ...
       WHERE   idcontato IS NULL AND tipo LIKE 'V%';

   v_n0                 VARCHAR2 (255) := 'VENDAS';
   ...
   LOOP
      ...
      */
         ...
         THEN
            ...
            IF v_count = 0
            THEN
               --DBMS_OUTPUT.PUT_LINE ('antes vo_idcontato '||vo_idcontato);
               vo_cderro := 7;
