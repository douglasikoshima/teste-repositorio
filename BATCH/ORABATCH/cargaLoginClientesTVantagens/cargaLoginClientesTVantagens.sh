...
############################################################
export LOG_PREFIX="cargaLoginClientesTVantagens"
DIR_SHELL=`dirname $0`
cd ${DIR_SHELL} 
...
ARQUIVO_EM_EXECUCAO=cargaLoginClientesTVantagens.lock
...
source ${ORABATCH_DIR}/cargaLoginClientesTVantagens_db_functions.sh
source ${ORABATCH_DIR}/cargaLoginClientesTVantagens_files_functions.sh
...
then
	...
	do
		...
		then
			...
			cargaArquivos ${ORABATCH_DIR_SQL}/cargaLoginClientesTVantagens.par ${arquivo}


			executaQuery ${ORABATCH_CONNECTION} ${ORABATCH_DIR} sql/cargaLoginClientesTVantagens ${SEM_RETORNO} ${arquivo}
	...
	log ${LOG_PREFIX} "================================"
	log ${LOG_PREFIX} "	Verifique se o processo esta em execucao: ps -ef | grep cargaLoginClientesTVantagens"
