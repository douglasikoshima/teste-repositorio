...
export LOG_PREFIX="sincronismoAMDOCS"
DIR_SHELL=`dirname $0`
cd ${DIR_SHELL} 
...
ARQUIVO_EM_EXECUCAO=sincronismoAMDOCS.lock
...
source ${ORABATCH_DIR}/sincronismoAMDOCS_db_functions.sh
source ${ORABATCH_DIR}/sincronismoAMDOCS_files_functions.sh
...
then
	...
	executaQuery ${ORABATCH_CONNECTION} ${ORABATCH_DIR} sql/sincronismoAMDOCS ${COM_RETORNO} 

	log ${LOG_PREFIX} "================================ RETORNO DO SQL ================================"
	...
	log ${LOG_PREFIX} "================================"
	log ${LOG_PREFIX} "	Verifique se o processo esta em execucao: ps -ef | grep sincronismoAMDOCS"
