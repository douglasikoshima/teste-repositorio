...
FILENAME=$1
SCRIPTDIR=/var/opt/batch/des/deploy/processos/ORABATCH/gestorAutorizado/bin
BADDIR=/var/opt/batch/des/deploy/processos/ORABATCH/gestorAutorizado/proc
DSCDIR=/var/opt/batch/des/deploy/processos/ORABATCH/gestorAutorizado/proc
LOGDIR=/var/opt/batch/des/deploy/processos/ORABATCH/gestorAutorizado/log
DATADIR=/var/opt/batch/des/deploy/processos/ORABATCH/gestorAutorizado/data
PRCDIR=/var/opt/batch/des/deploy/processos/ORABATCH/gestorAutorizado/proc
