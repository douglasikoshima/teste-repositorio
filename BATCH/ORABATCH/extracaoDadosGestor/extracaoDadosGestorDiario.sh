...
export EXTRACAO_DADOS_GESTOR_SPOOL_GC="${EXTRACAO_DADOS_GESTOR_DIR}/extracaoDadosGestorDiario.sql"
export EXTRACAO_DADOS_GESTOR_SPOOL_GM="${EXTRACAO_DADOS_GESTOR_DIR}/extracaoDadosGestorMasterDiario.sql"
