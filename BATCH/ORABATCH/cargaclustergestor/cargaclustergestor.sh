...
PRL='cargaclustergestor.pl'
CFG='cargaclustergestor.cfg'
...
export PARAM_COMMIT
export IDUSUARIOALTERACAO

# Para rodar corretamente na arneiroz
if [ `hostname` == 'arneiroz' ]
then
	# Exporta variavels do perl (Bibliotecas e executavel 32bits)
	export PERL5LIB=$DIR/../../perl/lib:$DIR/../../perl/lib/site_perl:$PERL5LIB
	alias perl_64bit='perl'
	
	export LIBPATH=$DIR/../../instantclient10_1:$LIBPATH
else
