...
############################################################
export LOG_PREFIX="expurgoParamProgRelacionamento"
DIR_SHELL=`dirname $0`
cd ${DIR_SHELL} 
...
ARQUIVO_EM_EXECUCAO=expurgoParamProgRelacionamento.lock
...
source ${ORABATCH_DIR}/expurgoParamProgRelacionamento_db_functions.sh
source ${ORABATCH_DIR}/expurgoParamProgRelacionamento_files_functions.sh
...
then
	...
	executaQuery ${ORABATCH_CONNECTION} ${ORABATCH_DIR} sql/expurgoParamProgRelacionamento ${SEM_RETORNO} 
	...
	log ${LOG_PREFIX} "================================"
	log ${LOG_PREFIX} "	Verifique se o processo esta em execucao: ps -ef | grep expurgoParamProgRelacionamento"
