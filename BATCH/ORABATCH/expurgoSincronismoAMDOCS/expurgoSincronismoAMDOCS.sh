...
############################################################
export LOG_PREFIX="EXP_SINC_AMDOCS"
DIR_SHELL=`dirname $0`
cd ${DIR_SHELL} 
...
then
	processaExpurgoBkp "PROCESSAMENTO_BACKUP_FILASINCRONISMOAMDOCS" $retorno_data
	processaExpurgoBkp "PROCESSAMENTO_BACKUP_LOG_SINCRONISMO" $retorno_data
	processaExpurgoBkp "PROCESSAMENTO_BACKUP_LOG_SINCRONISMO_XML" $retorno_data
	processaExpurgo "PROCESSAMENTO_EXPURGO_LOG_SINCRONISMO_XML" $retorno_data
	processaExpurgo "PROCESSAMENTO_EXPURGO_LOG_SINCRONISMO" $retorno_data
	processaExpurgo "PROCESSAMENTO_EXPURGO_FILASINCRONISMOAMDOCS" $retorno_data
