...
#ifndef BLACKLISTCREDITO_H_
#define BLACKLISTCREDITO_H_
...
class CBlacklistCredito
{
public:
	CBlacklistCredito(string& configFile);
	virtual ~CBlacklistCredito();
...
private:
	...
	{
	public:
		CException() : emsg("CBlacklistCredito Exception!") {}
