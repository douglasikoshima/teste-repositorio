...
FILENAME=$1
SCRIPTDIR=/var/opt/batch/producao/deploy/processos/linhapremium/bin
BADDIR=/var/opt/batch/producao/deploy/processos/linhapremium/log
DSCDIR=/var/opt/batch/producao/deploy/processos/linhapremium/log
LOGDIR=/var/opt/batch/producao/deploy/processos/linhapremium/log
DATADIR=/var/opt/batch/producao/deploy/processos/linhapremium/data
