...
FILENAME=$1
SCRIPTDIR=/var/opt/batch/des/deploy/processos/linhapremium/bin
BADDIR=/var/opt/batch/des/deploy/processos/linhapremium/log
DSCDIR=/var/opt/batch/des/deploy/processos/linhapremium/log
LOGDIR=/var/opt/batch/des/deploy/processos/linhapremium/log
DATADIR=/var/opt/batch/des/deploy/processos/linhapremium/data
