...
FILENAME=$1
SCRIPTDIR=/var/opt/batch/homvivo/deploy/processos/linhaIphone/bin
BADDIR=/var/opt/batch/homvivo/deploy/processos/linhaIphone/log
DSCDIR=/var/opt/batch/homvivo/deploy/processos/linhaIphone/log
LOGDIR=/var/opt/batch/homvivo/deploy/processos/linhaIphone/log
DATADIR=/var/opt/batch/homvivo/deploy/processos/linhaIphone/data
