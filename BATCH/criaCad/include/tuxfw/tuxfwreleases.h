 ...
 * @CVS     $Author: rrusso $ - $Date: 2008/11/12 19:38:40 $
 * @ID      $Id: tuxfwreleases.h,v 1.1.2.1 2008/11/12 19:38:40 rrusso Exp $
 **/

///
// Macro para documentação de disponibilização de releases oficiais do framework
//
#define TUXFW_SIGNATURE  "TUXFW v. 2.1.24 - $Revision: 1.1.2.1 $ $Date: 2008/11/12 19:38:40 $\0"
//
//  Historico parcial de releases oficiais do framework a partir de 03/08/2004
//
// $Log: tuxfwreleases.h,v $
// Revision 1.1.2.1  2008/11/12 19:38:40  rrusso
// criaCad - Correcao da nao publicacao do cadastro de cliente no NGIN e FO
//
// Revision 1.1  2008/11/11 18:06:34  rrusso
// *** empty log message ***
//
