...
FILENAME=$1
SCRIPTDIR=/var/opt/batch/homvivo/deploy/processos/planoservicolinha_tmp/bin
BADDIR=/var/opt/batch/homvivo/deploy/processos/planoservicolinha_tmp/log
DSCDIR=/var/opt/batch/homvivo/deploy/processos/planoservicolinha_tmp/log
LOGDIR=/var/opt/batch/homvivo/deploy/processos/planoservicolinha_tmp/log
DATADIR=/var/opt/batch/homvivo/deploy/processos/planoservicolinha_tmp/data
