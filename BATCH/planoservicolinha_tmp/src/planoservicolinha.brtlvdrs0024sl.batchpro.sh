...
FILENAME=$1
SCRIPTDIR=/var/opt/batch/producao/deploy/processos/planoservicolinha_tmp/bin
BADDIR=/var/opt/batch/producao/deploy/processos/planoservicolinha_tmp/log
DSCDIR=/var/opt/batch/producao/deploy/processos/planoservicolinha_tmp/log
LOGDIR=/var/opt/batch/producao/deploy/processos/planoservicolinha_tmp/log
DATADIR=/var/opt/batch/producao/deploy/processos/planoservicolinha_tmp/data
