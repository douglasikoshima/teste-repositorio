...
FILENAME=$1
SCRIPTDIR=/var/opt/batch/des/deploy/processos/planoservicolinha_tmp/bin
BADDIR=/var/opt/batch/des/deploy/processos/planoservicolinha_tmp/log
DSCDIR=/var/opt/batch/des/deploy/processos/planoservicolinha_tmp/log
LOGDIR=/var/opt/batch/des/deploy/processos/planoservicolinha_tmp/log
DATADIR=/var/opt/batch/des/deploy/processos/planoservicolinha_tmp/data

###############################################
### string de conexao ao BD
###############################################
CONNSTR=A5114878/eth0104@intdeva
