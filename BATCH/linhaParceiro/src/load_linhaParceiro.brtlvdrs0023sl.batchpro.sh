...
FILENAME=$1
SCRIPTDIR=/var/opt/batch/producao/deploy/processos/linhaParceiro/bin
BADDIR=/var/opt/batch/producao/deploy/processos/linhaParceiro/proc
DSCDIR=/var/opt/batch/producao/deploy/processos/linhaParceiro/proc
LOGDIR=/var/opt/batch/producao/deploy/processos/linhaParceiro/log
DATADIR=/var/opt/batch/producao/deploy/processos/linhaParceiro/data
PRCDIR=/var/opt/batch/producao/deploy/processos/linhaParceiro/proc
