...
FILENAME=$1
SCRIPTDIR=/var/opt/batch/homvivo/deploy/processos/linhaParceiro/bin
BADDIR=/var/opt/batch/homvivo/deploy/processos/linhaParceiro/proc
DSCDIR=/var/opt/batch/homvivo/deploy/processos/linhaParceiro/proc
LOGDIR=/var/opt/batch/homvivo/deploy/processos/linhaParceiro/log
DATADIR=/var/opt/batch/homvivo/deploy/processos/linhaParceiro/data
PRCDIR=/var/opt/batch/homvivo/deploy/processos/linhaParceiro/proc
