 ...
 * @ID      $Id: tuxfwreleases.h,v 1.1.4.1 2008/03/27 22:25:20 esiqueir Exp $
 **/

///
// Macro para documentação de disponibilização de releases oficiais do framework
//
#define TUXFW_SIGNATURE  "TUXFW v. 2.1.24 - $Revision: 1.1.4.1 $ $Date: 2008/03/27 22:25:20 $\0"
//
//  Historico parcial de releases oficiais do framework a partir de 03/08/2004
//
// $Log: tuxfwreleases.h,v $
// Revision 1.1.4.1  2008/03/27 22:25:20  esiqueir
// os 708 - Atendimento Agendado para linhas Premium
//
