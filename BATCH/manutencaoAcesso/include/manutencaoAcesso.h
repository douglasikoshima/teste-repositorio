...
// prototipos
bool existeRegistroNaBlackList(char *pszIdLinhaTelefonica);
...
int  EnviarMensagemTibco(const char *idAtendimentoProtocolo,const char *cdAreaRegistro,const char *nrLinha,const char *dsMensagemEnvio,const char *queueName,char *argVZero,tibemsQueueSender &queueSender,const char *pSzMessageLog);
