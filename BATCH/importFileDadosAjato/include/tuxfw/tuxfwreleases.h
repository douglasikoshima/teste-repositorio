 ...
 * @ID      $Id: tuxfwreleases.h,v 1.1.6.1 2013/07/10 18:04:38 jones Exp $
 **/

///
// Macro para documentação de disponibilização de releases oficiais do framework
//
#define TUXFW_SIGNATURE  "TUXFW v. 2.1.24 - $Revision: 1.1.6.1 $ $Date: 2013/07/10 18:04:38 $\0"
//
//  Historico parcial de releases oficiais do framework a partir de 03/08/2004
//
// $Log: tuxfwreleases.h,v $
// Revision 1.1.6.1  2013/07/10 18:04:38  jones
// importFileDadosAjato
//
