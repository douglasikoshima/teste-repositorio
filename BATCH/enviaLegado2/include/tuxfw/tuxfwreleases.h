 ...
 * @CVS     $Author: a5110702 $ - $Date: 2009/09/29 14:29:27 $
 * @ID      $Id: tuxfwreleases.h,v 1.1.2.1 2009/09/29 14:29:27 a5110702 Exp $
 **/

///
// Macro para documentação de disponibilização de releases oficiais do framework
//
#define TUXFW_SIGNATURE  "TUXFW v. 2.1.24 - $Revision: 1.1.2.1 $ $Date: 2009/09/29 14:29:27 $\0"
//
//  Historico parcial de releases oficiais do framework a partir de 03/08/2004
//
// $Log: tuxfwreleases.h,v $
// Revision 1.1.2.1  2009/09/29 14:29:27  a5110702
// Criado clone do serviço enviaLegado para desafogar processamento.
//
