...
FILENAME=$1
SCRIPTDIR=${HOME}/deploy/processos/pontocontato/bin
BADDIR=${HOME}/deploy/processos/pontocontato/log
DSCDIR=${HOME}/deploy/processos/pontocontato/log
LOGDIR=${HOME}/deploy/processos/pontocontato/log

DATADIR=${HOME}/deploy/processos/pontocontato/data
