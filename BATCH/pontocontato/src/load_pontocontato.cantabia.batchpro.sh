...
FILENAME=$1
SCRIPTDIR=/var/opt/batch/homvivo/deploy/processos/pontocontato/bin
BADDIR=/var/opt/batch/homvivo/deploy/processos/pontocontato/log
DSCDIR=/var/opt/batch/homvivo/deploy/processos/pontocontato/log
LOGDIR=/var/opt/batch/homvivo/deploy/processos/pontocontato/log

DATADIR=/var/opt/batch/homvivo/deploy/processos/pontocontato/data
