...
FILENAME=$1
SCRIPTDIR=/var/opt/batch/int/deploy/processos/pontocontato/bin
BADDIR=/var/opt/batch/int/deploy/processos/pontocontato/log
DSCDIR=/var/opt/batch/int/deploy/processos/pontocontato/log
LOGDIR=/var/opt/batch/int/deploy/processos/pontocontato/log

DATADIR=/var/opt/batch/int/deploy/processos/pontocontato/data
