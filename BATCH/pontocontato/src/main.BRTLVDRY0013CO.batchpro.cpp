...
//#define PATH_TEXTO "/var/opt/batch/homvivo/deploy/processos/pontocontato/data"
//#define PATH_CFG "/var/opt/batch/homvivo/deploy/processos/pontocontato/cfg"

#define PATH_TEXTO "../data"
#define PATH_CFG "../cfg"
