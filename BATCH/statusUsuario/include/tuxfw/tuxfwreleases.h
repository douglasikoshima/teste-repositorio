 ...
 * @CVS     $Author: rrusso $ - $Date: 2007/01/08 18:47:57 $
 * @ID      $Id: tuxfwreleases.h,v 1.1 2007/01/08 18:47:57 rrusso Exp $
 **/

///
// Macro para documentação de disponibilização de releases oficiais do framework
//
#define TUXFW_SIGNATURE  "TUXFW v. 2.1.24 - $Revision: 1.1 $ $Date: 2007/01/08 18:47:57 $\0"
//
//  Historico parcial de releases oficiais do framework a partir de 03/08/2004
//
// $Log: tuxfwreleases.h,v $
// Revision 1.1  2007/01/08 18:47:57  rrusso
// no message
//
