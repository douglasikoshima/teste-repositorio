 ...
 * @ID      $Id: tuxfwreleases.h,v 1.1.2.1 2008/01/04 14:48:51 rrusso Exp $
 **/

///
// Macro para documentação de disponibilização de releases oficiais do framework
//
#define TUXFW_SIGNATURE  "TUXFW v. 2.1.24 - $Revision: 1.1.2.1 $ $Date: 2008/01/04 14:48:51 $\0"
//
//  Historico parcial de releases oficiais do framework a partir de 03/08/2004
//
// $Log: tuxfwreleases.h,v $
// Revision 1.1.2.1  2008/01/04 14:48:51  rrusso
// no message
//
// Revision 1.1  2007/12/18 17:44:32  rrusso
// *** empty log message ***
//
