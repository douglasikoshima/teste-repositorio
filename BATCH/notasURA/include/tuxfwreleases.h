 ...
 * @ID      $Id: tuxfwreleases.h,v 1.1.2.1 2012/05/15 19:31:14 a5114878 Exp $
 **/

///
// Macro para documentação de disponibilização de releases oficiais do framework
//
#define TUXFW_SIGNATURE  "TUXFW v. 2.1.24 - $Revision: 1.1.2.1 $ $Date: 2012/05/15 19:31:14 $\0"
//
//  Historico parcial de releases oficiais do framework a partir de 03/08/2004
//
// $Log: tuxfwreleases.h,v $
// Revision 1.1.2.1  2012/05/15 19:31:14  a5114878
// OS 24507 - Alteração de Lay-Out no arquivo texto de carga.
//
