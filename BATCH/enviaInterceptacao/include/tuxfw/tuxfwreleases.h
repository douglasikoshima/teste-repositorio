 ...
 * @ID      $Id: tuxfwreleases.h,v 1.1.4.1 2009/08/26 19:24:43 a5110702 Exp $
 **/

///
// Macro para documentação de disponibilização de releases oficiais do framework
//
#define TUXFW_SIGNATURE  "TUXFW v. 2.1.24 - $Revision: 1.1.4.1 $ $Date: 2009/08/26 19:24:43 $\0"
//
//  Historico parcial de releases oficiais do framework a partir de 03/08/2004
//
// $Log: tuxfwreleases.h,v $
// Revision 1.1.4.1  2009/08/26 19:24:43  a5110702
// OS 1198 - Melhorias no cadastro de pré-pago
//
// Revision 1.1.2.1  2009/08/13 19:27:12  a5110702
// OS 1198 - Melhorias no processo de envio de cadastro de Pré-Pago.
//
