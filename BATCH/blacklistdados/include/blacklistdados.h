...
#ifndef BLACKLISTDADOS_H_
#define BLACKLISTDADOS_H_
...
class CBlacklistDados
{
public:
	CBlacklistDados(string& configFile);
	virtual ~CBlacklistDados();
...
private:
	...
	{
	public:
		CException() : emsg("CBlacklistDados Exception!") {}
