 ...
 * @CVS     $Author: rrusso $ - $Date: 2007/11/23 19:55:51 $
 * @ID      $Id: tuxfwreleases.h,v 1.1.4.1 2007/11/23 19:55:51 rrusso Exp $
 **/

///
// Macro para documentação de disponibilização de releases oficiais do framework
//
#define TUXFW_SIGNATURE  "TUXFW v. 2.1.24 - $Revision: 1.1.4.1 $ $Date: 2007/11/23 19:55:51 $\0"
//
//  Historico parcial de releases oficiais do framework a partir de 03/08/2004
//
// $Log: tuxfwreleases.h,v $
// Revision 1.1.4.1  2007/11/23 19:55:51  rrusso
// no message
//
// Revision 1.1.2.1  2007/11/22 20:13:05  rrusso
// no message
//
