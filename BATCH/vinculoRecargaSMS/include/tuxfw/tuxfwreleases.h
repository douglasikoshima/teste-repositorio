 ...
 * @ID      $Id: tuxfwreleases.h,v 1.1.4.1 2010/09/06 19:00:59 a5116174 Exp $
 **/

///
// Macro para documentação de disponibilização de releases oficiais do framework
//
#define TUXFW_SIGNATURE  "TUXFW v. 2.1.24 - $Revision: 1.1.4.1 $ $Date: 2010/09/06 19:00:59 $\0"
//
//  Historico parcial de releases oficiais do framework a partir de 03/08/2004
//
// $Log: tuxfwreleases.h,v $
// Revision 1.1.4.1  2010/09/06 19:00:59  a5116174
// OS - 1411
//
