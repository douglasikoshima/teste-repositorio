 ...
 * @version ${version}
 */
public class AssinanteFacadeSession
   extends br.com.indrasistemas.vivoservices.sittel.assinante.facade.ejb.AssinanteFacadeBean
   implements javax.ejb.SessionBean
{
   private static final long serialVersionUID = 1L;

   private static final Log logger = LogFactory.getLog(AssinanteFacadeSession.class);
   ...
   public br.com.indrasistemas.vivoservices.sittel.assinante.to.ResultadoConsultaTO gravarRequisicaoProcessum(br.com.indrasistemas.vivoservices.sittel.assinante.to.AssinanteTO to, Integer idTipoSolicitacao ) throws br.com.indrasistemas.framework.service.BusinessException {
      ...
      appRegister.register("br.com.indrasistemas.vivoservices.sittel.assinante.facade.ejb.AssinanteFacadeBean", "gravarRequisicaoProcessum");
      ...
      if(tokenAudit.isEnabled())  {
          //tokenAudit.setServiceName("AssinanteFacade.gravarRequisicaoProcessum");
      ...
      if(standardAudit.isEnabled())  {
          //standardAudit.setServiceName("AssinanteFacade.gravarRequisicaoProcessum");
          //standardAudit.putParameter(to);
      }      

      //Call
      br.com.indrasistemas.vivoservices.sittel.assinante.to.ResultadoConsultaTO result = null;
      try	{
	      result = super.gravarRequisicaoProcessum(to, idTipoSolicitacao );
