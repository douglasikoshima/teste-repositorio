...
/**
 * Camada Session para RetencaoUraFacade.
 * @xdoclet-generated at ${TODAY}
 * @copyright The XDoclet Team
 * @author XDoclet
 * @version ${version}
 */
public class RetencaoUraFacadeSession
   extends br.com.indrasistemas.vivoservices.atendimento.retencao.facade.ejb.RetencaoUraFacadeBean
   implements javax.ejb.SessionBean
{
   private static final long serialVersionUID = 1L;

   private static final Log logger = LogFactory.getLog(RetencaoUraFacadeSession.class);
   ...
   public br.com.indrasistemas.vivoservices.atendimento.retencao.to.RetencaoTO consultarOfertas( br.com.indrasistemas.framework.service.to.RequestInfoTO requestInfo,br.com.indrasistemas.vivoservices.atendimento.retencao.to.RetencaoTO to ) throws br.com.indrasistemas.framework.service.BusinessException	{
      ...
      if(requestInfo == null)	{
        String errMsg = "O parâmetro requestInfo não pode ser nulo. O método consultarOfertas não pode ser executado.";
        logger.error(errMsg);
      	throw new NullPointerException(errMsg);
      }
      //Verificação do parâmetro RequestInfoTO.userName
      if(requestInfo.getUserName() == null)	{
        String errMsg = "O parâmetro RequestInfoTO.userName não pode ser nulo. O método consultarOfertas não pode ser executado.";
        logger.error(errMsg);
      	throw new NullPointerException(errMsg);
      }
      ...
      appRegister.register("br.com.indrasistemas.vivoservices.atendimento.retencao.facade.ejb.RetencaoUraFacadeBean", "consultarOfertas");
      //Se nulo é a primeira interação da cadeia de chamadas.
      if(requestInfo.getServiceName() == null)	{
        requestInfo.setServiceName("br.com.indrasistemas.vivoservices.atendimento.retencao.facade.ejb.RetencaoUraFacadeBean.consultarOfertas");
      }
      //Início token audit.
      ...
      if(tokenAudit.isEnabled())  {
          tokenAudit.setServiceName("RetencaoUraFacade.consultarOfertas");
      ...
      if(standardAudit.isEnabled())  {
          standardAudit.setServiceName("RetencaoUraFacade.consultarOfertas");
          standardAudit.putParameter(requestInfo);
          standardAudit.putParameter(to);
      }      

      //Call
      br.com.indrasistemas.vivoservices.atendimento.retencao.to.RetencaoTO result = null;
      try	{
	      result = super.consultarOfertas( requestInfo,to );
   ...
   public br.com.indrasistemas.vivoservices.atendimento.retencao.to.RetencaoTO aceitarOfertas( br.com.indrasistemas.framework.service.to.RequestInfoTO requestInfo,br.com.indrasistemas.vivoservices.atendimento.retencao.to.RetencaoTO to ) throws br.com.indrasistemas.framework.service.BusinessException	{
      //Verificação do parâmetro RequestInfoTO
      if(requestInfo == null)	{
        String errMsg = "O parâmetro requestInfo não pode ser nulo. O método aceitarOfertas não pode ser executado.";
        logger.error(errMsg);
      	throw new NullPointerException(errMsg);
      }
      //Verificação do parâmetro RequestInfoTO.userName
      if(requestInfo.getUserName() == null)	{
        String errMsg = "O parâmetro RequestInfoTO.userName não pode ser nulo. O método aceitarOfertas não pode ser executado.";
        logger.error(errMsg);
      	throw new NullPointerException(errMsg);
      }
      //Registro da app na base de dados
      br.com.indrasistemas.framework.foundation.database.AppRegisterManager appRegister = new br.com.indrasistemas.framework.foundation.database.AppRegisterManager();
      appRegister.register("br.com.indrasistemas.vivoservices.atendimento.retencao.facade.ejb.RetencaoUraFacadeBean", "aceitarOfertas");
      //Se nulo é a primeira interação da cadeia de chamadas.
      if(requestInfo.getServiceName() == null)	{
        requestInfo.setServiceName("br.com.indrasistemas.vivoservices.atendimento.retencao.facade.ejb.RetencaoUraFacadeBean.aceitarOfertas");
      }
      //Início token audit.
      br.com.indrasistemas.framework.foundation.audit.TokenAudit tokenAudit = new br.com.indrasistemas.framework.foundation.audit.TokenAudit();
      if(tokenAudit.isEnabled())  {
          tokenAudit.setServiceName("RetencaoUraFacade.aceitarOfertas");
          tokenAudit.setRequestInfo(requestInfo);
          tokenAudit.sendStartToken();
      }
      ...
      br.com.indrasistemas.framework.foundation.audit.StandardAudit standardAudit = new br.com.indrasistemas.framework.foundation.audit.StandardAudit();
      if(standardAudit.isEnabled())  {
          standardAudit.setServiceName("RetencaoUraFacade.aceitarOfertas");
          standardAudit.putParameter(requestInfo);
          standardAudit.putParameter(to);
      }      
      ...
      br.com.indrasistemas.vivoservices.atendimento.retencao.to.RetencaoTO result = null;
      try	{
	      result = super.aceitarOfertas( requestInfo,to );
	  } catch (br.com.indrasistemas.framework.service.BusinessException e)	{
	  	  //Standard audit -- set exception.
	      if(standardAudit.isEnabled())  {
	          standardAudit.setException(e);
   ...
   public br.com.indrasistemas.vivoservices.atendimento.retencao.to.RetencaoTO recusarOfertas( br.com.indrasistemas.framework.service.to.RequestInfoTO requestInfo,br.com.indrasistemas.vivoservices.atendimento.retencao.to.RetencaoTO to ) throws br.com.indrasistemas.framework.service.BusinessException	{
      //Verificação do parâmetro RequestInfoTO
      if(requestInfo == null)	{
        String errMsg = "O parâmetro requestInfo não pode ser nulo. O método recusarOfertas não pode ser executado.";
        logger.error(errMsg);
      	throw new NullPointerException(errMsg);
      }
      //Verificação do parâmetro RequestInfoTO.userName
      if(requestInfo.getUserName() == null)	{
        String errMsg = "O parâmetro RequestInfoTO.userName não pode ser nulo. O método recusarOfertas não pode ser executado.";
        logger.error(errMsg);
      	throw new NullPointerException(errMsg);
      }
      //Registro da app na base de dados
      br.com.indrasistemas.framework.foundation.database.AppRegisterManager appRegister = new br.com.indrasistemas.framework.foundation.database.AppRegisterManager();
      appRegister.register("br.com.indrasistemas.vivoservices.atendimento.retencao.facade.ejb.RetencaoUraFacadeBean", "recusarOfertas");
      //Se nulo é a primeira interação da cadeia de chamadas.
      if(requestInfo.getServiceName() == null)	{
        requestInfo.setServiceName("br.com.indrasistemas.vivoservices.atendimento.retencao.facade.ejb.RetencaoUraFacadeBean.recusarOfertas");
      }
      //Início token audit.
      br.com.indrasistemas.framework.foundation.audit.TokenAudit tokenAudit = new br.com.indrasistemas.framework.foundation.audit.TokenAudit();
      if(tokenAudit.isEnabled())  {
          tokenAudit.setServiceName("RetencaoUraFacade.recusarOfertas");
          tokenAudit.setRequestInfo(requestInfo);
          tokenAudit.sendStartToken();
      }
      ...
      br.com.indrasistemas.framework.foundation.audit.StandardAudit standardAudit = new br.com.indrasistemas.framework.foundation.audit.StandardAudit();
      if(standardAudit.isEnabled())  {
          standardAudit.setServiceName("RetencaoUraFacade.recusarOfertas");
          standardAudit.putParameter(requestInfo);
          standardAudit.putParameter(to);
      }      
      ...
      br.com.indrasistemas.vivoservices.atendimento.retencao.to.RetencaoTO result = null;
      try	{
	      result = super.recusarOfertas( requestInfo,to );
	  } catch (br.com.indrasistemas.framework.service.BusinessException e)	{
	  	  //Standard audit -- set exception.
	      if(standardAudit.isEnabled())  {
	          standardAudit.setException(e);
