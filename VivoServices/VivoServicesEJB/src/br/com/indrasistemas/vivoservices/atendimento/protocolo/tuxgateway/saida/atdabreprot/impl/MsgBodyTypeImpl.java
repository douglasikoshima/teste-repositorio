...
public class MsgBodyTypeImpl implements br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdabreprot.MsgBodyType, com.sun.xml.bind.JAXBObject, br.com.indrasistemas.jaxb.impl.runtime.UnmarshallableObject, br.com.indrasistemas.jaxb.impl.runtime.XMLSerializable, br.com.indrasistemas.jaxb.impl.runtime.ValidatableObject
{

    protected br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdabreprot.AbreProtocoloOutTOType _AbreProtocoloOutTO;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdabreprot.MsgBodyType.class);
    }

    public br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdabreprot.AbreProtocoloOutTOType getAbreProtocoloOutTO() {
        return _AbreProtocoloOutTO;
    }

    public void setAbreProtocoloOutTO(br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdabreprot.AbreProtocoloOutTOType value) {
        _AbreProtocoloOutTO = value;
    }
    ...
    public br.com.indrasistemas.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(br.com.indrasistemas.jaxb.impl.runtime.UnmarshallingContext context) {
        return new br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdabreprot.impl.MsgBodyTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(br.com.indrasistemas.jaxb.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "AbreProtocoloOutTO");
        context.childAsURIs(((com.sun.xml.bind.JAXBObject) _AbreProtocoloOutTO), "AbreProtocoloOutTO");
        context.endNamespaceDecls();
        context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _AbreProtocoloOutTO), "AbreProtocoloOutTO");
        context.endAttributes();
        context.childAsBody(((com.sun.xml.bind.JAXBObject) _AbreProtocoloOutTO), "AbreProtocoloOutTO");
        context.endElement();
    }
...
+"lang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001dxq\u0000~\u0000\u0018t\u0000kbr.com.indrasistema"
+"s.vivoservices.atendimento.protocolo.tuxgateway.saida.atdabr"
+"eprot.AbreProtocoloOutTOTypet\u0000+http://java.sun.com/jaxb/xjc/"
...
+"tp://www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\u0012AbrePro"
+"tocoloOutTOt\u0000\u0000sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001"
...
+"ar/ExpressionPool;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000\tq\u0000~\u0000!q\u0000~\u0000\fq\u0000~\u0000\u000fx"));
        }
        ...
        extends br.com.indrasistemas.jaxb.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdabreprot.impl.MsgBodyTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("cdError" == ___local)&&("" == ___uri)) {
                            _AbreProtocoloOutTO = ((br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdabreprot.impl.AbreProtocoloOutTOTypeImpl) spawnChildFromEnterElement((br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdabreprot.impl.AbreProtocoloOutTOTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  0 :
