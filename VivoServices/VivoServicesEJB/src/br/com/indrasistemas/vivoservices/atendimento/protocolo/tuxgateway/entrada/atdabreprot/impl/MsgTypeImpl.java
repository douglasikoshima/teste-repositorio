...
public class MsgTypeImpl implements br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.entrada.atdabreprot.MsgType, com.sun.xml.bind.JAXBObject, br.com.indrasistemas.jaxb.impl.runtime.UnmarshallableObject, br.com.indrasistemas.jaxb.impl.runtime.XMLSerializable, br.com.indrasistemas.jaxb.impl.runtime.ValidatableObject
{

    protected br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.entrada.atdabreprot.MsgBodyType _MsgBody;
    protected br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.entrada.atdabreprot.MsgHdrType _MsgHdr;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.entrada.atdabreprot.MsgType.class);
    }

    public br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.entrada.atdabreprot.MsgBodyType getMsgBody() {
        return _MsgBody;
    }

    public void setMsgBody(br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.entrada.atdabreprot.MsgBodyType value) {
        _MsgBody = value;
    }

    public br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.entrada.atdabreprot.MsgHdrType getMsgHdr() {
        return _MsgHdr;
    }

    public void setMsgHdr(br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.entrada.atdabreprot.MsgHdrType value) {
        _MsgHdr = value;
    }
    ...
    public br.com.indrasistemas.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(br.com.indrasistemas.jaxb.impl.runtime.UnmarshallingContext context) {
        return new br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.entrada.atdabreprot.impl.MsgTypeImpl.Unmarshaller(context);
    }
...
+"\u0000\u0012Ljava/lang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001exq\u0000~\u0000\u0019t\u0000abr.com.indr"
+"asistemas.vivoservices.atendimento.protocolo.tuxgateway.entr"
+"ada.atdabreprot.MsgHdrTypet\u0000+http://java.sun.com/jaxb/xjc/du"
...
+"://www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\u0006msgHdrt\u0000\u0000"
+"sq\u0000~\u0000\u0006pp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0006pp\u0000sq\u0000~\u0000\fppsq\u0000~\u0000\u000eq\u0000~\u0000\u0012psq\u0000~\u0000\u0013q\u0000~\u0000\u0012pq\u0000"
+"~\u0000\u0016q\u0000~\u0000\u001aq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000bbr.com.indrasistemas.vivoservices.aten"
+"dimento.protocolo.tuxgateway.entrada.atdabreprot.MsgBodyType"
+"q\u0000~\u0000!sq\u0000~\u0000\fppsq\u0000~\u0000\u0013q\u0000~\u0000\u0012pq\u0000~\u0000\'q\u0000~\u00007q\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\u0007msgBodyq\u0000~\u0000"
...
+"Pool;xp\u0000\u0000\u0000\t\u0001pq\u0000~\u0000\nq\u0000~\u0000>q\u0000~\u0000\rq\u0000~\u0000@q\u0000~\u0000\u0005q\u0000~\u0000\u0010q\u0000~\u0000Aq\u0000~\u0000\"q\u0000~\u0000Ex"));
        ...
        extends br.com.indrasistemas.jaxb.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.entrada.atdabreprot.impl.MsgTypeImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  4 :
                        if (("AbreProtocoloTO" == ___local)&&("" == ___uri)) {
                            _MsgBody = ((br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.entrada.atdabreprot.impl.MsgBodyTypeImpl) spawnChildFromEnterElement((br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.entrada.atdabreprot.impl.MsgBodyTypeImpl.class), 5, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  1 :
                        if (("user" == ___local)&&("" == ___uri)) {
                            _MsgHdr = ((br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.entrada.atdabreprot.impl.MsgHdrTypeImpl) spawnChildFromEnterElement((br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.entrada.atdabreprot.impl.MsgHdrTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  3 :
