...
public class MsgTypeImpl implements br.com.indrasistemas.vivoservices.atendimento.retencao.tuxgateway.entrada.getbonus.MsgType, com.sun.xml.bind.JAXBObject, br.com.indrasistemas.jaxb.impl.runtime.UnmarshallableObject, br.com.indrasistemas.jaxb.impl.runtime.XMLSerializable, br.com.indrasistemas.jaxb.impl.runtime.ValidatableObject
{

    protected br.com.indrasistemas.vivoservices.atendimento.retencao.tuxgateway.entrada.getbonus.MsgBodyType _MsgBody;
    protected br.com.indrasistemas.vivoservices.atendimento.retencao.tuxgateway.entrada.getbonus.MsgHdrType _MsgHdr;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (br.com.indrasistemas.vivoservices.atendimento.retencao.tuxgateway.entrada.getbonus.MsgType.class);
    }

    public br.com.indrasistemas.vivoservices.atendimento.retencao.tuxgateway.entrada.getbonus.MsgBodyType getMsgBody() {
        return _MsgBody;
    }

    public void setMsgBody(br.com.indrasistemas.vivoservices.atendimento.retencao.tuxgateway.entrada.getbonus.MsgBodyType value) {
        _MsgBody = value;
    }

    public br.com.indrasistemas.vivoservices.atendimento.retencao.tuxgateway.entrada.getbonus.MsgHdrType getMsgHdr() {
        return _MsgHdr;
    }

    public void setMsgHdr(br.com.indrasistemas.vivoservices.atendimento.retencao.tuxgateway.entrada.getbonus.MsgHdrType value) {
        _MsgHdr = value;
    }
    ...
    public br.com.indrasistemas.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(br.com.indrasistemas.jaxb.impl.runtime.UnmarshallingContext context) {
        return new br.com.indrasistemas.vivoservices.atendimento.retencao.tuxgateway.entrada.getbonus.impl.MsgTypeImpl.Unmarshaller(context);
    }
...
+"da.getbonus.MsgHdrTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-"
...
+"nto.retencao.tuxgateway.entrada.getbonus.MsgBodyTypeq\u0000~\u0000!sq\u0000"
...
+"\u0000\u0000\t\u0001pq\u0000~\u0000\u0010q\u0000~\u0000Aq\u0000~\u0000\rq\u0000~\u0000@q\u0000~\u0000\nq\u0000~\u0000>q\u0000~\u0000\u0005q\u0000~\u0000\"q\u0000~\u0000Ex"));
        ...
        extends br.com.indrasistemas.jaxb.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return br.com.indrasistemas.vivoservices.atendimento.retencao.tuxgateway.entrada.getbonus.impl.MsgTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("user" == ___local)&&("" == ___uri)) {
                            _MsgHdr = ((br.com.indrasistemas.vivoservices.atendimento.retencao.tuxgateway.entrada.getbonus.impl.MsgHdrTypeImpl) spawnChildFromEnterElement((br.com.indrasistemas.vivoservices.atendimento.retencao.tuxgateway.entrada.getbonus.impl.MsgHdrTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  0 :
                    ...
                    case  4 :
                        if (("BonusPesquisaVO" == ___local)&&("" == ___uri)) {
                            _MsgBody = ((br.com.indrasistemas.vivoservices.atendimento.retencao.tuxgateway.entrada.getbonus.impl.MsgBodyTypeImpl) spawnChildFromEnterElement((br.com.indrasistemas.vivoservices.atendimento.retencao.tuxgateway.entrada.getbonus.impl.MsgBodyTypeImpl.class), 5, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  3 :
