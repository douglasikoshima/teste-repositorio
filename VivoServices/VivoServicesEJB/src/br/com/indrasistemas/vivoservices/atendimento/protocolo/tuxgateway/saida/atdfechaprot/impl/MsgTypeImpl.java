...
public class MsgTypeImpl implements br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdfechaprot.MsgType, com.sun.xml.bind.JAXBObject, br.com.indrasistemas.jaxb.impl.runtime.UnmarshallableObject, br.com.indrasistemas.jaxb.impl.runtime.XMLSerializable, br.com.indrasistemas.jaxb.impl.runtime.ValidatableObject
{

    protected br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdfechaprot.MsgBodyType _MsgBody;
    protected br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdfechaprot.MsgHdrType _MsgHdr;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdfechaprot.MsgType.class);
    }

    public br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdfechaprot.MsgBodyType getMsgBody() {
        return _MsgBody;
    }

    public void setMsgBody(br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdfechaprot.MsgBodyType value) {
        _MsgBody = value;
    }

    public br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdfechaprot.MsgHdrType getMsgHdr() {
        return _MsgHdr;
    }

    public void setMsgHdr(br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdfechaprot.MsgHdrType value) {
        _MsgHdr = value;
    }
    ...
    public br.com.indrasistemas.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(br.com.indrasistemas.jaxb.impl.runtime.UnmarshallingContext context) {
        return new br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdfechaprot.impl.MsgTypeImpl.Unmarshaller(context);
    }
...
+"a.atdfechaprot.MsgHdrTypet\u0000+http://java.sun.com/jaxb/xjc/dum"
...
+"imento.protocolo.tuxgateway.saida.atdfechaprot.MsgBodyTypeq\u0000"
...
+"ol;xp\u0000\u0000\u0000\t\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\nq\u0000~\u0000>q\u0000~\u0000\rq\u0000~\u0000@q\u0000~\u0000\"q\u0000~\u0000Eq\u0000~\u0000\u0010q\u0000~\u0000Ax"));
        ...
        extends br.com.indrasistemas.jaxb.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdfechaprot.impl.MsgTypeImpl.this;
        }
                ...
                switch (state) {
                    case  4 :
                        if (("FechaProtocoloOutTO" == ___local)&&("" == ___uri)) {
                            _MsgBody = ((br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdfechaprot.impl.MsgBodyTypeImpl) spawnChildFromEnterElement((br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdfechaprot.impl.MsgBodyTypeImpl.class), 5, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  3 :
                    ...
                    case  1 :
                        if (("user" == ___local)&&("" == ___uri)) {
                            _MsgHdr = ((br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdfechaprot.impl.MsgHdrTypeImpl) spawnChildFromEnterElement((br.com.indrasistemas.vivoservices.atendimento.protocolo.tuxgateway.saida.atdfechaprot.impl.MsgHdrTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                }
