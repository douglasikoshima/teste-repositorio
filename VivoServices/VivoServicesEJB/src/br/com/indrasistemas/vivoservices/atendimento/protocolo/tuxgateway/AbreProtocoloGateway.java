...
public class AbreProtocoloGateway extends TuxedoServiceGateway {

    private static final Log logger = LogFactory.getLog(AbreProtocoloGateway.class);

    public AbreProtocoloGateway() {
        super();
    }
    ...
    public Object createRequestBody(BaseTransferObject to) throws ServiceGatewayException {
        ...
        try{
            ...
            result = AbreProtocoloInJAXBTOBuilder.buildATDABREPROTxmlIn((ProtocoloTO) to);
            if(logger.isDebugEnabled()){
    ...
    public BaseTransferObject createResponseBody(Object body) throws ServiceGatewayException {
        ...
        try{
            result = AbreProtocoloOutJAXBTOBuilder.buildProtocoloTO(body);
        }catch(JAXBException e){
            throw new ServiceGatewayException(e);
        }
        return result;
