...
/**
 * Camada Session para PesquisaPontoContatoFacade.
 * @xdoclet-generated at ${TODAY}
 * @copyright The XDoclet Team
 * @author XDoclet
 * @version ${version}
 */
public class PesquisaPontoContatoFacadeSession
   extends br.com.indrasistemas.vivoservices.vole.contato.facade.ejb.PesquisaPontoContatoFacadeBean
   implements javax.ejb.SessionBean
{
   private static final long serialVersionUID = 1L;

   private static final Log logger = LogFactory.getLog(PesquisaPontoContatoFacadeSession.class);
   ...
   public java.util.List buscarPontoContato( br.com.indrasistemas.framework.service.to.RequestInfoTO requestInfo,br.com.indrasistemas.vivoservices.vole.contato.to.PontoContatoTO to,java.lang.Integer pagina,java.lang.Integer qtdeRegistros ) throws br.com.indrasistemas.framework.service.BusinessException	{
      ...
      if(requestInfo == null)	{
        String errMsg = "O parâmetro requestInfo não pode ser nulo. O método buscarPontoContato não pode ser executado.";
        logger.error(errMsg);
      	throw new NullPointerException(errMsg);
      }
      //Verificação do parâmetro RequestInfoTO.userName
      if(requestInfo.getUserName() == null)	{
        String errMsg = "O parâmetro RequestInfoTO.userName não pode ser nulo. O método buscarPontoContato não pode ser executado.";
        logger.error(errMsg);
      	throw new NullPointerException(errMsg);
      }
      ...
      appRegister.register("br.com.indrasistemas.vivoservices.vole.contato.facade.ejb.PesquisaPontoContatoFacadeBean", "buscarPontoContato");
      //Se nulo é a primeira interação da cadeia de chamadas.
      if(requestInfo.getServiceName() == null)	{
        requestInfo.setServiceName("br.com.indrasistemas.vivoservices.vole.contato.facade.ejb.PesquisaPontoContatoFacadeBean.buscarPontoContato");
      }
      //Início token audit.
      ...
      if(tokenAudit.isEnabled())  {
          tokenAudit.setServiceName("PesquisaPontoContatoFacade.buscarPontoContato");
      ...
      if(standardAudit.isEnabled())  {
          standardAudit.setServiceName("PesquisaPontoContatoFacade.buscarPontoContato");
      ...
      try	{
	      result = super.buscarPontoContato( requestInfo,to,pagina,qtdeRegistros );
