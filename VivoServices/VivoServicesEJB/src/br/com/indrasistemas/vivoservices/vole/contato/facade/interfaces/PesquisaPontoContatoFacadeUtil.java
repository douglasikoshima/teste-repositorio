...
/**
 * Classe utilitária para PesquisaPontoContatoFacade.
   ...
   public static final String generateGUID(Object o) {
       ...
       if (hexServerIP == null) {
           ...
           try {
               ...
               System.err.println("PesquisaPontoContatoFacadeUtil: Não foi possíbel obter o endereço IP local usando InetAddress.getLocalHost()!");
