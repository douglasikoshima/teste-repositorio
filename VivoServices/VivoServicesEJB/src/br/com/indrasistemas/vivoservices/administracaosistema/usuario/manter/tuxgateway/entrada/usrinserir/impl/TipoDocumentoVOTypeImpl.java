...
public class TipoDocumentoVOTypeImpl implements br.com.indrasistemas.vivoservices.administracaosistema.usuario.manter.tuxgateway.entrada.usrinserir.TipoDocumentoVOType, com.sun.xml.bind.JAXBObject, br.com.indrasistemas.jaxb.impl.runtime.UnmarshallableObject, br.com.indrasistemas.jaxb.impl.runtime.XMLSerializable, br.com.indrasistemas.jaxb.impl.runtime.ValidatableObject
{

    protected java.lang.String _DsTipoDocumento;
    protected java.lang.String _SgTipoDocumento;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (br.com.indrasistemas.vivoservices.administracaosistema.usuario.manter.tuxgateway.entrada.usrinserir.TipoDocumentoVOType.class);
    }
    ...
    public java.lang.String getSgTipoDocumento() {
        return _SgTipoDocumento;
    }

    public void setSgTipoDocumento(java.lang.String value) {
        _SgTipoDocumento = value;
    }
    ...
    public br.com.indrasistemas.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(br.com.indrasistemas.jaxb.impl.runtime.UnmarshallingContext context) {
        return new br.com.indrasistemas.vivoservices.administracaosistema.usuario.manter.tuxgateway.entrada.usrinserir.impl.TipoDocumentoVOTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.endElement();
        context.startElement("", "sgTipoDocumento");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(((java.lang.String) _SgTipoDocumento), "SgTipoDocumento");
        } catch (java.lang.Exception e) {
            br.com.indrasistemas.jaxb.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
...
+"idTipoDocumentot\u0000\u0000sq\u0000~\u0000\u0007pp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u000fsq\u0000~\u0000 ppsq\u0000~\u0000\"q\u0000~\u0000%p"
+"q\u0000~\u0000&q\u0000~\u0000/q\u0000~\u00003sq\u0000~\u0000-t\u0000\u000fsgTipoDocumentoq\u0000~\u00007sq\u0000~\u0000\u0007pp\u0000sq\u0000~\u0000\u0000p"
+"pq\u0000~\u0000\u000fsq\u0000~\u0000 ppsq\u0000~\u0000\"q\u0000~\u0000%pq\u0000~\u0000&q\u0000~\u0000/q\u0000~\u00003sq\u0000~\u0000-t\u0000\u000fdsTipoDocu"
+"mentoq\u0000~\u00007sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L"
...
+"xpressionPool;xp\u0000\u0000\u0000\b\u0001pq\u0000~\u0000!q\u0000~\u0000:q\u0000~\u0000@q\u0000~\u0000\u000bq\u0000~\u00009q\u0000~\u0000?q\u0000~\u0000\u0005q\u0000~"
+"\u0000\u0006x"));
        }
        ...
        extends br.com.indrasistemas.jaxb.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return br.com.indrasistemas.vivoservices.administracaosistema.usuario.manter.tuxgateway.entrada.usrinserir.impl.TipoDocumentoVOTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  3 :
                        if (("sgTipoDocumento" == ___local)&&("" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 4;
                            return ;
                        }
