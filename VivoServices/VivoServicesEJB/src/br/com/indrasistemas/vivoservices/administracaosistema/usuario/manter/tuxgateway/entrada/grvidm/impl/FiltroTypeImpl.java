...
public class FiltroTypeImpl implements br.com.indrasistemas.vivoservices.administracaosistema.usuario.manter.tuxgateway.entrada.grvidm.FiltroType, com.sun.xml.bind.JAXBObject, br.com.indrasistemas.jaxb.impl.runtime.UnmarshallableObject, br.com.indrasistemas.jaxb.impl.runtime.XMLSerializable, br.com.indrasistemas.jaxb.impl.runtime.ValidatableObject
{

    protected br.com.indrasistemas.vivoservices.administracaosistema.usuario.manter.tuxgateway.entrada.grvidm.CombosType _Combos;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (br.com.indrasistemas.vivoservices.administracaosistema.usuario.manter.tuxgateway.entrada.grvidm.FiltroType.class);
    }

    public br.com.indrasistemas.vivoservices.administracaosistema.usuario.manter.tuxgateway.entrada.grvidm.CombosType getCombos() {
        return _Combos;
    }

    public void setCombos(br.com.indrasistemas.vivoservices.administracaosistema.usuario.manter.tuxgateway.entrada.grvidm.CombosType value) {
        _Combos = value;
    }
    ...
    public br.com.indrasistemas.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(br.com.indrasistemas.jaxb.impl.runtime.UnmarshallingContext context) {
        return new br.com.indrasistemas.vivoservices.administracaosistema.usuario.manter.tuxgateway.entrada.grvidm.impl.FiltroTypeImpl.Unmarshaller(context);
    }
    ...
    {
        if (_Combos!= null) {
            context.startElement("", "Combos");
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Combos), "Combos");
            context.endNamespaceDecls();
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Combos), "Combos");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Combos), "Combos");
            context.endElement();
        }
    }
...
+"amet\u0000\u0012Ljava/lang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001exq\u0000~\u0000\u0019t\u0000jbr.com."
+"indrasistemas.vivoservices.administracaosistema.usuario.mant"
+"er.tuxgateway.entrada.grvidm.CombosTypet\u0000+http://java.sun.co"
...
+"\u001dt\u0000\u0006Combost\u0000\u0000q\u0000~\u0000\u001csr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000"
...
+"rammar/ExpressionPool;xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000\u000fq\u0000~\u0000\u0005q\u0000~\u0000\"q\u0000~\u0000\u0012q\u0000~\u0000\rx"));
        }
        ...
        extends br.com.indrasistemas.jaxb.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return br.com.indrasistemas.vivoservices.administracaosistema.usuario.manter.tuxgateway.entrada.grvidm.impl.FiltroTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("nmSelect" == ___local)&&("" == ___uri)) {
                            _Combos = ((br.com.indrasistemas.vivoservices.administracaosistema.usuario.manter.tuxgateway.entrada.grvidm.impl.CombosTypeImpl) spawnChildFromEnterElement((br.com.indrasistemas.vivoservices.administracaosistema.usuario.manter.tuxgateway.entrada.grvidm.impl.CombosTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                }
