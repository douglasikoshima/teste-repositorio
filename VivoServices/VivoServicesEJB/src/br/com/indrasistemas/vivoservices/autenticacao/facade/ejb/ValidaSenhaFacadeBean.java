...
/**
 * @ejb.bean name="ValidaSenhaFacade" display-name="ValidaSenhaFacade" description=""
 * 
 * jndi-name="ejb/vivoservices/ValidaSenhaFacade" type="Stateless"
 * local-jndi-name="ejb/vivoservices/local/ValidaSenhaFacade" view-type="both"
 * 
 ...
 */
public class ValidaSenhaFacadeBean implements SessionBean {

	/**
	 * Logger for this class
	 */
	private static final Log logger = LogFactory.getLog(ValidaSenhaFacadeBean.class);

	/** The session context */
	private SessionContext context;	
	
	/**
	 * @J2EE_METHOD -- ValidaSenhaFacadeBean
	 */
	public ValidaSenhaFacadeBean () {}
	 ...
	 * @J2EE_METHOD -- validaSenha
	 */
	public ResultadoValidarSenhaTO validaSenha(RequestInfoTO requestInfo, DadosValidaSenhaTO dados) throws BusinessException {
		ResultadoValidarSenhaTO result = null;
		try {
			AutenticacaoAS as = new AutenticacaoAS(this.getSessionContext());
			result = as.validaSenha(requestInfo, dados);
		} catch (Exception e) {
