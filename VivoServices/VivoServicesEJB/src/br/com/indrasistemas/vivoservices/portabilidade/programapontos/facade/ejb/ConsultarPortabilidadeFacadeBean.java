...
import br.com.indrasistemas.vivoservices.portabilidade.programapontos.application.ConsultarPortabilidadeAS;
import br.com.indrasistemas.vivoservices.portabilidade.programapontos.webservice.to.RespostaStatusPortabilidadeTO;

/**
 * @ejb.bean name="ConsultarPortabilidadeFacade" 
 * display-name="ConsultarPortabilidadeFacade" description=""
 * jndi-name="ejb/vivoservices/ConsultarPortabilidadeFacade"
 * type="Stateless"
 * local-jndi-name="ejb/vivoservices/local/ConsultarPortabilidadeFacade"
 * view-type="both"
 * 
 * @ejb.transaction type="Required"
 * @weblogic.enable-call-by-reference True
 */
public class ConsultarPortabilidadeFacadeBean implements SessionBean {
	 ...
	 */
	private static final Log logger = LogFactory.getLog(ConsultarPortabilidadeFacadeBean.class);

	/** The session context */
	private SessionContext context;

	/**
	 * @J2EE_METHOD -- ConsultarPortabilidadeFacadeBean
	 */
	public ConsultarPortabilidadeFacadeBean() {
	 ...
	 * @J2EE_METHOD -- consultarStatusPortabilidade
	 */
	public RespostaStatusPortabilidadeTO consultarStatusPortabilidade(RequestInfoTO requestInfo, String nrLinha) throws BusinessException {
		RespostaStatusPortabilidadeTO result = null;
		try {
			ConsultarPortabilidadeAS as = new ConsultarPortabilidadeAS(this.getSessionContext());
			result = as.consultarStatusPortabilidade(requestInfo, nrLinha);
