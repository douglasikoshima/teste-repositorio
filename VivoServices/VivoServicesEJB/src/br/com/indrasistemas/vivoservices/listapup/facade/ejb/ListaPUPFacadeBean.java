...
/**
 * @ejb.bean name="ListaPUPFacade" display-name="ListaPUPFacade" description=""
 * 
 * jndi-name="ejb/vivoservices/ListaPUPFacade" type="Stateless"
 * local-jndi-name="ejb/vivoservices/local/ListaPUPFacade" view-type="both"
 * 
 ...
 */
public class ListaPUPFacadeBean implements SessionBean {
	...
	private static final Log logger = LogFactory
			.getLog(ListaPUPFacadeBean.class);

	/** The session context */
	private SessionContext context;

	/**
	 * @J2EE_METHOD -- ListaPUPFacadeBean
	 */
	public ListaPUPFacadeBean() {
	...
	public ResultadoLinhaPUPTO gravarLinhaPUP(RequestInfoTO requestInfo,
		...
		try {
			...
			ListaPUPAS as = new ListaPUPAS(this.getSessionContext());
			result = as.gravarLinhaPUP(requestInfo, to);
	...
	public ResultadoLinhaPUPTO consultarLinhaPUP(RequestInfoTO requestInfo,
		...
		try {
			...
			ListaPUPAS as = new ListaPUPAS(this.getSessionContext());
			result = as.consultarLinhaPUP(requestInfo, to);
		} catch (ApplicationServiceException e) {
			throw new EJBException(e);
		}
		return result;
