...
public:
	...
	void	setIdPessoaEndereco(long value);
	...
	void alterarEndereco( long iIdPessoa );
	void inserirEndereco( long iIdPessoa );
	void associarContas();
	void consultarEndereco( long iIdPessoa );
	void consultarEnderecoCobranca( long iIdPessoa );
	void atualizarContaEndereco(void);
	void excluirEndereco();
	void consultarPais(long  idPessoaEndereco, XMLGen* xml_g);
...
private:
	...
	void alterarDadosEnderecoDB( long iIdPessoa );
	void inserirDadosEnderecoDB( long iIdPessoa );
	int  verificarEnderecoContaDB();
	void associarContasDB();
	void carregarDadosEnderecoDB( long iIdPessoa );
	void carregarDadosEnderecoCobrancaDB( long iIdPessoa );
