...
public:
	...
	void consultarUltimosProcessos( long, list < CProcesso > & lstRelac );
	void consultarRangeDateProcessos( long, list < CProcesso > & lstRelac );
...
private:
	...
	// Métodos de acesso a banco de dados
 	void consultarProcessosPeriodoDataDB(long idCliente, list < CProcesso > & lstRelac);
	void consultarUltimosProcessosDB(long idCliente, list < CProcesso > & lstRelac);
