...
// Prototipos ProC
// =========================================================================
extern bool proCAlteraValor(int idUsuarioPrm,int iNivelPrm,int idSubFormularioPrm,int idCampoPrm,char * nmCampoPrm);
extern void proCAtualizarCampos();
extern void proCCamposValores( int idGrupoCampo,XMLGen * saida );
extern void proCExcluirCampos(int idUsuarioPrm,int idSubFormularioPrm,vector <string> &lstValorExc);
...
extern void proCGravaProcArvore(int idUsuarioPrm,int idSubFormularioPrm,int iNivelPrm,int idCampoPrm,const char *nmValorPaiPrm,const char *nmValorFilhoPrm);
extern void proCGravaRelacionamentoCpoDepend(int idUsuarioPrm,VEC_PRODOMHIERARQUIA &vecProcDomHierarquia,const char *nmSubFormularioPrm);
extern void proCInsereValor( char * MsgErro,bool flgRemove,int iNivelPrm,int idUsuarioPrm,int * idSubFormularioPrm,char * nmGrupoPrm,int idContatoPrm,int * idCampoPrm,char * nmCampoPrm,list <string> * lstValorInc,list <string> * lstValorExc);
...
extern void proCRemoverRelacionamentos( int idCampoPrm, int idUsuarioPrm );
