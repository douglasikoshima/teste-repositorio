...
public:
	...
	void insereMenuParceiro(char* cNmParceiro, char* cDsIpParceiro, char* cDsUrlParceiro,  int idMenuPai, int idContato, int idUsuario);
	void alterarMenuParceiro(char* cNmParceiro, char* cDsIpParceiro, char* cDsUrlParceiro, int idItemMenu, int idContato, int idUsuario);
	...
	void	consultarIdGrupo (long iIdPessoa, int iNrLinha, int iCdAreaRegistro);
